...
import { INTUNE_TOTAL, loadIntune } from "@/lib/stepsIntune";
      ...
      <header className="border-b pb-3 flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold">
            MD102 Learning App – Entra / Intune
          </h1>
          <p className="text-sm text-zinc-500">
            Schritt {step || "Übersicht"} · {INTUNE_TOTAL} Schritte
          </p>
        </div>
