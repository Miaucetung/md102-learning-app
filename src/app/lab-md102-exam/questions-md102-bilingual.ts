// MD-102 Questions - BILINGUAL (DE/EN) 2026-04-15
// German and English versions of all questions
// Total: 221 Fragen / Questions
...
`,
    questionEn: `
## Scenario: Nordwind GmbH

iOS/iPadOS App Protection Policy – PIN & ZugangskontRole

You have eine Microsoft 365 Subscription und verwendest die Microsoft Intune Suite,
um iOS/iPadOS-Devicee mit App Protection Policies (MAM) zu schützen.

Die Policy ist How folgt konfiguriert:
...
Question:
Was geschieht nach 30 Minuten Inaktivität und nach fünf incorrecten PIN-Eingaben?
`,
    options: [
      { key: "A", text: `Nach 30 Minuten wird nur die App-PIN abgefragt; nach 5 Fehlversuchen wird der Benutzer dauerhaft gesperrt.` },
      { key: "B", text: `Nach 30 Minuten werden nur die Kontozugangsdaten abgefragt; nach 5 Fehlversuchen passiert nichts.` },
      { key: "C", text: `Nach 30 Minuten ist kein erneuter Login erforderlich; nach 5 Fehlversuchen werden alle App-Daten gelöscht.` },
      { key: "D", text: `Nach 30 Minuten wird nur eine biometrische Authentifizierung verlangt; nach 5 Fehlversuchen muss das Gerät zurückgesetzt werden.` },
      { key: "E", text: `Nach 30 Minuten muss der Benutzer die PIN und die Kontozugangsdaten erneut eingeben; nach 5 falschen PIN-Eingaben muss der App-PIN zurückgesetzt werden.` }
    ],
    optionsEn: [
      { key: "A", text: `Nach 30 Minuten wird nur die App-PIN abgefragt; nach 5 Fehlversuchen wird der User dauerhaft gesperrt.` },
      { key: "B", text: `Nach 30 Minuten werden nur die Kontozugangsdaten abgefragt; nach 5 Fehlversuchen passiert nichts.` },
      { key: "C", text: `Nach 30 Minuten ist kein erneuter Login erforderlich; nach 5 Fehlversuchen werden alle App-Daten gelöscht.` },
      { key: "D", text: `Nach 30 Minuten wird nur eine biometrische Authentication verlangt; nach 5 Fehlversuchen muss das Device zurückgesetzt werden.` },
      { key: "E", text: `Nach 30 Minuten muss der User die PIN und die Kontozugangsdaten erneut eingeben; nach 5 incorrecten PIN-Eingaben muss der App-PIN zurückgesetzt werden.` }
    ],
    correctAnswers: ["E"],
    explanation: `
...
Durch die Setting 'Recheck the access requirements after (minutes of inactivity) = 30' werden nach
30 Minuten Inaktivität die Zugriffsanforderungen erneut geprüft. Da sowohl Kontozugangsdaten als auch PIN
erforderlich sind, muss der User beides erneut eingeben.

Für die PIN-Security ist 'MAX PIN attempts = 5' mit der Aktion 'Reset PIN' konfiguriert.
Das bedeutet: Nach fünf incorrecten PIN-Eingaben wird der User nicht dauerhaft gesperrt und
die App-Daten werden nicht automatisch gelöscht, sondern der User muss den App-PIN zurücksetzen.
Dazu authentifiziert er sich erneut mit seinem Konto (inkl. MFA, falls erforderlich) und definiert anschließend eine neue App-PIN.
`
  },
...
`,
    questionEn: `
## Scenario: Techfabrik AG

App Protection Policies zum Schutz vor Datenkopien zwischen Apps

You manage einen Azure AD Tenant mit Deviceen auf Windows 10, Android und iOS/iPadOS.
Alle Devicee enthalten eine App namens App1 und sind in Microsoft Intune registriert.

You need to verhindern, dass User Daten aus App1 kopieren und in andere Apps einfügen können.

Question:
Which Art von Policy musst du verwenden und How viele Policyn benötigst du mindestens?
`,
    options: [
      { key: "A", text: `Device configuration policy – 1 Richtlinie` },
      { key: "B", text: `App configuration policy – 1 Richtlinie` },
      { key: "C", text: `App protection policy – 3 Richtlinien (Windows, Android, iOS/iPadOS)` },
      { key: "D", text: `Conditional access policy – 3 Richtlinien` }
    ],
    optionsEn: [
      { key: "A", text: `Device configuration policy – 1 Policy` },
      { key: "B", text: `App configuration policy – 1 Policy` },
      { key: "C", text: `App protection policy – 3 Policyn (Windows, Android, iOS/iPadOS)` },
      { key: "D", text: `Conditional access policy – 3 Policyn` }
    ],
    correctAnswers: ["C"],
    explanation: `
...
`,
    explanationEn: `
Das Szenario beschreibt den Schutz von Unternehmensdaten innerhalb einer App (App1),
insbesondere die KontRole von Copy & Paste zwischen Apps. Dies ist eine klassische Aufgabe für
App Protection Policies (APP/MAM).
...
App Configuration Policies steuern nur App-Settingen (z. B. URLs, Standardwerte),
nicht jedoch die Containerisierung oder Copy/Paste-Sperren.
Device Configuration Policies wirken auf Deviceeebene, nicht auf App-Daten-Ebene.
Conditional Access adressiert Zugriffsbedingungen, nicht das Verhalten von Copy & Paste in Apps.
`
  },
...
`,
    questionEn: `
## Scenario: Medizintechnik Plus

Review Device Startup Processes and Restart Frequency

You have eine Microsoft 365 Subscription mit 100 Deviceen, die alle in Microsoft Intune registriert sind.
You want to die Startprozesse und die Neustartfrequenz der Devicee analysieren,
um die Usererfahrung und Stabilität zu bewerten.

Question:
Whichs Tool solltest du verwenden, um Startup-Performance und Neustarthäufigkeit zu analysieren?
`,
    options: [
...
`,
    explanationEn: `
Endpoint Analytics ist Teil der Microsoft Endpoint Manager / Intune Suite und
ist speziell darauf ausgelegt, die EndUsererfahrung zu analysieren.

Zu den Kernfunktionen zählen:
- Startup Performance (Bootzeiten, Verzögerungen durch Autostartprozesse)
- Restart Frequency (How oft werden Devicee neu gestartet)
- Application Reliability (Abstürze, Hänger)
- Proactive Remediations (Skripte zur automatischen Problembehebung)

Azure Monitor dient primär zur Monitoring von Cloud-Ressourcen und Logdaten,
liefert jedoch keine spezifischen Startup-Experience-Kennzahlen auf Deviceeebene.
Intune Data Warehouse stellt historische Intune-Daten über OData bereit,
enthält aber keine detaillierten Startup-/Neustartmetriken.
Microsoft Defender for Endpoint fokussiert auf Securitysereignisse und Bedrohungen,
nicht auf Bootperformance und Neustarthäufigkeit.
`
  },
...
Question:
Which Ereignisse werden im Log Analytics Workspace gesammelt?
`,
    options: [
...
`,
    explanationEn: `
Der klassische Log Analytics Agent (bzw. Azure Monitor Agent mit StandardConfiguration)
kann Ereignisse aus bestimmten Windows-Ereignislogs sammeln, z. B.:
- Application
- System
- Custom Logs
...
Security-Events werden nicht einfach 'mit allen anderen' über den gleichen Mechanismus gesammelt,
sondern benötigen typischerweise spezielle Configurationen oder Integrationen
How Microsoft Sentinel, Defender for Cloud oder AMA mit erweiterter Security-Datensammlung.
...
`,
    questionEn: `
## Scenario: Finanzhaus AG

Android Enterprise Devicee im Single-App-Kioskmodus konfigurieren

You manage Android Enterprise-Devicee (corporate-owned) mit Microsoft Intune.
You want to ein Device so konfigurieren, dass es nur eine bestimmte App im Kioskmodus ausführt (Single-App Mode).

Question:
In Whichm Bereich eines Device Restrictions Profils musst du den Kioskmodus konfigurieren?
`,
    options: [
      { key: "A", text: `General` },
...
`,
    explanationEn: `
Der Kioskmodus auf Android Enterprise-Deviceen (z. B. Single-App Kiosk) wird in Intune
über ein Device Restrictions Profil konfiguriert.

Die Configuration erfolgt im Bereich 'Device Experience', dort können u. a. folgende Settingen gesetzt werden:
- Kiosk mode: Single app, Multi app, etc.
- Zu verwendende App für den Kioskmodus

'General' enthält nur grundlegende Settingen (Name, Zeit, etc.),
'Users and Accounts' steuert User- und Konto-Settingen,
'System Security' betrifft SecuritysPolicyn How PIN, Encryption und Passwortanforderungen.

Nur 'Device Experience' enthält die Kiosk-spezifischen Optionen für Android Enterprise.
Daher ist Antwort D correct.
`
  },
...
`,
    questionEn: `
## Scenario: Bauwerk GmbH

Device Configuration Profile nur auf ein bestimmtes Device anwenden

You have eine Azure AD-Group Group1 und zwei Windows 10-Devicee: Device1 und Device2.
Ein Device Configuration Profile (Profile1) ist aktuell Group1 zugeHowsen.

Question:
You want to sicherstellen, dass Profile1 nur auf Device1 angewendet wird.
Whichn Teil des Profils musst du ändern?
`,
    options: [
...
`,
    explanationEn: `
Device Configuration Profiles in Intune werden über 'Assignments' zugeHowsen.
Dort wird festgelegt, Which User- oder DeviceeGroupn das Profil erhalten.

Um Profile1 nur auf Device1 anzuwenden, musst du die Zuweisung anpassen, z. B.:
- Neue DeviceeGroup, in der nur Device1 Mitglied ist, und diese Group in den Assignments verwenden; oder
- Device2 in einer Exclude-Group ausschließen.

'Settings' verändern lediglich die Inhalte der Policy, nicht aber die ZielDevicee.
'Scope (Tags)' steuert in erster Linie, Which Admins das Profil sehen/verwenden dürfen (RBAC),
nicht Which Devicee das Profil bekommen.
'Applicability Rules' filtern nach OS-Version oder Edition (z. B. nur Windows 11 Pro),
aber nicht nach einzelnen Deviceen.
...
`,
    questionEn: `
## Scenario: Energie-Direkt AG

Windows Update zentral für Azure AD-joined Devicee verwalten

You have 100 Windows 10-Devicee:
- Keine On-Premises-Serverinfrastruktur
- Alle Devicee sind Azure AD-joined (keine lokale Domäne)

Die Update-Settingen sind uNoheitlich, einige Devicee sind auf manuelle Updates eingestellt.

Ziel:
- Zentrale Management der Windows Updates
- Minimierung des Internetverkehrs
- Keine zusätzlichen Server und möglichst keine Zusatzkosten

Question:
Which Kombination von Technologien solltest du verwenden?
`,
    options: [
...
`,
    explanationEn: `
Da keine Serverinfrastruktur vorhanden ist und alle Devicee Azure AD-joined sind,
ist ein cloudbasierter Ansatz optimal.
...
Intune dient als zentrales Managementsportal, um WUfB-Policyn zu konfigurieren
und den Update-Status zu überwachen.

Delivery Optimization reduziert Internet-Traffic, indem Updates per Peer-to-Peer
zwischen Deviceen im gleichen Netzwerk verteilt werden.

WSUS oder SCCM würden zusätzliche Serverinfrastruktur erfordern und
passen nicht zur Anforderung 'keine neuen Server'.
GPO kann bei reinen Azure AD-joined Deviceen nicht ohne Weiteres eingesetzt werden.

Daher ist die correcte Kombination: Windows Update for Business + Intune + Delivery Optimization (Antwort E).
`
  },
...
Du verwaltest eine Microsoft 365 E5 Subscription mit einem Benutzer Paul und einer Webanwendung App1.
...
`,
    questionEn: `
## Scenario: Motorenwerk Schmidt

Legacy Authentication für Web App-Zugriff blockieren

You manage eine Microsoft 365 E5 Subscription mit einem User Paul und einer WebApplication App1.
App1 soll nur moderne Authentication (OAuth 2.0 / OpenID Connect) akzeptieren.
Alle Anfragen mit Legacy Authentication (z. B. Basic Auth, IMAP, POP, SMTP, MAPI) sollen blockiert werden.

You plan to eine Conditional Access Policy mit:
- Users: Paul
- Cloud apps: App1
- Grant: Block access

Question:
Which Bedingung (Condition) musst du konfigurieren, um gezielt Legacy Authentication zu blockieren?
`,
    options: [
...
Die Setting 'Client apps' (teilweise als 'Client apps (Preview)' bezeichnet) erlaubt es,
zwischen Browser, Mobile & Desktop Apps und Legacy Authentication Clients zu unterscheiden.
...
Andere Conditions How Device platforms, User risk oder Sign-in risk steuern ganz andere Aspekte
und können Legacy Authentication nicht spezifisch adressieren.

Daher ist Antwort E correct.
`
  },
...
`,
    questionEn: `
## Scenario: Autohaus Stern

Microsoft 365 Apps for Enterprise bereitstellen

You manage eine Microsoft 365-Subscription.
In deiner Umgebung befinden sich 10 Windows 10-Devicee,
die bereits in der Mobile Device Management (MDM)-Lösung Microsoft Intune registriert sind.
...
Question:
How kannst du die Microsoft 365 Apps for Enterprise-Suite an alle Devicee bereitstellen?
`,
    options: [
      { key: "A", text: `Im Microsoft Intune Admin Center ein Windows 10 device configuration profile erstellen` },
      { key: "B", text: `In Azure AD eine App Registration hinzufügen` },
      { key: "C", text: `In Azure AD eine Enterprise Application hinzufügen` },
      { key: "D", text: `Im Microsoft Intune Admin Center eine App hinzufügen` }
    ],
    optionsEn: [
      { key: "A", text: `Im Microsoft Intune Admin Center ein Windows 10 device configuration profile erstellen` },
      { key: "B", text: `In Azure AD eine App Registration hinzufügen` },
...
`,
    explanationEn: `
Microsoft 365 Apps for Enterprise (früher Office 365 ProPlus) werden in einer MDM-Umgebung mit Intune
als verwaltete Application bereitgestellt, nicht über DeviceeConfigurationsprofile oder Azure AD-App-Enrollmenten.

Im Microsoft Intune Admin Center gehst du How folgt vor:
- Apps → All apps → Add
- App type: Windows 10 and later → Microsoft 365 Apps for Windows 10 and later
- Komponenten auswählen (z. B. Word, Excel, Outlook, Teams)
- Update-Kanal konfigurieren (z. B. Monthly Enterprise Channel)
- App den relevanten Devicee- oder UserGroupn zuweisen

Intune sorgt dann für die automatische Installation und Aktualisierung der Apps auf allen zugeHowsenen Deviceen.

Device configuration profiles (Antwort A) dienen zur Configuration von Settingen (z. B. Policyn),
nicht zur App-Deployment.
App Registration (Antwort B) und Enterprise Application (Antwort C) sind Azure-AD-Konzepte zur Authentication/SSO
für Applicationen, nicht für die Installation von Office auf EndDeviceen.
`
  },
...
`,
    questionEn: `
## Scenario: Möbelhaus Eiche

Entfernen eines offline Windows-Devices aus Intune

You have eine Microsoft 365 Subscription, die Microsoft Intune verwendet.
Ein Windows 11-Device namens Device1 ist seit 30 Tagen offline und wird über Intune verwaltet.

Ziel:
You want to Device1 sofort aus Intune entfernen.
Wenn das Device später Howder eine Verbindung herstellt, sollen alle durch Intune bereitgestellten Apps und Daten entfernt werden,
aber Userdaten, persönliche Apps und OEM-Apps sollen erhalten bleiben.

Question:
Which Aktion solltest du ausführen, um dieses Verhalten sicherzustellen?
`,
    options: [
...
`,
    explanationEn: `
In Intune stehen dir primär drei Mechanismen zum Entfernen/Zurücksetzen von Deviceen zur Verfügung:
- Retire: Entfernt Unternehmensdaten und -Apps, lässt persönliche Daten/apps und OEM-Apps bestehen.
- Wipe: Setzt das Device auf WerksSettingen zurück (mit oder ohne Userkonten).
- Delete: Entfernt das Device aus Intune.

Im Prüfungskontext ist hier Important:
- Du willst das Device sofort aus der Intune-Konsole entfernen.
- Beim nächsten Check-in soll das Device dennoch so behandelt werden, dass Unternehmensdaten entfernt werden,
  aber persönliche Daten erhalten bleiben.

Die beschriebene Lösung ist die Delete-Aktion:
Device1 wird sofort aus Intune gelöscht.
Kommt es doch noch einmal mit Intune in Kontakt, wird der Status so behandelt,
als sei das Device 'retired' – Unternehmensdaten und verwaltete Apps werden entfernt,
Userdaten und OEM-Apps bleiben bestehen.

Retire (Antwort B) würde das Device nicht sofort aus der Konsole entfernen.
Fresh Start (Antwort C) entfernt u. a. Userinstallierte Apps und ist eher für ein 'sauberes' Windows gedacht.
Autopilot Reset (Antwort D) bereitet ein Device für eine Howderverwendung in der Organisation vor,
löscht Profil/Daten und lässt die Management bestehen – nicht passend zum Ziel, das Device zu entfernen.
`
  },
...
`,
    questionEn: `
## Scenario: Druckerei Gutenberg

Microsoft Defender for Endpoint auf macOS bereitstellen

You have eine Microsoft 365 E5-Subscription mit 500 macOS-Deviceen,
die bereits in Microsoft Intune registriert sind.

Question:
You need to sicherstellen, dass du Microsoft Defender for Endpoint Antivirus-Policies
auf diese macOS-Devicee anwenden kannst, bei minimalem administrativen Aufwand.
Which Maßnahme solltest du ergreifen?
`,
    options: [
      { key: "A", text: `Die macOS-Geräte im Microsoft 365 Purview compliance portal onboarden` },
      { key: "B", text: `Eine Security Baseline im Endpoint Manager Admin Center erstellen` },
      { key: "C", text: `Defender for Endpoint manuell auf allen macOS-Geräten installieren` },
      { key: "D", text: `Ein Konfigurationsprofil im Endpoint Manager Admin Center erstellen` }
    ],
    optionsEn: [
      { key: "A", text: `Die macOS-Devicee im Microsoft 365 Purview Compliance portal onboarden` },
      { key: "B", text: `Eine Security Baseline im Endpoint Manager Admin Center erstellen` },
      { key: "C", text: `Defender for Endpoint manuell auf allen macOS-Deviceen installieren` },
      { key: "D", text: `Ein Configurationsprofil im Endpoint Manager Admin Center erstellen` }
    ],
    correctAnswers: ["D"],
    explanation: `
...
`,
    explanationEn: `
Für macOS-Devicee wird Microsoft Defender for Endpoint typischerweise über Intune
mit Hilfe eines Configurationsprofils ausgerollt.

Vereinfachter Ablauf:
- Im Microsoft 365 Defender Portal das Onboarding-Paket für macOS herunterladen (Deploymentsmethode: Intune).
- In Intune ein macOS-Device Configuration Profile erstellen (z. B. Template: Custom, mit passenden .plist-/Configurationswerten).
- Das Profil den relevanten macOS-DeviceeGroupn zuweisen.

Damit wird Defender for Endpoint automatisch installiert und konfiguriert,
sodass du anschließend Antivirus- und weitere SecuritysPolicyn zentral verwalten kannst.

Option A (Purview) hat Schwerpunkt auf Compliance & Daten, nicht auf AV-Deployment.
Option B (Security Baseline) betrifft vordefinierte Windows-Configurationen, nicht macOS.
Option C (manuelle Installation) wäre bei 500 Deviceen zu aufwendig und widerspricht der Anforderung,
den administrativen Aufwand zu minimieren.
`
  },
...
`,
    questionEn: `
## Scenario: Apotheke Gesundheit Plus

Microsoft Defender Firewall und Antivirus in Intune konfigurieren

You have einen Azure AD-Tenanten und 100 Windows 10-Devicee,
die Azure AD-joined und über Intune verwaltet werden.

You need to Microsoft Defender Firewall und Microsoft Defender Antivirus auf diesen Deviceen konfigurieren.
Die Lösung soll den administrativen Aufwand minimieren.

Question:
Which zwei Aktionen solltest du durchführen? (Jede correcte Auswahl ist einen Punkt wert.)
`,
    options: [
      { key: "A", text: `GPO für Defender Antivirus konfigurieren` },
      { key: "B", text: `Device configuration profile → Device restrictions für Firewall verwenden` },
      { key: "C", text: `Device configuration profile → Endpoint protection für Antivirus verwenden` },
      { key: "D", text: `Device configuration profile → Device restrictions für Antivirus verwenden` },
      { key: "E", text: `Device configuration profile → Endpoint protection für Firewall verwenden` },
...
- Microsoft Defender Antivirus-Settingen werden typischerweise in Device restriction-Profilen abgebildet.
- Microsoft Defender Firewall-Settingen werden im Bereich Endpoint protection konfiguriert.

Da es sich um cloudverwaltete, Azure AD-joined Devicee handelt, soll die gesamte Configuration aus Intune erfolgen,
ohne zusätzliche GPO-Infrastruktur.
...
GPO-basierte Ansätze (A und F) würden On-Prem-AD und zusätzliche Management erfordern und passen nicht zu Intune-only.
B und C vertauschen die Profiltypen im Vergleich zur üblichen Intune-Aufteilung für AV und Firewall.
`
  },
...
`,
    questionEn: `
## Scenario: Spedition Schnell

Migrate Default Domain Policy GPO Settings to Intune

Dein Netzwerk enthält eine lokale Active Directory-Domäne und einen Azure AD-Tenanten.
Die Default Domain Policy GPO enthält Kennwort- und SecuritysPolicyn (z. B. Länge, Ablauf, Sperrung).

Question:
You need to die bestehenden Settingen der Default Domain Policy GPO in ein DeviceeConfigurationsprofil in Intune migrieren.
Whichn Typ von Device Configuration Profile solltest du erstellen?
`,
    options: [
...
In Intune werden diese Settingen üblicherweise über Device restriction-Profile abgebildet.
Dort findest du Kategorien How 'Password', in denen du ähnliche Parameter setzen kannst.

Administrative Templates (Antwort A) sind ADMX-/Registry-basiert und eher für Applications- oder
FeinSettingen gedacht, nicht primär für Basis-KennwortPolicyn.
Endpoint Protection (Antwort B) fokussiert auf Komponenten How Antivirus, Firewall, BitLocker.
Ein Custom-Profil (Antwort D) wäre nur nötig, wenn es keine native Entsprechung gäbe –
hier gibt es aber Device Restrictions als passende Option.

Daher ist Device Restrictions (C) die correcte Wahl.
`
  },
...
`,
    questionEn: `
## Scenario: Software-Schmiede Berlin

Devicee in Microsoft Defender for Endpoint onboarden

Du verfügst über ein Microsoft 365 E5-Abonnement.
Das Abonnement enthält 25 Computer mit Windows 11, die bereits in Microsoft Intune registriert sind.

Ziel:
You need to die Devicee in Microsoft Defender for Endpoint (MDE) onboarden.
...
`,
    explanationEn: `
Das Onboarding von Windows-Deviceen in Microsoft Defender for Endpoint über Intune
erfolgt über eine Endpoint Detection and Response (EDR)-Policy.

In dieser Policy wird der Onboarding-Blob aus dem Defender-Portal verwendet.
Nach der Zuweisung an eine DeviceeGroup werden die Devicee automatisch im Defender Security Center eingebunden.

Andere Policytypen haben andere Zwecke:
- Attack Surface Reduction (A): Regeln zur Reduzierung von Angriffsflächen (z. B. Makroblockierung).
- Security Baseline (B): Vordefinierte empfohlene Windows-SecuritysSettingen.
- Account Protection (D): Fokus auf Kontoschutz, AnmeldeSettingen.
- Antivirus (E): Configuration des Defender Antivirus, aber kein primäres Onboarding für MDE.
...
`,
    questionEn: `
## Scenario: Hotel Alpenblick

Configuration des Microsoft Edge Kioskmodus

You create in Microsoft Intune ein Device Configuration Profile für Windows 10/11 mit Kiosk-Modus (Microsoft Edge).
Microsoft Edge ist als Kiosk-App im Modus 'Public browsing (InPrivate)' konfiguriert.

Question:
Bewerte die folgenden Aussagen basierend auf dieser Policy:

1. User können auf beliebige URLs zugreifen.
2. Windows 10-Devicee können eine einzelne Microsoft Edge-Instanz mit mehreren Tabs haben.

Wähle die correcte Kombination.
`,
    options: [
    ...
    optionsEn: [
      { key: "A", text: `Beide Aussagen sind correct.` },
      { key: "B", text: `Nur Aussage 1 ist correct.` },
      { key: "C", text: `Nur Aussage 2 ist correct.` },
      { key: "D", text: `Keine der Aussagen ist correct.` }
    ],
    correctAnswers: ["A"],
    explanation: `
...
Im Kioskmodus 'Public browsing (InPrivate)' für Microsoft Edge:
- Läuft der Browser im InPrivate-Modus und speichert keine Daten dauerhaft.
- Können User grundsätzlich zu beliebigen Websites navigieren, sofern nicht zusätzliche URL-Filter greifen.
- Sind mehrere Tabs in derselben Edge-Instanz möglich.

Daher:
- Aussage 1: 'User können auf beliebige URLs zugreifen.' → correct.
- Aussage 2: 'Windows 10-Devicee können eine einzelne Microsoft Edge-Instanz mit mehreren Tabs haben.' → ebenfalls correct.

Andere Edge-Kioskmodi (z. B. Digital Signage) würden ggf. nur eine fest definierte URL zulassen,
doch hier ist explizit der Modus Public browsing konfiguriert.
Somit ist die Kombination in Antwort A correct.
`
  },
...
`,
    questionEn: `
## Scenario: Anwaltskanzlei Recht

App Configuration Policies für mehrere Plattformen

You have eine Microsoft Intune Subscription.
In Intune sind Devicee registriert, How in der Tabelle dargestellt:

- iOS/iPadOS: App1 installiert
- Android: App1 installiert

App1 ist auf allen Deviceen vorhanden.

Question:
How viele App Configuration Policies sind mindestens erforderlich, um App1 für beide Plattformen zu verwalten?
`,
    options: [
      { key: "A", text: `1` },
      { key: "B", text: `2` },
...
`,
    explanationEn: `
App Configuration Policies in Intune sind plattformabhängig.
Auch wenn es sich um dieselbe App (App1) handelt, unterscheiden sich die Configurationsschnittstellen
und Schlüssel zwischen iOS/iPadOS und Android.
...
In Summe also zwei Policies.
Eine einzelne Policy (Antwort A) kann nicht gleichzeitig beide Plattformen bedienen.
Mehr als zwei Policies (C, D, E) wären möglich (z. B. getrennt nach Groupn),
aber nicht 'mindestens notwendig'.
`
  },
...
| TAB-FIELD-01 | Android 14 | MAM | ✅ Compliant |`,
    question: `
## Szenario: Architekturbüro Modern
...
`,
    questionEn: `
## Scenario: Architekturbüro Modern

Deployment einer LOB-App für iOS-Devicee in Microsoft Intune\\n\\nYou have ein Microsoft 365 E5-Abonnement, das 100 iOS-Devicee enthält,\\ndie in Microsoft Intune registriert sind.\\n\\nYou want to eine eigene Unternehmens-App (Line-of-Business / LOB-App) auf allen Deviceen bereitstellen.\\n\\nQuestion:\\nWhich Dateierweiterung muss das App-Paket haben, damit du es in Intune als LOB-App hochladen und bereitstellen kannst?
`,
    options: [
...
`,
    explanationEn: `
Line-of-Business (LOB)-Apps sind intern entwickelte UnternehmensApplicationen,\\ndie außerhalb des App Stores bereitgestellt werden.\\nFür iOS/iPadOS-Devicee akzeptiert Intune ausschließlich .ipa-Dateien als App-Paket.\\n\\nPlattformabhängige LOB-Formate:\\n- iOS / iPadOS: .ipa\\n- Android: .apk oder .aab\\n- Windows: .msi, .appx, .appxbundle, .msix, .msixbundle\\n- macOS: .pkg oder .intunemac\\n\\nDie .ipa-Datei enthält den App-Code und muss correct signiert sein,\\nmeist mittels Apple Enterprise Developer Certificate.\\n\\nVorgehensweise in Intune:\\n1. Intune Admin Center → Apps → iOS/iPadOS → Add → Line-of-business app\\n2. .ipa-Datei hochladen\\n3. App-Infos konfigurieren\\n4. App DeviceeGroupn oder UserGroupn zuweisen\\n\\nWhy die anderen Antworten incorrect sind:\\n- .intunemac ist nur für macOS\\n- .apk ist nur für Android\\n- .appx ist nur für Windows Universal Apps
`
  },
...
`,
    questionEn: `
## Scenario: Restaurant Genuss

Configure Microsoft 365 Apps (WebView2 & Feedback Policy)

You manage eine Microsoft 365 Subscription.
Alle User verfügen über Microsoft 365 Apps for Enterprise, die über das Microsoft 365 Apps Admin Center bereitgestellt wurden.

Du sollst sicherstellen, dass:
1) Die automatische Installation von WebView2 Runtime deaktiviert wird.
2) User kein Feedback an Microsoft senden können.

Question:
Which zwei Settingen solltest du im Microsoft 365 Apps Admin Center konfigurieren?
(Jede correcte Auswahl ist einen Punkt wert.)
`,
    options: [
...
`,
    explanationEn: `
Die automatische Installation der WebView2 Runtime wird über DeviceeSettingen im Microsoft 365 Apps Admin Center
gesteuert. Diese fallen unter den Bereich 'Device Configuration', insbesondere Modern Apps Settings → WebView2.

Um die Feedback-Funktion für User zu deaktivieren, wird eine Policy benötigt.
Dafür ist der Bereich 'Policy Management' zuständig.
Dort kannst du Policyn How 'Allow users to submit feedback to Microsoft' auf Disabled setzen.

Andere Bereiche im Admin Center:
- 'Monthly Enterprise' (A) definiert den Updatekanal, aber nicht WebView2- oder Feedback-Settingen.
- 'What's New Management' (D) steuert Hinweise zu neuen Features, nicht Feedback oder WebView2.
- 'Security Update Status' (E) dient dem Reporting.
- 'Setup' (F) deckt generelle Deployment ab, nicht die beiden genannten Anforderungen.

Deshalb sind Device Configuration und Policy Management die correcten Bereiche.
`
  },
...
Question:
How werden Qualitäts- und Funktionsupdates laut dieser Configuration installiert?
`,
    options: [
      { key: "A", text: `Quality Updates werden nach 7 Tagen installiert; Feature Updates nach 30 Tagen.` },
      { key: "B", text: `Quality Updates werden innerhalb von 30 Tagen installiert; Feature Updates nach 60 Tagen.` },
      { key: "C", text: `Quality Updates werden nicht automatisch installiert; Feature Updates nach 30 Tagen.` },
      { key: "D", text: `Quality Updates werden sofort installiert; Feature Updates innerhalb von 30 Tagen nach Veröffentlichung.` }
    ],
    optionsEn: [
      { key: "A", text: `Quality Updates werden nach 7 Tagen installiert; Feature Updates nach 30 Tagen.` },
      { key: "B", text: `Quality Updates werden innerhalb von 30 Tagen installiert; Feature Updates nach 60 Tagen.` },
...
`,
    explanationEn: `
Quality Updates (Securitys- und Stabilitätsupdates) haben in der Policy einen Deferral-Wert von 0 Tagen
und eine Deadline von 0 Tagen. Das bedeutet, sie werden im Rahmen des konfigurierten Wartungszeitfensters
ohne Aufschub installiert – praktisch 'sofort', sobald sie verfügbar sind.
...
`,
    questionEn: `
## Scenario: Werbeagentur Kreativ

Collect Data from Windows 10 Computers Using Log Analytics

You have 100 Computer mit Windows 10, die mit einem Azure Log Analytics Workspace verbunden sind.

Question:
Which drei Arten von Daten kannst du von den Computern mit Log Analytics erfassen?
(Jede correcte Auswahl ist einen Punkt wert.)
`,
    options: [
      ...
      { key: "D", text: `The list of processes and their exact execution times` },
...
- Windows Event Logs, z. B. System- und Application-Logs → dadurch können Error events aus dem System log gesammelt werden (A).
- Custom Logs: Textdateien können als Userdefinierte Logs eingebunden werden (C).
- Performance Counter: z. B. CPU-Auslastung, wodurch durchschnittliche Prozessor-Auslastung (E) erfassbar ist.

Security Events (B) werden im klassischen Setup nicht über den normalen Log Analytics Agent erfasst,
sondern in der Regel über spezielle Securitysintegrationen (Defender for Cloud, Sentinel, AMA mit Security-Profil).

Eine vollständige Liste von Prozessen mit ihren 'execution times' (D) ist so nicht direkt ein Standard-Datentyp,
sondern würde separate Lösungen oder Scripts erfordern.

Daher sind A, C und E correct.
`
  },
...
Dein Unternehmen verwendet Microsoft Intune zur Management mobiler Devicee.
Es soll sichergestellt werden, dass nur Android-Devicee mit Android Work Profile (Android Enterprise Work Profile)
in Intune registriert werden können.

Question:
Which zwei Configurationen musst du in den Device Enrollment Restrictions vornehmen?
(Jede correcte Auswahl ist einen Punkt wert.)
`,
    options: [
      { key: "A", text: `From Platform Settings, set Android device administrator Personally Owned to Block` },
      { key: "B", text: `From Platform Settings, set Android Enterprise (Work Profile) to Allow` },
      { key: "C", text: `From Platform Settings, set Android device administrator Personally Owned to Allow` },
      { key: "D", text: `From Platform Settings, set Android device administrator to Block` }
    ],
    optionsEn: [
      { key: "A", text: `From Platform Settings, set Android device Administrator Personally Owned to Block` },
      { key: "B", text: `From Platform Settings, set Android Enterprise (Work Profile) to Allow` },
...
Dazu müssen die Plattform-Settingen in den Enrollment Restrictions How folgt gesetzt werden:
- Android Enterprise (Work Profile) → Allow (B), damit Work Profile-Devicee registriert werden dürfen.
- Android device Administrator → Block (D), damit das Legacy-Device-Administratormodell nicht mehr genutzt werden kann.

Option A blockiert nur persönlich besessene Device-AdministratorDevicee, lässt aber ggf. andere Szenarien offen.
Option C würde Device Administrator explizit erlauben – das ist das Gegenteil der Zielanforderung.

Daher sind B und D die correcten Settingen.
`
  },
...
You manage 100 Windows 10-Devicee, die über Microsoft Intune registriert sind.

Ziel:
- Devicee sollen Windows-Updates sowohl aus dem Internet als auch von anderen Computern im lokalen Netzwerk beziehen.
- Die Bandbreite soll optimiert und die Update-Verteilung beschleunigt werden.

Question:
Which Delivery Optimization-Setting musst du konfigurieren und Whichn Intune-Objekttyp musst du erstellen?
`,
    options: [
      { key: "A", text: `Bandwidth optimization type | Windows 10 quality updates` },
      { key: "B", text: `Bandwidth optimization type | A configuration profile` },
...
Der zentrale Parameter ist 'Download mode'.
Für das Szenario, in dem Devicee Inhalte sowohl aus dem Internet als auch von Peers im lokalen Netzwerk beziehen sollen,
wird üblicherweise ein Modus How 'HTTP blended with peering behind same NAT' verwendet.

Diese Setting nimmst du in einem Device Configuration Profile mit dem Template 'Delivery Optimization' vor:
- Intune Admin Center → Devices → Configuration profiles → Create profile
- Platform: Windows 10 and later
- Profile type: Templates → Delivery Optimization

Windows Update Rings steuern zwar, wann Updates installiert werden, aber nicht die Delivery Optimization-Peer-Settingen.
App configuration policies sind für Apps, nicht für OS-Updateverteilung.

Daher ist die Kombination 'Download mode' + 'Configuration profile' (Antwort D) correct.
`
  },
...
Benutzer:
- Paul ist Mitglied von Group1
- Mia ist Mitglied von Group1

Geräte:
- Device1: Windows 11, gehört Paul
- Device2: macOS, gehört Mia
- Device3: Android, gehört Paul
...
You manage eine Azure AD-Umgebung mit folgenden Usern und Deviceen, die in Intune eingeschrieben sind:
...
You create in Intune eine Custom Notification mit dem Namen Notification1 und sendest sie an Group1.

Question:
Which Devicee erhalten Notification1?
`,
    options: [
...
Die Benachrichtigung wird an Group1 gesendet, deren Mitglieder Paul und Mia sind.
- Paul besitzt Device1 (Windows 11) und Device3 (Android).
- Mia besitzt Device2 (macOS).
...
`,
    explanationEn: `
Custom Notifications in Intune werden als Push-Nachrichten an mobile Devicee gesendet,
die die Company Portal- oder Intune-App unterstützen.
...
Die Benachcorrectung wird an Group1 gesendet, deren Mitglieder Paul und Mia sind.
- Paul besitzt Device1 (Windows 11) und Device3 (Android).
- Mia besitzt Device2 (macOS).
...
Device1 (Windows) und Device2 (macOS) erhalten keine Custom Notification.
Daher ist nur Antwort C correct.
`
  },
...
Deviceeinventarbericht aus Intune Data Warehouse erstellen

Du nutzt Microsoft Intune soHow das Intune Data Warehouse.
You want to einen Deviceeinventarbericht erstellen, der auch die im Intune Data Warehouse gespeicherten Daten enthält.

Question:
Which Lösung solltest du verwenden, um den Bericht zu erstellen?
`,
    options: [
...
`,
    explanationEn: `
Das Intune Data Warehouse stellt Daten über eine OData-Schnittstelle bereit,
die sich ideal mit Reporting- und BI-Tools How Microsoft Power BI verbinden lässt.
...
Die Azure portal app (A) dient zur Management, nicht zur Erstellung komplexer Berichte.
Endpoint Analytics (B) bietet Analysen zur Usererfahrung, ist aber kein generisches Reporting über das Data Warehouse.
Die Company Portal App (C) ist für EndUser zur Devicee- und App-Selbstbedienung, nicht für Admin-Reporting.

Daher ist Power BI (D) die correcte Wahl.
`
  },
...
You have eine Microsoft 365 E5-Subscription und 25 Apple iPads, die mit Microsoft Intune verwaltet werden sollen.
You want to die iPads mithilfe der Apple Configurator Enrollment-Methode in Intune registrieren.
...
`,
    options: [
      ...
      { key: "D", text: `Dein Benutzerkonto als Device Enrollment Manager (DEM) hinzufügen` }
    ],
    optionsEn: [
      { key: "A", text: `Eine Datei mit den Devicee-IDs jedes iPads hochladen` },
      { key: "B", text: `Enrollment-Restrictions ändern` },
      { key: "C", text: `Ein Apple MDM Push-Certificate konfigurieren` },
      { key: "D", text: `Dein Userkonto als Device Enrollment Manager (DEM) hinzufügen` }
    ],
    correctAnswers: ["C"],
    explanation: `
...
`,
    explanationEn: `
Damit Intune iOS-/iPadOS-Devicee verwalten kann, muss zunächst eine Vertrauensstellung
zwischen Apple und Intune eingerichtet werden.

Dies geschieht über das Apple MDM Push-Certificate:
- In Intune das CSR (Certificate Signing Request) erzeugen,
- Im Apple Push Certificates Portal das Certificate erstellen,
- Das Certificate Howder in Intune hochladen.

Ohne dieses MDM Push-Certificate können keine Apple-Devicee via Intune verwaltet werden –
weder per Apple Configurator noch über andere Enrollment-Methoden.

Option A (Devicee-IDs hochladen) ist eher im Kontext von Apple Business Manager/DEP relevant.
Option B (Enrollment Restrictions) kann Enrollment einschränken, ersetzt aber kein MDM-Certificate.
Option D (DEM) ist optional für Massen-Enrollment, aber nicht der erste erforderliche Schritt.

Deshalb ist Antwort C correct.
`
  },
...
You have eine Microsoft 365 E5-Subscription mit 150 hybrid Azure AD-joined Windows-Deviceen,
die bereits in Microsoft Intune registriert sind.

Ziel:
- Delivery Optimization so konfigurieren, dass Downloads sowohl aus dem Internet als auch von anderen Deviceen im lokalen Netzwerk möglich sind.
- Die verwendete Bandbreite soll auf 50 % begrenzt werden.
...
`,
    explanationEn: `
Delivery Optimization-Settingen (inkl. Download Mode und Bandbreitenlimits) werden in Intune
über ein Device Configuration Profile konfiguriert.
...
Windows Update Rings (D) steuern primär Zeitpunkte/Deadlines für Updates, nicht die DO-Bandbreite.
GPO-basierte Ansätze (B, C) sind eher für klassische On-Prem-AD-Umgebungen gedacht und widersprechen dem Ziel,
Cloud- und Intune-basierte Management zu nutzen.

Daher ist ein Configuration Profile (A) die correcte Lösung.
`
  },
...
Deine Umgebung enthält eine Active Directory-Domäne mit dem Namen energie-direkt-ag.de.
...
Lokale Groupnmitgliedschaften (Windows 10)

Deine Umgebung enthält eine Active Directory-Domäne mit dem Namen energie-direkt-ag.de.
In der Domäne existiert ein Computer namens Computer1, auf dem Windows 10 läuft.

Es gibt folgende Groupn:
- Group1: Distribution, Universal
- Group2: Security, Global
- Group3: Security, Domain Local
- Group4: Local Group (auf Computer1)
...
Question:
Which Groupn können zu Group4 (lokale Group auf Computer1) hinzugefügt werden?
`,
    options: [
...
`,
    explanationEn: `
Group4 ist eine lokale Group auf einem Windows 10-Computer.
Lokale Groupn können Mitglieder aus der Domäne oder vom lokalen Computer enthalten,
aber es gelten bestimmte Regeln für Groupntypen und -bereiche.

Wichtige Punkte:
- Lokale Groupn können Userkonten und globale/Universelle SecuritysGroupn als Mitglieder haben.
- VerteilerGroupn (Distribution Groups) sind nicht Securitysrelevant und können nicht als Securitysprinzipale
  für Permissionen verwendet werden.
- Domänenlokale SecuritysGroupn (Domain Local) sind für die Zuweisung von Permissionen innerhalb der Domäne gedacht,
  nicht als Mitglieder lokaler Groupn auf Clients.

Im Scenario:
- Group1 ist eine Distribution Group (Universal) → nicht für Securityszuweisungen anwendbar.
- Group2 ist eine globale SecuritysGroup → kann Mitglied einer lokalen Group werden.
- Group3 ist eine domänenlokale SecuritysGroup → wird nicht als Mitglied lokaler Groupn auf Clients verwendet.

Daher kann nur Group2 zu Group4 hinzugefügt werden.
Antwort A ist somit correct.

Dies entspricht den allgemeinen Regeln für Groupntypen und -bereiche in Active Directory.
`
  },
...
Case Study: Lieferant-KG Inc.

Dieses Item beschreibt die Ausgangssituation von Lieferant-KG Inc. (Standort Los Angeles, 500 Entwickler,
...
Dieses Item beschreibt die Ausgangssituation von Lieferant-KG Inc. (Standort Los Angeles, 500 Entwickler,
ConfigMgr 2012 R2, Intune, hybride Azure AD-Umgebung, unterschiedliche Abteilungen und Probleme mit
Updates, Datenabfluss und manueller Deployment der Sales-Devicee).

Diese Fallstudie dient als Grundlage für mehrere Folgefragen (z. B. Windows Autopilot, Co-management,
Conditional Access, App Protection Policies und Branding).

How solltest du dieses Item im Rahmen der Prüfung verwenden?
`,
    options: [
      { key: "A", text: `Als Hintergrundinformation, auf die sich mehrere nachfolgende Fragen beziehen` },
      { key: "B", text: `Als eigenständige Frage, bei der eine einzelne Konfigurationsoption gewählt werden muss` },
      { key: "C", text: `Als Beispiel für eine nicht mehr unterstützte Konfiguration, die ignoriert werden kann` },
      { key: "D", text: `Nur zur Beantwortung einer einzigen Frage zur Netzwerkbandbreite` }
    ],
    optionsEn: [
      { key: "A", text: `Als Hintergrundinformation, auf die sich mehrere nachfolgende Fragen beziehen` },
      { key: "B", text: `Als eigenständige Frage, bei der eine einzelne Configurationsoption gewählt werden muss` },
      { key: "C", text: `Als Beispiel für eine nicht mehr unterstützte Configuration, die ignoriert werden kann` },
      { key: "D", text: `Nur zur Beantwortung einer einzigen Frage zur Netzwerkbandbreite` }
    ],
    correctAnswers: ["A"],
    explanation: `
Bei Microsoft-Case-Study-Fragen beschreibt das Case-Item wie hier bei Lieferant-KG Inc. die Gesamtumgebung,
...
`,
    explanationEn: `
Bei Microsoft-Case-Study-Fragen beschreibt das Case-Item How hier bei Lieferant-KG Inc. die Gesamtumgebung,
Geschäftsziele, Probleme und Anforderungen. Die eigentlichen Prüfungsfragen kommen danach und verweisen
auf diese Informationen.
...
Die correcte Nutzung besteht darin, die Informationen als gemeinsamen Kontext für mehrere Fragen zu nutzen.
`
  },
...
Ein User nutzt auf einem iOS-Device eine unternehmensverwaltete App (z. B. Outlook),
die durch Microsoft Intune App Protection Policies (MAM) geschützt ist.

Die App Protection Policy verlangt nach einer bestimmten Inaktivitätsdauer eine erneute Authentication.
Der User öffnet die App nach 30 Minuten Inaktivität erneut.

Question:
Was geschieht typischerweise, wenn der User die geschützte App nach 30 Minuten Inaktivität Howder öffnet?
(Gehe davon aus, dass App-PIN und Conditional-Access/MFA konfiguriert sind.)
`,
    options: [
      { key: "A", text: `Die App öffnet sich ohne weitere Eingabe; nur die Daten werden im Hintergrund neu synchronisiert.` },
      { key: "B", text: `Der Benutzer muss sich nur mit seinem Azure AD-Kennwort anmelden, eine PIN ist nicht erforderlich.` },
      { key: "C", text: `Die App fordert die App-PIN an und kann zusätzlich eine Azure AD-Authentifizierung inkl. MFA verlangen.` },
      { key: "D", text: `Die App wird vollständig zurückgesetzt und alle Unternehmensdaten werden sofort gelöscht.` }
    ],
    optionsEn: [
      { key: "A", text: `Die App öffnet sich ohne weitere Eingabe; nur die Daten werden im Hintergrund neu synchronisiert.` },
      { key: "B", text: `Der User muss sich nur mit seinem Azure AD-Kennwort anmelden, eine PIN ist nicht erforderlich.` },
      { key: "C", text: `Die App fordert die App-PIN an und kann zusätzlich eine Azure AD-Authentication inkl. MFA verlangen.` },
      { key: "D", text: `Die App wird vollständig zurückgesetzt und alle Unternehmensdaten werden sofort gelöscht.` }
    ],
    correctAnswers: ["C"],
    explanation: `
...
`,
    explanationEn: `
Intune App Protection Policies (MAM) definieren unter anderem:
- Nach Whichr Inaktivitätszeit der Zugriff erneut geprüft wird (z. B. 30 Minuten),
- Ob eine App-spezifische PIN oder biometrische Authentication erforderlich ist,
- Und ob über Conditional Access zusätzliche Azure AD-Authentication inkl. MFA erzwungen wird.

Wird die App nach Ablauf des Inaktivitätstimers erneut geöffnet, prüft das Intune SDK die Policy:
- Zuerst wird die App-PIN bzw. eine biometrische Methode verlangt.
- Falls Conditional Access so konfiguriert ist, kann zusätzlich eine Azure AD-Anmeldung
  mit MFA gefordert werden, bevor Unternehmensdaten Howder zugänglich sind.
...
Lieferant-KG Inc. – OOBE Branding für Windows Autopilot

Lieferant-KG Inc. möchte sicherstellen, dass während der Windows-Autopilot-Bereitstellung
...
Lieferant-KG Inc. möchte sicherstellen, dass während der Windows-Autopilot-Deployment
(Out of Box Experience – OOBE) der Firmenname und das Firmenlogo angezeigt werden.

Question:
Which zwei Bereiche im Microsoft Entra admin center (Azure AD) müssen konfiguriert werden,
damit Firmenname und Logo während der OOBE angezeigt werden?
(Jede correcte Auswahl ist einen Punkt wert.)
`,
    options: [
...
Nutzer den Mandanten visuell eindeutig als 'Lieferant-KG Inc.' erkennen.
...
`,
    explanationEn: `
Damit Autopilot-OOBE das Unternehmensbranding correct anzeigen kann, müssen:
- In den Tenanteneigenschaften (Properties) grundlegende Informationen How der Firmenname gepflegt sein.
- Im Bereich Company branding Logo, Hintergrundbild und Beschriftungen konfiguriert werden.

Diese Configurationen werden vom Anmelde- und OOBE-Prozess ausgelesen und sorgen dafür, dass
Nutzer den Tenanten visuell eindeutig als 'Lieferant-KG Inc.' erkennen.

Users (A), Organizational relationships (B), Azure AD Connect (D) und Notification settings (E)
haben keinen direkten Einfluss auf OOBE-Branding.
Daher sind Properties (C) und Company branding (F) correct.
`
  },
...
Lieferant-KG Inc. – Geräteschutz und Datenkontrolle

Bei Lieferant-KG Inc. bestehen folgende Anforderungen:
...
Lieferant-KG Inc. – Deviceeschutz und DatenkontRole
...
Question:
Which Lösungen solltest du für die Forschungsabteilung bzw. die Vertriebsabteilung einsetzen?
(Wähle die correcte Kombination.)
`,
    options: [
      { key: "A", text: `Forschung: Windows Information Protection | Vertrieb: App Protection Policy` },
      { key: "B", text: `Forschung: Azure Information Protection | Vertrieb: Windows Information Protection` },
      { key: "C", text: `Forschung: App Protection Policy | Vertrieb: Azure Information Protection` },
      { key: "D", text: `Forschung: Device Configuration Profile | Vertrieb: Conditional Access` }
    ],
    optionsEn: [
      { key: "A", text: `Forschung: Windows Information Protection | Vertrieb: App Protection Policy` },
      { key: "B", text: `Forschung: Azure Information Protection | Vertrieb: Windows Information Protection` },
...
`,
    explanationEn: `
Für die Forschungsabteilung geht es um die KontRole von Datenbewegungen zwischen Apps auf mobilen bzw.
EndDeviceen (z. B. Copy/Paste oder 'Save As'). Dies wird am besten über Intune App Protection Policies (MAM) erreicht,
die Daten in geschützten Apps containerisieren und Transfers zu ungeschützten Apps einschränken können.

Für die Vertriebsabteilung soll der Versand/Weiterleitung von E-Mails mit Bankinformationen verhindert werden.
Hierfür eignet sich Azure Information Protection (AIP) mit:
- Klassifizierungs- und Sensitivitätslabels,
- Policyn How 'Do Not Forward' oder 'Encrypt',
- Optional automatischer Label-Zuweisung bei Erkennung sensibler Inhalte (z. B. IBAN, Kontonummern).

Damit ist die correcte Zuordnung:
- Forschung → App Protection Policy (MAM),
- Vertrieb → Azure Information Protection (AIP).

Andere Kombinationen adressieren entweder nicht die correcten Ebenen (z. B. reine DeviceeConfiguration) oder
vermischen Rolen der Technologien.
`
  },
...
Lieferant-KG Inc. – Upgrade Required for Co-Management Configuration

Lieferant-KG Inc. verwendet derzeit System Center 2012 R2 Configuration Manager in einer hybrid angebundenen Umgebung.
...
Lieferant-KG Inc. verwendet derzeit System Center 2012 R2 Configuration Manager in einer hybrid angebundenen Umgebung.
Das Unternehmen möchte Co-management mit Microsoft Intune für alle Windows 10-Devicee einführen.

Question:
Was muss aktualisiert werden, bevor die Umgebung für Co-management konfiguriert werden kann?
`,
    options: [
      { key: "A", text: `Das Domain-Functional-Level der Active Directory-Domäne` },
      { key: "B", text: `System Center Configuration Manager auf eine Current-Branch-Version (mind. 1710)` },
      { key: "C", text: `Alle Domain Controller auf Windows Server 2019` },
      { key: "D", text: `Windows Server Update Services (WSUS) auf die neueste Version` }
    ],
    optionsEn: [
      { key: "A", text: `Das Domain-Functional-Level der Active Directory-Domäne` },
      { key: "B", text: `System Center Configuration Manager auf eine Current-Branch-Version (mind. 1710)` },
      { key: "C", text: `Alle Domain ContRoler auf Windows Server 2019` },
      { key: "D", text: `Windows Server Update Services (WSUS) auf die neueste Version` }
    ],
    correctAnswers: ["B"],
    explanation: `
...
Das AD-Forest- bzw. Domain-Functional-Level 2012 R2 ist für Co-management ausreichend;
ein Upgrade der Domain ContRoler oder von WSUS ist dafür nicht zwingende Voraussetzung.

Daher muss vor der Co-management-Configuration der Configuration Manager auf eine unterstützte
Current-Branch-Version aktualisiert werden.
`
  },
...
Lieferant-KG Inc. – Delivery Optimization und Active Hours für Los Angeles

Bei Lieferant-KG Inc. führen Windows-Updates zu langsamen Internetverbindungen im Büro in Los Angeles.
...
Ziel:
- Internetbelastung durch Updates reduzieren, indem Devicee Updates auch von anderen Clients im LAN beziehen.
- Neustarts und Installationen möglichst außerhalb der Arbeitszeit planen.

Question:
Which Kombination aus Delivery Optimization-Downloadmode und Active Hours ist am geeignetsten?
`,
    options: [
      { key: "A", text: `Bypass mode | Active Hours 10:00–22:00` },
      { key: "B", text: `Bypass mode | Active Hours 23:00–22:00` },
      { key: "C", text: `HTTP blended with internet peering | Active Hours 10:00–11:00` },
      { key: "D", text: `HTTP blended with peering behind same NAT | Active Hours 11:00–22:00` },
      { key: "E", text: `HTTP blended with peering behind same NAT | Active Hours 23:00–11:00` },
      { key: "F", text: `Simple download (no peering) | Active Hours 22:00–10:00` }
    ],
    optionsEn: [
      { key: "A", text: `Bypass mode | Active Hours 10:00–22:00` },
      { key: "B", text: `Bypass mode | Active Hours 23:00–22:00` },
...
dieser Zeit geplant werden. Für Lieferant-KG ist dies 11:00–22:00 Uhr.
...
Bypass mode (A/B) oder Simple download (F) deaktivieren bzw. begrenzen die Peer-Verteilung und lösen das
Bandbreitenproblem nicht. incorrecte Active Hours (C/E) passen nicht zu den tatsächlichen Arbeitszeiten.
...
Lieferant-KG Inc. verwendet Azure DevOps zur Verwaltung von Quellcode und Projekten.
...
Lieferant-KG Inc. verwendet Azure DevOps zur Management von Quellcode und Projekten.
Die Geschäftsleitung möchte sicherstellen, dass auf Azure DevOps nur aus dem Firmennetzwerk zugegriffen werden kann,
um Datenabfluss zu verhindern.

Question:
Which Technologie solltest du einsetzen, um den Zugriff auf Azure DevOps auf das Firmennetzwerk zu beschränken?
`,
    options: [
      { key: "A", text: `Intune App Protection Policy` },
      { key: "B", text: `Windows Information Protection (WIP)` },
      { key: "C", text: `Azure AD Conditional Access mit standortbasierten Bedingungen` },
      { key: "D", text: `Device Configuration Profile (Firewall-Regeln für alle Clients)` }
    ],
    optionsEn: [
      { key: "A", text: `Intune App Protection Policy` },
      { key: "B", text: `Windows Information Protection (WIP)` },
...
`,
    explanationEn: `
Azure DevOps authentifiziert User über Azure AD. Standortbasierte Zugriffsbeschränkungen werden
über Azure AD Conditional Access umgesetzt:
- In einer CA-Policy wird die Cloud-App 'Azure DevOps' ausgewählt,
- Als Bedingung werden nur vertrauenswürdige IP-Standorte (Firmenstandorte, VPN-Gateways) zugelassen.
...
zur Cloud-App selbst nach Standort.
Ein Device Configuration Profile (D) könnte zwar Firewall-Regeln setzen, ist aber wesentlich schwerer zu warten
und nicht so präzise How eine CA-Policy direkt an der Cloud-App.

Daher ist Conditional Access (C) die correcte Wahl.
`
  },
...
Lieferant-KG Inc. (Part 3) – Configure OOBE Branding

Lieferant-KG Inc. möchte den Windows Autopilot OOBE-Prozess so anpassen,
...
Lieferant-KG Inc. möchte den Windows Autopilot OOBE-Prozess so anpassen,
dass Firmenname und Logo beim Einrichten eines neuen Devices angezeigt werden.

Question:
Which zwei Azure AD-/Entra ID-Bereiche müssen konfiguriert werden, um dieses Branding sichtbar zu machen?
(Jede correcte Auswahl ist einen Punkt wert.)
`,
    options: [
...
`,
    explanationEn: `
Für OOBE-Branding sind zwei Dinge Important:
- Properties: Hier wird der offizielle Tenanten-/Firmenname konfiguriert,
- Company branding: Hier werden Logo, Hintergrund und weitere Branding-Elemente hinterlegt.

Diese Informationen werden von den Anmeldeseiten und dem OOBE-Prozess genutzt, um den Tenanten visuell
darzustellen. Andere Bereiche How Users, Organizational relationships, Identity Governance oder Mobility
beeinflussen das OOBE-Branding nicht direkt.

Daher sind C (Properties) und F (Company branding) correct.
`
  },
...
Anwaltskanzlei Recht, Ltd. betreibt einen hybriden Azure AD-Tenant (anwaltskanzlei-recht.de) mit Microsoft 365 E5- und EMS-E3-Lizenzen.
...
Alle vier Benutzer (Max–Sarah) besitzen gültige Intune-/EMS-Lizenzen und es gibt keine speziellen
...
Anwaltskanzlei Recht, Ltd. betreibt einen hybriden Azure AD-Tenant (anwaltskanzlei-recht.de) mit Microsoft 365 E5- und EMS-E3-Lizenzen.
Alle Windows 10-Devicee sind Azure AD-joined und in Intune registriert.

Ein neues Device (Device6) soll in Intune eingeschrieben werden.
Alle vier User (Max–Sarah) besitzen gültige Intune-/EMS-Lizenzen und es gibt keine speziellen
einschränkenden Enrollment Restrictions.

Question:
Which User können Device6 in Intune einschreiben (enRolen)?
`,
    options: [
...
`,
    explanationEn: `
Standardmäßig können alle User, die:
- eine gültige Intune-/EMS-Lizenz besitzen und
- im MDM-User-Scope oder im Standard-Scope liegen,
Devicee in Intune registrieren, sofern keine Enrollment Restrictions dies einschränken.

Da im Szenario alle vier User lizenziert sind und keine weiteren Beschränkungen erwähnt werden,
können alle vier User Device6 einschreiben.

Die Standardgrenze von in der Regel fünf Deviceen pro User wird hier nicht überschritten.
Damit ist Antwort D correct.
`
  },
...
Architekturbüro Modern, Ltd. betreibt eine hybride Azure AD-Umgebung. Alle Windows 10-Geräte sind Azure AD-joined
und in Intune eingeschrieben. Enterprise State Roaming (ESR) ist nur für Group1 und GroupA aktiviert.

Jonas ist Mitglied von GroupA und meldet sich an verschiedenen Azure AD-joined Geräten an.
...
Architekturbüro Modern, Ltd. betreibt eine hybride Azure AD-Umgebung. Alle Windows 10-Devicee sind Azure AD-joined
und in Intune eingeschrieben. Enterprise State Roaming (ESR) ist nur für Group1 und GroupA aktiviert.

Jonas ist Mitglied von GroupA und meldet sich an verschiedenen Azure AD-joined Deviceen an.

Du sollst beurteilen, Which UserSettingen typischerweise zwischen den Deviceen
über Enterprise State Roaming synchronisiert werden.

Which Aussage beschreibt das Verhalten von Enterprise State Roaming am besten?
`,
    options: [
      { key: "A", text: `Alle Benutzerdaten inklusive Desktop-Dateien und Dokumente werden synchronisiert.` },
      { key: "B", text: `Nur installierte Anwendungen und Win32-App-Konfigurationen werden synchronisiert.` },
      { key: "C", text: `Es werden ausschließlich Kennwörter und Browser-Cookies synchronisiert.` },
      { key: "D", text: `Nur bestimmte Windows- und Personalisierungseinstellungen (z. B. Themes, Hintergrundfarbe) sowie UWP-App-Einstellungen werden synchronisiert.` }
    ],
    optionsEn: [
      { key: "A", text: `Alle Userdaten inklusive Desktop-Dateien und Dokumente werden synchronisiert.` },
      { key: "B", text: `Nur installierte Applicationen und Win32-App-Configurationen werden synchronisiert.` },
      { key: "C", text: `Es werden ausschließlich Kennwörter und Browser-Cookies synchronisiert.` },
      { key: "D", text: `Nur bestimmte Windows- und PersonalisierungsSettingen (z. B. Themes, Hintergrundfarbe) soHow UWP-App-Settingen werden synchronisiert.` }
    ],
    correctAnswers: ["D"],
    explanation: `
...
`,
    explanationEn: `
Enterprise State Roaming (ESR) synchronisiert ausgewählte Windows- und App-Settingen:
- Personalisierung (z. B. Theme, Hintergrundfarbe, Sprache),
- Bestimmte Edge- und UWP-App-Settingen,
- Optional Kennwörter (z. B. WLAN), wenn aktiviert.

Nicht synchronisiert werden:
- Userdateien (Dokumente, Bilder, Desktop-Inhalte),
- Win32-App-spezifische Registry-Settingen,
- Installierte Applicationen als solche.

Damit beschreibt nur Option D das Verhalten correct: Es werden ausgewählte Windows-/Personalisierungs-
und UWP-App-Settingen synchronisiert, nicht jedoch alle Userdateien oder Win32-Configurationen.
`
  },
...
Enterprise State Roaming – „Sync your settings“ bei Restaurant Genuss, Ltd.

Restaurant Genuss, Ltd. verwendet Enterprise State Roaming (ESR) für Windows 10-Geräte.
...
- Paul ist Mitglied von GroupA.
- Mia ist kein Mitglied von Group1 oder GroupA.
- Beide Benutzer haben EMS E3 (inkl. Azure AD Premium).

Paul und Mia möchten die Funktion 'Sync your settings' nutzen, um persönliche Windows-Einstellungen
...
Restaurant Genuss, Ltd. verwendet Enterprise State Roaming (ESR) für Windows 10-Devicee.

Umgebung:
- Alle Windows 10-Devicee sind Azure AD-joined und in Intune eingeschrieben.
- Es gibt fünf Devicee: Device1–Device5.
- ESR ist für Group1 und GroupA aktiviert.
- Paul ist Mitglied von GroupA.
- Mia ist kein Mitglied von Group1 oder GroupA.
- Beide User haben EMS E3 (inkl. Azure AD Premium).

Paul und Mia möchten die Funktion 'Sync your settings' nutzen, um persönliche Windows-Settingen
zwischen ihren Deviceen zu synchronisieren.

Auf Whichn Deviceen steht die Funktion 'Sync your settings' (Enterprise State Roaming) zur Verfügung?
`,
    options: [
    ...
    optionsEn: [
      { key: "A", text: `User1: Keine Devicee | User2: Keine Devicee` },
      { key: "B", text: `User1: Device1–Device5 | User2: Device1–Device5` },
      { key: "C", text: `User1: Device1–Device3 | User2: Keine Devicee` },
      { key: "D", text: `User1: Device1 und Device2 | User2: Device1–Device5` },
      { key: "E", text: `User1: Device1–Device5 | User2: Keine Devicee` }
    ],
    correctAnswers: ["E"],
    explanation: `
...
Da ESR nur für Group1 und GroupA aktiviert ist und Paul Mitglied von GroupA ist,
kann Paul auf allen seinen Azure AD-joined Geräten (Device1–Device5) 'Sync your settings' verwenden.

Mia ist kein Mitglied der ESR-Gruppen und hat daher trotz Lizenz keine aktive ESR-Synchronisierung.
Damit gilt:
- Paul: Device1–Device5,
- Mia: keine Geräte.
...
Enterprise State Roaming setzt voraus:
- Azure AD Premium-Lizenz (z. B. EMS E3),
- Azure AD-joined Devicee,
- ESR muss für den User (direkt oder über Groupnmitgliedschaft) aktiviert sein.

Da ESR nur für Group1 und GroupA aktiviert ist und Paul Mitglied von GroupA ist,
kann Paul auf allen seinen Azure AD-joined Deviceen (Device1–Device5) 'Sync your settings' verwenden.

Mia ist kein Mitglied der ESR-Groupn und hat daher trotz Lizenz keine aktive ESR-Synchronization.
Damit gilt:
- Paul: Device1–Device5,
- Mia: keine Devicee.
...
Buchhaltung Express Ltd. – Hybrid Autopilot Deployment & Computerobjekterstellung

Buchhaltung Express Ltd. plant, neue Geräte per Windows Autopilot als hybrid Azure AD-joined bereitzustellen.
...
Buchhaltung Express Ltd. plant, neue Devicee per Windows Autopilot als hybrid Azure AD-joined bereitzustellen.
Der Intune Connector for Active Directory ist auf Server1 installiert.

Ziel:
Computerobjekte sollen während der Autopilot-Deployment automatisch im lokalen Active Directory
in der vorgesehenen OU erstellt werden.

Question:
An Whichs Konto/Objekt solltest du die Permission zum Erstellen von Computerobjekten in der gewünschten OU delegieren?
`,
    options: [
      { key: "A", text: `An den Domain Controller DC1` },
      { key: "B", text: `An das Computerobjekt von Server1 (Intune Connector for AD)` },
      { key: "C", text: `An die Benutzergruppe GroupA` },
      { key: "D", text: `An das Computerkonto jedes einzelnen Autopilot-Geräts` }
    ],
    optionsEn: [
      { key: "A", text: `An den Domain ContRoler DC1` },
      { key: "B", text: `An das Computerobjekt von Server1 (Intune Connector for AD)` },
      { key: "C", text: `An die UserGroup GroupA` },
      { key: "D", text: `An das Computerkonto jedes einzelnen Autopilot-Devices` }
    ],
    correctAnswers: ["B"],
    explanation: `
...
Der Connector läuft als Dienst auf Server1. Entsprechend benötigt das Computerkonto von Server1 (Server1\$)
die Permission 'Create Computer Objects' in der Ziel-OU:
- In ADUC: OU → Delegate Control → Computerobjekt Server1\$ hinzufügen → Create Computer Objects.

DC1 hostet zwar AD, erstellt aber nicht automatisch Objekte für Autopilot (A).
GroupA ist eine UserGroup und kein technischer Connector (C).
Autopilot-Deviceeobjekte existieren zu diesem Zeitpunkt noch nicht (D).
...
Werbeagentur Kreativ, Ltd. verwendet ein Endpoint Protection-Konfigurationsprofil mit Controlled Folder Access:
- Name: Protection1
...
1) Finn kann D:\\\\Folder1\\\\file1.txt auf Device4 mit Notepad erstellen.
2) Emma kann D:\\\\Folder1 aus den geschützten Ordnern auf Device2 entfernen.
3) Paul kann C:\\\\Users\\\\Paul\\\\Desktop\\\\file1.txt auf Device2 erstellen.
...
ContRoled Folder Access & geschützte Ordner

Werbeagentur Kreativ, Ltd. verwendet ein Endpoint Protection-Configurationsprofil mit ContRoled Folder Access:
- Name: Protection1
- ContRoled Folder Access: Enabled
- Allowed apps: C:\\*\\AppA.exe
- Protected folders: D:\\\\Folder1
- ZugeHowsen an: Group2, GroupB

Device4 ist Mitglied von Group2, Device2 von Group1 und Group2.
Auf beiden Deviceen existieren C:\\\\AppA.exe und D:\\\\Folder1.
...
Which der folgenden Aussagen ist/ sind correct?
`,
    options: [
    ...
    optionsEn: [
      { key: "A", text: `Nur Aussage 1 ist correct.` },
      { key: "B", text: `Nur Aussage 2 ist correct.` },
      { key: "C", text: `Nur Aussage 3 ist correct.` },
      { key: "D", text: `Aussagen 1 und 2 sind correct.` },
      { key: "E", text: `Aussagen 1 und 3 sind correct.` },
      { key: "F", text: `Aussagen 2 und 3 sind correct.` }
    ],
    correctAnswers: ["C"],
    explanation: `
...
3) Der Desktopordner (C:\\Users\\Paul\\Desktop) gehört NICHT zu den in der Richtlinie definierten geschützten
...
`,
    explanationEn: `
ContRoled Folder Access erlaubt Schreibzugriffe in geschützte Ordner nur für explizit zugelassene Applicationen.
In der Policy ist ausschließlich C:\\*\\AppA.exe als erlaubte App konfiguriert.

1) Notepad ist nicht in der Allow-Liste. Der Versuch, mit Notepad in D:\\Folder1 zu schreiben, wird blockiert.
   → Aussage 1 ist incorrect.

2) Das Entfernen von D:\\Folder1 aus den geschützten Ordnern ist eine Policynänderung und wird zentral
   über Intune gesteuert. Lokale User – selbst lokale Administratoren – können diese Setting nicht
   dauerhaft aus der verwalteten Policy herausnehmen.
   → Aussage 2 ist incorrect.

3) Der Desktopordner (C:\\Users\\Paul\\Desktop) gehört NICHT zu den in der Policy definierten geschützten
   Ordnern. ContRoled Folder Access blockiert dort keine Schreiboperationen – ein User kann dort
   problemlos Dateien anlegen.
   → Aussage 3 ist correct.

Daher ist nur Aussage 3 correct, entsprechend Option C.
`
  },
...
Nordwind GmbH, Ltd. implementiert ein Network Boundary Profile 'Boundary1' mit:
...
Nordwind GmbH, Ltd. implementiert ein Network Boundary Profile 'Boundary1' mit:
- Netzwerkgrenze: 192.168.1.0/24
- ZugeHowsen an: Group1 und Group2
...
Question:
Which Devicee erhalten die Netzwerkgrenze 192.168.1.0/24 aus dem Profil Boundary1?
`,
    options: [
...
`,
    explanationEn: `
Configurationsprofile werden in Intune Groupnbasiert zugeHowsen.
Boundary1 ist explizit den Groupn Group1 und Group2 zugeHowsen.

Deviceezuordnung:
- Device1: Group1 → erhält Boundary1.
- Device2: Group2 → erhält Boundary1.
- Device3: Group1 und Group2 → erhält Boundary1 (Mehrfachmitgliedschaft spielt keine negative Role).
- Device4: Group1 → erhält Boundary1.
- Device5: nur GroupB → erhält Boundary1 nicht.
...
Techfabrik AG, Ltd. führt zwei VPN-Konfigurationsprofile ein:
...
Jonas ist Mitglied von GroupA und meldet sich sowohl auf Device1 als auch auf Device2 an.
Device2 verfügt zusätzlich bereits über eine manuell konfigurierte VPN-Verbindung VPN3.

Frage:
Wie viele VPN-Verbindungen sind für Jonas auf Device1 bzw. Device2 verfügbar,
...
Techfabrik AG, Ltd. führt zwei VPN-Configurationsprofile ein:

- Connection1 (VPN1, L2TP): zugeHowsen an Group1, Group2, GroupA
- Connection2 (VPN2, IKEv2): zugeHowsen an GroupA, GroupB ausgeschlossen

Jonas ist Mitglied von GroupA und meldet sich sowohl auf Device1 als auch auf Device2 an.
Device2 verfügt zusätzlich bereits über eine manuell konfigurierte VPN-Verbindung VPN3.

Question:
How viele VPN-Verbindungen sind für Jonas auf Device1 bzw. Device2 verfügbar,
nachdem die Intune-Profile angewendet wurden?
`,
    options: [
    ...
    correctAnswers: ["C"],
    explanation: `
Jonas ist Mitglied von GroupA und erhält damit beide Intune-VPN-Profile:
- Connection1 (VPN1),
- Connection2 (VPN2).

Device1:
- Bekommt für Jonas VPN1 und VPN2 aus Intune zugewiesen.
- Es ist keine zusätzliche lokale VPN-Verbindung beschrieben.
→ Device1 hat insgesamt 2 VPN-Verbindungen.

Device2:
- Erhält ebenfalls VPN1 und VPN2 über Intune für Jonas.
...
Device1:
- Bekommt für Jonas VPN1 und VPN2 aus Intune zugeHowsen.
- Es ist keine zusätzliche lokale VPN-Verbindung beschrieben.
→ Device1 hat insgesamt 2 VPN-Verbindungen.
...
Damit ist Option C correct: Device1 = 2 Verbindungen, Device2 = 3 Verbindungen.
`
  },
...
Medizintechnik Plus, Ltd. verwendet Intune-Compliance-Richtlinien, die gruppenbasiert zugewiesen werden.
...
Compliance-Bewertung in Intune – Policynzuweisung und Deviceestatus

Medizintechnik Plus, Ltd. verwendet Intune-Compliance-Policyn, die Groupnbasiert zugeHowsen werden.

Situation:
- Device1 ist Mitglied von Group1 und hat die Policyn Policy1 und Policy2 zugeHowsen.
  Device1 erfüllt Policy1, aber nicht Policy2.
- Device4 ist Mitglied von Group2 und hat Policy3 zugeHowsen, erfüllt diese jedoch nicht.
- Device5 ist Mitglied von Group3, für Group3 ist keine Compliance Policy zugeHowsen.

Die globale Compliance-Setting lautet:
- 'Devices with no Compliance policy' → Compliant.

Question:
How ist der Compliance-Status der drei Devicee in Intune?
`,
    options: [
      { key: "A", text: `Device1: compliant | Device4: compliant | Device5: compliant` },
      { key: "B", text: `Device1: non-compliant | Device4: compliant | Device5: non-compliant` },
      { key: "C", text: `Device1: compliant | Device4: non-compliant | Device5: non-compliant` },
      { key: "D", text: `Device1: compliant | Device4: non-compliant | Device5: compliant` },
      { key: "E", text: `Device1: non-compliant | Device4: non-compliant | Device5: compliant` }
    ],
    optionsEn: [
      { key: "A", text: `Device1: compliant | Device4: compliant | Device5: compliant` },
      { key: "B", text: `Device1: non-compliant | Device4: compliant | Device5: non-compliant` },
...
`,
    explanationEn: `
In Intune gilt:
- Ein Device ist nur dann compliant, wenn es alle ihm zugeHowsenen Compliance-Policyn erfüllt.
- Devicee ohne zugeHowsene Policy werden je nach globale Setting behandelt – hier: als compliant.

Device1:
- Hat zwei Policyn (Policy1 und Policy2).
- Erfüllt Policy2 nicht.
→ Device1 ist non-compliant.

Device4:
- Hat Policy3 zugeHowsen und erfüllt sie nicht.
→ Device4 ist non-compliant.

Device5:
- Hat keine Compliance-Policy zugeHowsen.
- Globale Setting: Devicee ohne Policy sind compliant.
→ Device5 ist compliant.

Damit ist Option E correct.
`
  },
...
Logistik-Union AG Ltd. – Gerätezuweisung & Autopilot-Registrierung

Logistik-Union AG Ltd. verwendet ein Windows Autopilot-Profil mit folgender Konfiguration:
...
Logistik-Union AG Ltd. – Deviceezuweisung & Autopilot-Enrollment

Logistik-Union AG Ltd. verwendet ein Windows Autopilot-Profil mit folgender Configuration:
- Deployment mode: User-driven
- Join to Azure AD as: Azure AD joined
- Convert all targeted devices to Autopilot: Yes
- Assigned groups: Group1
...
Question:
Which Devicee werden durch den Windows Autopilot Deployment Service automatisch registriert?
`,
    options: [
...
`,
    explanationEn: `
Die Option 'Convert all targeted devices to Autopilot' bewirkt, dass alle Devicee,
die in den ZuweisungsGroupn des Profils enthalten sind, automatisch als Autopilot-Devicee registriert werden,
sofern sie als UnternehmensDevicee (Corporate-owned) gekennzeichnet sind.

ZugeHowsene Groupn: Group1, ausgeschlossen: Group2.

- Device1: Corporate-owned, in Group1, nicht in Group2 → wird registriert.
- Device2: Corporate-owned, in Group1 UND Group2 → fällt unter die Excluded-Group Group2 → wird NICHT registriert.
- Device3: Personally-owned → wird nicht automatisch in Autopilot aufgenommen, obwohl in Group1.

Daher wird nur Device1 durch den Autopilot Deployment Service registriert.
Option A ist correct.
`
  },
...
You have eine Microsoft 365-Umgebung mit Intune und willst Microsoft Defender for Endpoint (MDE) integrieren.

Ziele:
1. MDE-Compliance soll über Conditional Access erzwungen werden (Deviceezustand aus MDE in Intune/Entra).
2. Verdächtige Skripte sollen auf verwalteten Deviceen blockiert werden.

Question:
Which Configurationen sind erforderlich, um diese beiden Anforderungen zu erfüllen?
`,
    options: [
      { key: "A", text: `Enforce compliance: Device restriction policy | Skriptschutz: Attack surface reduction (ASR) rule` },
      { key: "B", text: `Enforce compliance: Device restriction policy | Skriptschutz: Intune–MDE-Verbindung` },
      { key: "C", text: `Enforce compliance: Security baseline | Skriptschutz: Device restriction policy` },
      { key: "D", text: `Enforce compliance: Attack surface reduction (ASR) rule | Skriptschutz: Intune–MDE-Verbindung` },
      { key: "E", text: `Enforce compliance: Attack surface reduction (ASR) rule | Skriptschutz: Security baseline` },
      { key: "F", text: `Enforce compliance: Intune–MDE-Verbindung | Skriptschutz: Attack surface reduction (ASR) rule` }
    ],
    optionsEn: [
      { key: "A", text: `Enforce Compliance: Device restriction policy | Skriptschutz: Attack surface reduction (ASR) rule` },
      { key: "B", text: `Enforce Compliance: Device restriction policy | Skriptschutz: Intune–MDE-Verbindung` },
...
`,
    explanationEn: `
1) Enforce Compliance for Defender for Endpoint:
Damit Intune den Securitysstatus eines Devices aus Microsoft Defender for Endpoint (MDE) auswerten kann,
muss eine Intune–MDE-Verbindung (Connector) konfiguriert werden. Erst dann können MDE-Signale in
Compliance-Policyn und Conditional Access Policies einfließen.

2) Prevent suspicious scripts from running:
Zum Blockieren verdächtiger Skripte werden Attack Surface Reduction (ASR)-Regeln eingesetzt.
Diese sind Teil der Defender-/Endpoint-Protection- bzw. Endpoint-Security-Configuration und können
z. B. Script-Missbrauch oder Office-Makro-Missbrauch einschränken.

Device restriction policies (A/B/C) sind für allgemeine DeviceeSettingen gedacht, Security Baselines (C/E)
bündeln zwar SecuritysSettingen, adressieren aber nicht explizit die MDE-Compliance-Verknüpfung
und Skriptschutz in dieser Form.

Die correcte Kombination ist daher:
- Enforce Compliance: Intune–MDE-Verbindung,
- Skriptschutz: Attack surface reduction (ASR) rule.
...
You manage eine Microsoft 365-Umgebung mit Windows 11-Deviceen, die in Microsoft Intune registriert sind.
Du sollst eine Compliance-Policy erstellen, die folgende Bedingungen prüft:

1) BitLocker-LaufwerksEncryption muss aktiviert sein
2) Eine Mindestbetriebssystemversion muss erzwungen werden

Which Kategorien der Windows-Compliance-Policy in Intune musst du konfigurieren?
`,
    options: [
      { key: "A", text: `Require BitLocker unter Device health; Require minimum OS version unter Device properties` },
      { key: "B", text: `Require BitLocker und Require minimum OS version beide unter Device health` },
      { key: "C", text: `Require BitLocker und Require minimum OS version beide unter Device properties` },
      { key: "D", text: `Require BitLocker unter Device properties; Require minimum OS version unter Device health` }
    ],
    optionsEn: [
      { key: "A", text: `Require BitLocker unter Device health; Require minimum OS version unter Device properties` },
      { key: "B", text: `Require BitLocker und Require minimum OS version beide unter Device health` },
...
`,
    explanationEn: `
BitLocker-Status gehört in Windows-Compliance-Policyn zur Kategorie "Device health". Dort werden Securitysrelevante Deviceezustände How Secure Boot, Code Integrity und BitLocker geprüft.

Die Mindestbetriebssystemversion wird in der Kategorie "Device properties" definiert. Hier legst du z.B. Plattform und minimale OS-Build fest.

Daher ist nur Kombination A correct: BitLocker unter Device health, Mindestversion unter Device properties.
`
  },
...
Compliance Policies: Deviceezugriff nur mit vertrauenswürdiger Firmware/OS

You manage eine Microsoft 365-Umgebung mit folgenden Deviceen:

• Device1: Windows 11
• Device2: iOS
• Device3: Android

You need to sicherstellen, dass nur Devicee mit vertrauenswürdiger Firmware bzw. nicht kompromittiertem Betriebssystem auf Netzwerkressourcen zugreifen dürfen.

Which Compliance-Policy-Setting sollte für jedes Device konfiguriert werden?
`,
    options: [
      { key: "A", text: `Device1: Require BitLocker; Device2: Prevent jailbroken devices; Device3: Require secure boot` },
      { key: "B", text: `Device1: Require BitLocker; Device2: Prevent rooted devices; Device3: Prevent jailbroken devices` },
      { key: "C", text: `Device1: Prevent jailbroken devices; Device2: Require BitLocker; Device3: Require secure boot` },
      { key: "D", text: `Device1: Prevent rooted devices; Device2: Require secure boot; Device3: Require BitLocker` },
      { key: "E", text: `Device1: Require secure boot; Device2: Prevent jailbroken devices; Device3: Prevent rooted devices` },
      { key: "F", text: `Device1: Require secure boot; Device2: Prevent rooted devices; Device3: Require BitLocker` }
    ],
    optionsEn: [
      { key: "A", text: `Device1: Require BitLocker; Device2: Prevent Yesilbroken devices; Device3: Require secure boot` },
      { key: "B", text: `Device1: Require BitLocker; Device2: Prevent rooted devices; Device3: Prevent Yesilbroken devices` },
      { key: "C", text: `Device1: Prevent Yesilbroken devices; Device2: Require BitLocker; Device3: Require secure boot` },
      { key: "D", text: `Device1: Prevent rooted devices; Device2: Require secure boot; Device3: Require BitLocker` },
      { key: "E", text: `Device1: Require secure boot; Device2: Prevent Yesilbroken devices; Device3: Prevent rooted devices` },
      { key: "F", text: `Device1: Require secure boot; Device2: Prevent rooted devices; Device3: Require BitLocker` }
    ],
    correctAnswers: ["E"],
    explanation: `
...
Für iOS/iPadOS werden kompromittierte Devicee über die Setting "Mark Yesilbroken devices as noncompliant" blockiert.

Für Android werden manipulierte Devicee über "Mark rooted devices as noncompliant" erkannt und als nicht compliant markiert.

Genau diese Kombination bildet Option E ab; alle anderen Optionen mischen die Plattform-spezifischen Settingen incorrect.
`
  },
...
Deine Organisation verwaltet 1.000 Windows 11-Devicee in Microsoft Intune.
You want to eine Custom Compliance Policy erstellen, die die BIOS-Version der Devicee überprüft und den Status in Intune anzeigt.

Which Kombination beschreibt correct, was du für eine Custom Compliance Policy benötigst?
`,
    options: [
      { key: "A", text: `Nur ein PowerShell-Skript, das "Compliant" oder "NonCompliant" in die Ereignisprotokolle schreibt` },
      { key: "B", text: `Ein Discovery Script (PowerShell), das Werte als JSON zurückgibt, und eine JSON-Definitionsdatei, die die Auswertungsregeln für diese Werte beschreibt` },
      { key: "C", text: `Nur eine JSON-Datei mit Schwellwerten für die BIOS-Version, die Intune direkt auswertet` },
      { key: "D", text: `Ein Gerätekonfigurationsprofil und eine Proactive-Remediation-Richtlinie, aber keine JSON-Datei` }
    ],
    optionsEn: [
      { key: "A", text: `Nur ein PowerShell-Skript, das "Compliant" oder "NonCompliant" in die Ereignisprotokolle schreibt` },
      { key: "B", text: `Ein Discovery Script (PowerShell), das Werte als JSON zurückgibt, und eine JSON-Definitionsdatei, die die Auswertungsregeln für diese Werte beschreibt` },
      { key: "C", text: `Nur eine JSON-Datei mit Schwellwerten für die BIOS-Version, die Intune direkt auswertet` },
      { key: "D", text: `Ein DeviceeConfigurationsprofil und eine Proactive-Remediation-Policy, aber keine JSON-Datei` }
    ],
    correctAnswers: ["B"],
    explanation: `
...
Das Discovery Script (z.B. PowerShell) läuft auf dem Client und ermittelt Deviceeeigenschaften How BIOS-Version oder Modell. Es gibt die Ergebnisse in einem JSON-Objekt zurück.

Die JSON-Definitionsdatei beschreibt, Which Felder im JSON geprüft werden und Which Werte als compliant bzw. noncompliant gewertet werden.

Nur Option B bildet dieses Zusammenspiel correct ab. Weder ein alleinstehendes Skript noch nur eine JSON-Datei reichen aus.
`
  },
...
• Tom soll Datum und Uhrzeit ändern dürfen.
• Sarah soll Windows-Ereignisprotokolle löschen dürfen.
...
Userrechte: Datum/Zeit ändern & Windows-Protokolle löschen

Auf einem Windows-10-Computer existieren zwei lokale User:
• Tom soll Datum und Uhrzeit ändern dürfen.
• Sarah soll Windows-Ereignisprotokolle löschen dürfen.

Nach dem Prinzip der minimalen Rechte (Least Privilege): Whichn lokalen Groupn müssen die User zugeordnet werden, damit sie ihre Aufgaben ausführen können?
`,
    options: [
      { key: "A", text: `User1: Administrators; User2: Administrators` },
      { key: "B", text: `User1: Power Users; User2: Event Log Readers` },
      { key: "C", text: `User1: Users; User2: Event Log Readers` },
      { key: "D", text: `User1: Backup Operators; User2: Performance Log Users` }
    ],
    optionsEn: [
      { key: "A", text: `User1: Administrators; User2: Administrators` },
      { key: "B", text: `User1: Power Users; User2: Event Log Readers` },
...
Daher müssen sowohl Tom als auch Sarah Mitglieder der lokalen Administratorengruppe sein, wenn sie diese Aufgaben direkt am System ausführen sollen.
`,
    explanationEn: `
Die Permission "Change the system time" ist standardmäßig nur Mitgliedern der lokalen Group "Administrators" zugeHowsen.

Auch das Löschen von Windows-Ereignisprotokollen ("Clear event log") ist eine administrative Aufgabe, die Administratorrechten vorbehalten ist. Die Group "Event Log Readers" darf nur lesen, nicht löschen.

Daher müssen sowohl Tom als auch Sarah Mitglieder der lokalen AdministratorenGroup sein, wenn sie diese Aufgaben direkt am System ausführen sollen.
`
  },
...
Du hast einen Azure AD-Mandanten möbelhaus-eiche.de und verwaltest verschiedene Gerätetypen:
...
You have einen Azure AD-Tenanten möbelhaus-eiche.de und verwaltest verschiedene Deviceetypen:
• Windows 10/11 Pro/Enterprise
• Windows 10 Home
• iOS und Android
• macOS und Ubuntu 20.04/22.04 LTS

Which Aussage beschreibt correct, Which Devicee Azure AD joined und Which Azure AD registered werden können?
`,
    options: [
      { key: "A", text: `Alle genannten Geräte, einschließlich Windows 10 Home, können Azure AD joined werden.` },
      { key: "B", text: `Nur Windows 10/11 (außer Home Edition) können Azure AD joined werden; Windows, iOS, Android, macOS und Ubuntu können Azure AD registered werden.` },
      { key: "C", text: `Nur mobile Geräte (iOS/Android) können Azure AD registered werden; Windows und macOS nur per Azure AD Join.` },
      { key: "D", text: `Azure AD Join ist nur für Serverbetriebssysteme vorgesehen; Clients werden ausschließlich Azure AD registered.` }
    ],
    optionsEn: [
      { key: "A", text: `Alle genannten Devicee, einschließlich Windows 10 Home, können Azure AD joined werden.` },
      { key: "B", text: `Nur Windows 10/11 (außer Home Edition) können Azure AD joined werden; Windows, iOS, Android, macOS und Ubuntu können Azure AD registered werden.` },
      { key: "C", text: `Nur mobile Devicee (iOS/Android) können Azure AD registered werden; Windows und macOS nur per Azure AD Join.` },
      { key: "D", text: `Azure AD Join ist nur für Serverbetriebssysteme vorgesehen; Clients werden ausschließlich Azure AD registered.` }
    ],
    correctAnswers: ["B"],
    explanation: `
...
`,
    explanationEn: `
Azure AD Join ist für organisationsverwaltete Devicee gedacht und wird nur von Windows 10/11 (Professional/Enterprise/Education, nicht Home) unterstützt.

Azure AD Register (Workplace Join) steht für BYOD- und PrivatDevicee zur Verfügung und wird von Windows, iOS, Android, macOS und bestimmten Linux-Distributionen How Ubuntu 20.04/22.04 LTS unterstützt.

Option B bringt diese Unterscheidung correct auf den Punkt; die anderen Antworten über- oder unterschätzen die Fähigkeiten der jeweiligen Plattform.
`
  },
...
Du hast einen Azure AD-Mandanten druckerei-gutenberg.de mit folgenden Benutzern:
• Admin1@druckerei-gutenberg.de – Global Administrator
• Admin2@druckerei-gutenberg.de – User Administrator
• Max@druckerei-gutenberg.de – Standardbenutzer

Ein Windows-10-Gerät Computer1 befindet sich noch in einer Workgroup.
Max führt mit seinem Konto einen Azure AD Join von Computer1 nach druckerei-gutenberg.de durch.
...
You have einen Azure AD-Tenanten druckerei-gutenberg.de mit folgenden Usern:
• Admin1@druckerei-gutenberg.de – Global Administrator
• Admin2@druckerei-gutenberg.de – User Administrator
• Max@druckerei-gutenberg.de – StandardUser

Ein Windows-10-Device Computer1 befindet sich noch in einer Workgroup.
Max führt mit seinem Konto einen Azure AD Join von Computer1 nach druckerei-gutenberg.de durch.

Which Aussage beschreibt das Standardverhalten nach dem Join am besten?
`,
    options: [
      { key: "A", text: `User1, der den Azure AD Join ausführt, wird lokaler Administrator auf Computer1.` },
      { key: "B", text: `User Administratoren (z.B. Admin2) werden automatisch lokale Administratoren auf allen Azure-AD-joined Geräten.` },
      { key: "C", text: `Kein Benutzer erhält lokale Administratorrechte; diese müssen immer manuell per Intune zugewiesen werden.` },
      { key: "D", text: `Nur Global Administratoren (z.B. Admin1) werden lokale Administratoren; der Join-Benutzer bleibt Standardbenutzer.` }
    ],
    optionsEn: [
      { key: "A", text: `User1, der den Azure AD Join ausführt, wird lokaler Administrator auf Computer1.` },
      { key: "B", text: `User Administratoren (z.B. Admin2) werden automatisch lokale Administratoren auf allen Azure-AD-joined Deviceen.` },
      { key: "C", text: `Kein User erhält lokale Administratorrechte; diese müssen immer manuell per Intune zugeHowsen werden.` },
      { key: "D", text: `Nur Global Administratoren (z.B. Admin1) werden lokale Administratoren; der Join-User bleibt StandardUser.` }
    ],
    correctAnswers: ["A"],
    explanation: `
...
`,
    explanationEn: `
Bei einem Azure AD Join wird der User, der den Join durchführt, standardmäßig der lokalen AdministratorenGroup des Devices hinzugefügt.

Zusätzlich können in Azure AD Rolen How "Azure AD device Administrator" definiert werden, deren Mitglieder ebenfalls lokale Administratoren werden. Ein reiner User Administrator erhält jedoch keine lokalen Adminrechte allein durch seine Role.

Daher ist Aussage A correct; die Optionen B, C und D beschreiben das Standardverhalten nicht correct.
`
  },
...
You manage eine Active-Directory-Domäne mit Windows-10-Clients.
Auf allen Rechnern wurde Windows PowerShell Remoting (WinRM) bereits aktiviert.
Das Userkonto Admin1 soll Remote-PowerShell-Sitzungen zu den Clients aufbauen können,
ohne Mitglied der lokalen AdministratorenGroup zu sein (Least Privilege).

Zu Whichr lokalen Group solltest du Admin1 hinzufügen?
`,
    options: [
...
Um nicht-administrativen Usern gezielt Remoting-Rechte zu geben, existiert die lokale Group "Remote Management Users".

Mitgliedschaft in dieser Group erlaubt Remote-PowerShell-Sitzungen, ohne weitere Administrationsrechte How bei lokalen Administratoren oder RDP-Sitzungen zu vergeben.

Daher ist die Zuordnung von Admin1 zur Group "Remote Management Users" die correcte und least-privilege-konforme Lösung.
`
  },
...
You create in Intune ein Windows Autopilot Deployment Profile mit folgenden Settingen:

• Apply device name template: No
• User account type: Standard user

Which Aussage beschreibt das Verhalten bei der Deployment eines Devices mit diesem Profil am besten?
`,
    options: [
      { key: "A", text: `Benutzer können keine Desktop-Einstellungen ändern und den Computernamen während der Bereitstellung nicht konfigurieren.` },
      { key: "B", text: `Benutzer können nur ihre eigenen Desktop-Einstellungen ändern und den Computernamen während der Bereitstellung selbst festlegen.` },
      { key: "C", text: `Benutzer können Desktop-Einstellungen für alle Benutzer ändern und Cortana während der Bereitstellung konfigurieren.` },
      { key: "D", text: `Benutzer werden als lokale Administratoren angelegt und erhalten einen automatisch generierten Gerätenamen.` }
    ],
    optionsEn: [
      { key: "A", text: `User können keine Desktop-Settingen ändern und den Computernamen während der Deployment nicht konfigurieren.` },
      { key: "B", text: `User können nur ihre eigenen Desktop-Settingen ändern und den Computernamen während der Deployment selbst festlegen.` },
      { key: "C", text: `User können Desktop-Settingen für alle User ändern und Cortana während der Deployment konfigurieren.` },
      { key: "D", text: `User werden als lokale Administratoren angelegt und erhalten einen automatisch generierten Deviceenamen.` }
    ],
    correctAnswers: ["B"],
    explanation: `
...
`,
    explanationEn: `
Mit "User account type = Standard user" werden Userkonten ohne lokale Administratorrechte erstellt. Sie können ihre eigenen Desktop-Settings anpassen, aber keine systemweiten Änderungen vornehmen.

Wenn "Apply device name template = No" gesetzt ist, verwendet Autopilot kein vordefiniertes Namensmuster; der User kann den Deviceenamen im OOBE-Dialog eingeben.

Damit beschreibt Option B das Verhalten correct; die übrigen Optionen widersprechen entweder dem Standard-User-Typ oder der NamensConfiguration.
`
  },
...
You want to, dass der Deployment-Prozess automatisch startet, sobald der Client sich mit MDT1 verbindet – der Welcome Screen soll nicht mehr angezeigt werden.

Which Configuration ist erforderlich?
`,
    options: [
      { key: "A", text: `Nur die Bootstrap.ini anpassen (SkipBDDWelcome=YES) – weitere Schritte sind nicht erforderlich.` },
      { key: "B", text: `CustomSettings.ini und Bootstrap.ini anpassen und anschließend den Deployment Share updaten, um ein neues Boot-Image zu erzeugen.` },
      { key: "C", text: `Nur die Task Sequence ändern, damit sie automatisch startet; keine Änderungen an INI-Dateien nötig.` },
      { key: "D", text: `Nur DHCP-Optionen 66/67 setzen, damit das PXE-Boot automatisch ohne Benutzerinteraktion abläuft.` }
    ],
    optionsEn: [
      { key: "A", text: `Nur die Bootstrap.ini anpassen (SkipBDDWelcome=YES) – weitere Schritte sind nicht erforderlich.` },
      { key: "B", text: `CustomSettings.ini und Bootstrap.ini anpassen und anschließend den Deployment Share updaten, um ein neues Boot-Image zu erzeugen.` },
      { key: "C", text: `Nur die Task Sequence ändern, damit sie automatisch startet; keine Änderungen an INI-Dateien nötig.` },
      { key: "D", text: `Nur DHCP-Optionen 66/67 setzen, damit das PXE-Boot automatisch ohne Userinteraktion abläuft.` }
    ],
    correctAnswers: ["B"],
    explanation: `
...
Deshalb ist nur Option B vollständig correct.
`
  },
...
Windows Admin Center – Certificatewarnung "Your connection isn’t private"

Beim Zugriff auf die Weboberfläche des Windows Admin Center (WAC) erscheint im Browser die Warnung:
"Your connection isn’t private" (NET::ERR_CERT_AUTHORITY_INVALID).

Während der WAC-Installation wurde ein selbstsigniertes Certificate erstellt.
You want to die Warnung auf den Administrations-Clients dauerhaft beseitigen.

In Whichn Certificatesspeicher musst du das WAC-Certificate auf den Clients importieren?
`,
    options: [
...
`,
    explanationEn: `
Das von Windows Admin Center erstellte Certificate ist selbstsigniert und wird von keiner bekannten öffentlichen oder internen CA ausgestellt.

Damit der Browser dem Certificate vertraut, muss die ausstellende CA (hier: das selbstsignierte Certificate) in den Speicher "Trusted Root Certification Authorities" des Clientcomputers importiert werden.

Ein Import in "Personal" oder andere Stores ändert die Vertrauenskette des Browsers nicht und beseitigt die Warnung daher nicht. Deshalb ist Option B correct.
`
  },
...
You manage eine Active-Directory-Domäne mit 1.000 Windows-11-Clients.
Die RDP-Configuration soll zentral per GroupnPolicy erfolgen.

Anforderungen:
• Verhindern, dass die Zwischenablage (Clipboard) zwischen Client und RDP-Sitzung genutzt wird.
• Sicherstellen, dass sich User nur mittels Network Level Authentication (NLA) anmelden können.

In Whichm GPO-Knoten konfigurierst du jeweils die Policyn, um diese Anforderungen umzusetzen?

Note: Es handelt sich um ComputerConfigurationen unterhalb von
Administrative Templates → Windows Components → Remote Desktop Services → Remote Desktop Session Host.
`,
    options: [
...
`,
    explanationEn: `
Die Setting zum Deaktivieren der Zwischenablage (Clipboard) liegt unter dem Knoten "Device and Resource Redirection" als Policy "Do not allow Clipboard redirection".

Die Erzwingung von Network Level Authentication (NLA) erfolgt über den Knoten "Security" mit der Policy "Require user authentication for remote connections by using Network Level Authentication".
...
Intune Compliance Policy – Groupnlogik & BitLocker-Anforderung

You use Microsoft Intune mit einer Microsoft 365 E5 Subscription.
Es gibt drei Windows-11-Devicee mit folgenden Groupnmitgliedschaften:

• Device1 ist Mitglied in Group1
• Device2 ist Mitglied in Group2
• Device3 ist Mitglied in Group3

You create eine Compliance Policy (Policy1) mit der Anforderung:
• BitLocker-LaufwerksEncryption muss aktiviert sein.
...
Angenommen, nur Device1 hat BitLocker aktiviert, Device2 und Device3 nicht:
How wirkt sich die Policy auf die drei Devicee aus?
`,
    options: [
      { key: "A", text: `Policy1 wird Device1 und Device2 zugewiesen; Device1 ist compliant, Device2 non-compliant; Device3 erhält die Policy nicht.` },
      { key: "B", text: `Policy1 wird allen drei Geräten zugewiesen; nur Device1 ist compliant, Device2 und Device3 sind non-compliant.` },
      { key: "C", text: `Policy1 wird Device1 und Device3 zugewiesen; Device1 ist compliant, Device3 non-compliant; Device2 erhält die Policy nicht.` },
      { key: "D", text: `Policy1 wird nur Device3 zugewiesen; Device3 ist compliant, Device1 und Device2 erhalten die Policy nicht.` }
    ],
    optionsEn: [
      { key: "A", text: `Policy1 wird Device1 und Device2 zugeHowsen; Device1 ist compliant, Device2 non-compliant; Device3 erhält die Policy nicht.` },
      { key: "B", text: `Policy1 wird allen drei Deviceen zugeHowsen; nur Device1 ist compliant, Device2 und Device3 sind non-compliant.` },
      { key: "C", text: `Policy1 wird Device1 und Device3 zugeHowsen; Device1 ist compliant, Device3 non-compliant; Device2 erhält die Policy nicht.` },
      { key: "D", text: `Policy1 wird nur Device3 zugeHowsen; Device3 ist compliant, Device1 und Device2 erhalten die Policy nicht.` }
    ],
    correctAnswers: ["C"],
    explanation: `
...
`,
    explanationEn: `
Intune berechnet die effektive Zuweisung nach der Regel: Effective = Include − Exclude. Devicee in Exclude-Groupn erhalten die Policy nicht, selbst wenn sie in Include-Groupn wären.
...
Somit beschreibt Option C die Situation correct.
`
  },
...
Was musst du auf Server1 tun und Which Mindestkomponenten müssen im MDT Deployment Share vorhanden sein?
`,
    options: [
      { key: "A", text: `Import the DISM PowerShell module; Windows 10 image only` },
      { key: "B", text: `Import the DISM PowerShell module; Windows 10 image and package only` },
      { key: "C", text: `Import the WindowsPilotIntune PowerShell module; Windows 10 image only` },
      { key: "D", text: `Install the Windows Assessment and Deployment Kit (Windows ADK); Windows 10 image and task sequence only` },
      { key: "E", text: `Install Windows Deployment Services role; Windows 10 image, task sequence, and package` },
      { key: "F", text: `Install Windows Deployment Services role; Windows 10 image and task sequence only` }
    ],
    optionsEn: [
      { key: "A", text: `Import the DISM PowerShell module; Windows 10 image only` },
      { key: "B", text: `Import the DISM PowerShell module; Windows 10 image and package only` },
...
Daher ist Option D die einzig correcte Kombination: Windows ADK installieren und im Deployment Share ein Windows-10-Image soHow eine Task Sequence hinzufügen.
`
  },
...
In einem Azure-AD-Mandanten buchhaltung-express.de existieren folgende Geräte:
...
Windows Autopilot – DeviceePermission & Groupnlogik

In einem Azure-AD-Tenanten buchhaltung-express.de existieren folgende Devicee:
• Device1: Windows 8.1, Azure AD status: Registered, MDM: None
• Device2: Windows 10, Azure AD status: Joined, MDM: None
• Device3: Windows 10, Azure AD status: Joined, MDM: Microsoft Intune
...
• Deployment mode: Self-deploying
• Join to Azure AD as: Azure AD joined
• Assignments: Include = Group1 (verschachtelte Groupn werden von Autopilot nicht ausgewertet).

Which Devicee können tatsächlich über dieses Autopilot-Profil bereitgestellt werden, wenn sie in OOBE starten?
`,
    options: [
      { key: "A", text: `Device1 only` },
      { key: "B", text: `Device2 only` },
...
Zudem müssen Devicee dem Autopilot-Profil direkt zugeHowsen sein; verschachtelte Groupn (Group2 in Group1) werden bei Autopilot-Zuweisungen nicht berücksichtigt, daher wird Device2 über Group2 nicht erfasst.
...
Eine Organisation nutzt Microsoft Intune Suite für die DeviceeManagement; Azure-AD-joined Devicee werden automatisch in Intune eingeschrieben.
Vorhandene Devicee (alle Windows-11-kompatible Hardware):

• Device1: Windows 10 Pro 64-Bit, Azure AD joined = Yes, LOB Apps = No
• Device2: Windows 10 Pro 32-Bit, Azure AD joined = No, LOB Apps = Yes
• Device3: Windows 10 Pro 64-Bit, Azure AD joined = No, LOB Apps = Yes

Ziel ist es, die Devicee auf Windows 11 Pro zu aktualisieren, unter Beibehaltung von Userprofilen und Applicationen.
Es stehen zwei Methoden zur Auswahl: Windows Autopilot und In-Place Upgrade.

Which Zuordnung ist correct?
`,
    options: [
      { key: "A", text: `Windows Autopilot: None of the devices; In-Place Upgrade: Device1 and Device3 only` },
      { key: "B", text: `Windows Autopilot: Device1 only; In-Place Upgrade: Device2 and Device3 only` },
      { key: "C", text: `Windows Autopilot: Device1 and Device3; In-Place Upgrade: Device2 only` },
      { key: "D", text: `Windows Autopilot: Device1, Device2, and Device3; In-Place Upgrade: Device1 only` }
    ],
    optionsEn: [
      { key: "A", text: `Windows Autopilot: None of the devices; In-Place Upgrade: Device1 and Device3 only` },
      { key: "B", text: `Windows Autopilot: Device1 only; In-Place Upgrade: Device2 and Device3 only` },
...
`,
    explanationEn: `
Windows Autopilot ist ein Neu-Deploymentsmechanismus (Reset/Reimage) und behält Userprofile und lokal installierte Applicationen nicht im Sinne eines In-Place Upgrades bei. Es ist daher nicht geeignet, wenn Profile und Apps zwingend erhalten bleiben sollen.

Ein In-Place Upgrade kann nur von 64-Bit auf 64-Bit durchgeführt werden; ein Wechsel von 32-Bit auf 64-Bit (Device2) wird nicht unterstützt. Device1 und Device3 sind 64-Bit und damit für ein In-Place Upgrade geeignet.

Damit ergibt sich: Autopilot – keines der Devicee; In-Place Upgrade – Device1 und Device3. Option A ist correct.
`
  },
...
Microsoft Intune – Enable Remote Help for Max on Device1
...
Max soll über das Intune Admin Center per Remote Help auf Device1 zugreifen können.

Welche drei Maßnahmen sind erforderlich, damit Max Remote Help für Device1 nutzen kann?
(Jede richtige Auswahl ist einen Punkt wert.)
`,
    questionEn: `
## Scenario: Nordwind GmbH
...
You manage Devicee über Microsoft Intune Suite in einer Microsoft 365 E5-Umgebung.
Device1 ist bereits in Intune registriert.
Max soll über das Intune Admin Center per Remote Help auf Device1 zugreifen können.

Which drei Maßnahmen sind erforderlich, damit Max Remote Help für Device1 nutzen kann?
(Jede correcte Auswahl ist einen Punkt wert.)
`,
    options: [
      { key: "A", text: `Deploy the Remote Help app to Device1` },
      { key: "B", text: `Assign the Help Desk Operator role (oder eine passende benutzerdefinierte Rolle) an User1` },
      { key: "C", text: `Assign the Intune Administrator role to User1 (global)` },
      { key: "D", text: `Assign a Microsoft 365 E5 license to User1 (ohne Remote Help Add-on)` },
      { key: "E", text: `Re-enroll Device1 in Intune using Windows Autopilot` },
      { key: "F", text: `Assign the Remote Help add-on (oder Intune Suite) license to User1` }
    ],
    optionsEn: [
      { key: "A", text: `Deploy the Remote Help app to Device1` },
      { key: "B", text: `Assign the Help Desk Operator role (oder eine passende Userdefinierte Role) an User1` },
      { key: "C", text: `Assign the Intune Administrator role to User1 (global)` },
      { key: "D", text: `Assign a Microsoft 365 E5 license to User1 (ohne Remote Help Add-on)` },
      { key: "E", text: `Re-enroll Device1 in Intune using Windows Autopilot` },
      { key: "F", text: `Assign the Remote Help add-on (oder Intune Suite) license to User1` }
...
Max benötigt passende RBAC-Berechtigungen in Intune, typischerweise über die integrierte Rolle "Help Desk Operator" oder eine äquivalente benutzerdefinierte Rolle, die Remote-Help-Berechtigungen enthält (Option B).

Zusätzlich wird eine passende Lizenz benötigt, z.B. Remote Help Add-on oder Intune Suite Lizenz, die Max zugewiesen sein muss (Option F).
...
`,
    explanationEn: `
Remote Help erfordert, dass die Remote-Help-App auf dem ZielDevice installiert ist; daher muss Device1 die Remote-Help-App erhalten (Option A).

Max benötigt passende RBAC-Permissionen in Intune, typischerweise über die integrierte Role "Help Desk Operator" oder eine äquivalente Userdefinierte Role, die Remote-Help-Permissionen enthält (Option B).

Zusätzlich wird eine passende Lizenz benötigt, z.B. Remote Help Add-on oder Intune Suite Lizenz, die Max zugeHowsen sein muss (Option F).

Eine globale Intune-AdministratorRole (C) ist zu weitreichend und nicht erforderlich; eine E5-Lizenz allein (D) beinhaltet Remote Help nicht automatisch; ein erneutes Enrollment des Devices (E) ist ebenfalls nicht nötig.
`
  },
...
Device1 erfüllt die Hardwareanforderungen für Windows 11.
Es läuft derzeit mit Windows 10 Enterprise (x64) und Microsoft Office 2019 ist installiert.
You want to ein In-Place Upgrade auf Windows 11 Enterprise durchführen, ohne Daten oder Applicationen zu verlieren.

Folgende Installationsimages stehen zur Verfügung:
• Image1 (x64): Custom Windows 11 Image, in das Office 2021 integriert wurde.
• Image2 (x64): Default Windows 11 Image (Original Microsoft Install.wim, unverändert).

Which Images können für ein In-Place Upgrade auf Device1 verwendet werden?
`,
    options: [
...
Custom Images, in die Applicationen (z.B. Office 2021) integriert wurden, werden für In-Place Upgrades nicht unterstützt und führen typischerweise zu Setup-Fehlern.
...
You manage ein MDT-Deployment-Share DS1.
Unter "Out-of-Box Drivers" hast du für verschiedene Hardwaremodelle eigene Ordner angelegt (z.B. Dell, HP, Lenovo).
You want to die "Inject Drivers"-Task so konfigurieren, dass MDT nur die passenden Treiber per Plug-and-Play-Erkennung (PnP) für das jeweilige Modell installiert.

Which Voraussetzung muss erfüllt sein, bevor du die Inject-Drivers-Task in einer Task Sequence entsprechend konfigurieren kannst?
`,
    options: [
      { key: "A", text: `Du musst mindestens ein Betriebssystemabbild (OS package) in das Deployment Share importieren.` },
      { key: "B", text: `Du musst zunächst Selection Profiles für jedes Hardwaremodell erstellen.` },
      { key: "C", text: `Du musst eine zusätzliche Gather Task vor Inject Drivers einfügen.` },
      { key: "D", text: `Du musst die MDT Rules (CustomSettings.ini) so anpassen, dass Model-spezifische Variablen gesetzt werden.` }
    ],
    optionsEn: [
      { key: "A", text: `You need to mindestens ein Betriebssystemabbild (OS package) in das Deployment Share importieren.` },
      { key: "B", text: `You need to zunächst Selection Profiles für jedes Hardwaremodell erstellen.` },
      { key: "C", text: `You need to eine zusätzliche Gather Task vor Inject Drivers einfügen.` },
      { key: "D", text: `You need to die MDT Rules (CustomSettings.ini) so anpassen, dass Model-spezifische Variablen gesetzt werden.` }
    ],
    correctAnswers: ["A"],
    explanation: `
...
Auf Server1 existiert ein MDT Deployment Share (MDT1).
You want to Multicast-Deployments ermöglichen, damit mehrere Clients gleichzeitig effizient dasselbe Image herunterladen können.
...
`,
    explanationEn: `
MDT selbst kann keine Multicast-Übertragungen bereitstellen. Für Multicast-Deployments wird die Windows-Server-Role "Windows Deployment Services" (WDS) benötigt.
...
In deinem Azure-AD-Tenant finanzhaus-ag.de sind mehrere Windows-11-Geräte registriert.
...
Du möchtest erzwingen, dass Benutzer beim Beitritt zu finanzhaus-ag.de eine sechsstellige PIN konfigurieren müssen.
...
In deinem Azure-AD-Tenant finanzhaus-ag.de sind mehrere Windows-11-Devicee registriert.
Wenn Devicee der Organisation beitreten, werden User aktuell aufgefordert, eine vierstellige PIN für Windows Hello for Business (WHfB) zu konfigurieren.
You want to erzwingen, dass User beim Beitritt zu finanzhaus-ag.de eine sechsstellige PIN konfigurieren müssen.
...
`,
    explanationEn: `
Die PIN-Policyn für Windows Hello for Business – einschließlich Mindestlänge und Komplexität – werden nicht über die allgemeinen User- oder Device-Settings im Entra Admin Center gesteuert.

Stattdessen werden sie über Windows-Hello- bzw. DeviceeConfigurationsPolicyn in Intune (oder per GroupnPolicyn On-Premises) konfiguriert.

Im Intune Admin Center legst du unter Devices → Windows → Windows Enrollment → Windows Hello for Business die PIN-Komplexität fest (z.B. Mindestlänge = 6).

Das bloße Anpassen der User-/Device-Settingen in Entra ändert daher nichts an der PIN-Länge, weshalb die Maßnahme das Ziel nicht erreicht.
`
  },
...
Dein Unternehmen hat einen Azure AD-Tenant bauwerk-gmbh.de mit mehreren Windows 11-Geräten.
...
Dein Unternehmen hat einen Azure AD-Tenant bauwerk-gmbh.de mit mehreren Windows 11-Deviceen.
User werden beim Devicee-Join aktuell aufgefordert, eine vierstellige PIN für Windows Hello for Business (WHfB) zu erstellen.

Geplanter Lösungsansatz:
- Im Microsoft Entra admin center wird die automatische MDM-Enrollment (MDM auto-enrollment) aktiviert.
- Im Microsoft Intune admin center wird ein Device Restrictions-Profil erstellt und zugeHowsen.

Question:
Erreicht diese Maßnahme das Ziel, dass User beim Devicee-Join künftig eine sechsstellige PIN für WHfB festlegen müssen?
`,
    options: [
      { key: "A", text: `Yes` },
      { key: "B", text: `No` }
...
`,
    explanationEn: `
Device Restriction Profiles steuern Kennwort-Policyn, aber nicht die PIN-Policy für Windows Hello for Business. PIN-Länge und Komplexität werden über die WHfB-Enrollment-Optionen/Identity Protection Profile konfiguriert, nicht über allgemeine Deviceeeinschränkungen.
`
  },
...
Dein Unternehmen besitzt einen Azure AD-Tenant energie-direkt-ag.de mit mehreren Windows 11-Geräten.
...
Dein Unternehmen besitzt einen Azure AD-Tenant energie-direkt-ag.de mit mehreren Windows 11-Deviceen.
User müssen beim Devicee-Join aktuell eine vierstellige WHfB-PIN erstellen.

Geplanter Lösungsansatz:
- Im Microsoft Entra admin center wird die automatische MDM-Enrollment konfiguriert.
- Im Microsoft Intune admin center werden die Windows Hello for Business Enrollment-Optionen angepasst (z. B. Mindest-PIN-Länge = 6).

Question:
Erreicht diese Maßnahme das Ziel, dass User künftig eine sechsstellige PIN einrichten müssen?
`,
    options: [
      { key: "A", text: `Yes` },
      { key: "B", text: `No` }
...
`,
    explanationEn: `
Die PIN-Anforderungen für Windows Hello for Business werden über die WHfB-Enrollment-Optionen (oder Identity Protection Profile) in Intune definiert. In Kombination mit MDM-Auto-Enrollment werden die WHfB-PIN-Policyn beim Devicee-Join angewendet, inklusive Mindestlänge von sechs Zeichen.
`
  },
...
You manage zwei Devicee mit Microsoft Intune:
- Device1: Windows 11
- Device2: iOS

Nach der Intune-Enrollment sollen regelmäßig Compliance-Überprüfungen durchgeführt werden.
How lauten die correcten Check-in-Intervalle für Device1 und Device2?
`,
    options: [
      { key: "A", text: `Device1: alle 8 Stunden; Device2: alle 8 Stunden` },
      { key: "B", text: `Device1: alle 15 Minuten für 1 Stunde, dann alle 8 Stunden; Device2: alle 3 Minuten für 15 Minuten, dann alle 8 Stunden` },
      { key: "C", text: `Device1: alle 3 Minuten für 15 Minuten, dann alle 15 Minuten für 2 Stunden, dann alle 8 Stunden; Device2: alle 15 Minuten für 1 Stunde, dann alle 8 Stunden` },
      { key: "D", text: `Device1: alle 15 Minuten dauerhaft; Device2: alle 15 Minuten dauerhaft` }
    ],
    optionsEn: [
      { key: "A", text: `Device1: alle 8 Stunden; Device2: alle 8 Stunden` },
      { key: "B", text: `Device1: alle 15 Minuten für 1 Stunde, dann alle 8 Stunden; Device2: alle 3 Minuten für 15 Minuten, dann alle 8 Stunden` },
...
`,
    explanationEn: `
Windows-Devicee melden sich initial sehr häufig (alle 3 Minuten, dann alle 15 Minuten) und gehen danach in einen 8-Stunden-Rhythmus über. iOS- (und Android-)Devicee melden sich initial alle 15 Minuten für ca. eine Stunde und danach ebenfalls alle 8 Stunden.
`
  },
...
You manage Android- und iOS-Devicee mit Microsoft Intune und möchtest Microsoft Tunnel bereitstellen.
Ziel ist es, die Anzahl der offenen Inbound-Firewall-Ports zu minimieren.

Question:
Auf Whichm Servertyp und mit Whichn eingehenden Ports sollte der Microsoft Tunnel Gateway installiert werden, wenn nur die minimal erforderlichen Ports geöffnet werden sollen?
`,
    options: [
...
`,
    explanationEn: `
Microsoft Tunnel läuft auf einem Linux-Server und benötigt für den Client-Traffic eingehend TCP 443 und UDP 443. Damit sind nur zwei Ports erforderlich. Zusätzliche Ports How 1723 sind nicht notwendig.
`
  },
...
Ein Unternehmen besitzt 100 Windows 10 Computer, die per Wipe & Load auf Windows 11 migriert werden sollen.
Userdaten und -Settingen sollen erhalten bleiben.

Which Reihenfolge von Aktionen ist erforderlich, um Userdateien und Settingen mit USMT zu behalten?
`,
    options: [
      { key: "A", text: `Deploy Windows 11 → Run scanstate.exe → Run loadstate.exe` },
      { key: "B", text: `Run loadstate.exe → Deploy Windows 11 → Run scanstate.exe` },
      { key: "C", text: `Run scanstate.exe → Deploy Windows 11 → Run loadstate.exe` },
      { key: "D", text: `Deploy Windows 11 → Run loadstate.exe → Run scanstate.exe` }
    ],
    optionsEn: [
      { key: "A", text: `Deploy Windows 11 → Run scanstate.exe → Run loadstate.exe` },
      { key: "B", text: `Run loadstate.exe → Deploy Windows 11 → Run scanstate.exe` },
...
`,
    explanationEn: `
Mit USMT werden Userdaten zuerst mit scanstate.exe gesichert, anschließend erfolgt das Wipe & Load Deployment (Windows 11 Neuinstallation) und danach die Howderherstellung der Daten mit loadstate.exe.
`
  },
...
Windows Autopilot – Logsammlung bei Deploymentsfehlern

You use Windows Autopilot mit Intune, um Windows 11-Devicee bereitzustellen.
Ein Support Engineer meldet, dass er bei fehlgeschlagenen Autopilot-Deploymenten keine Logs vom Device sammeln kann.

Question:
Which Configuration musst du anpassen, damit Autopilot-Logs automatisch gesammelt und über das Intune admin center heruntergeladen werden können?
`,
    options: [
...
Ein Unternehmen betreibt eine on-premises AD DS-Domäne, die per Azure AD Connect mit Azure AD synchronisiert wird.
Devicee werden über Intune und Configuration Manager verwaltet.

Anforderungen:
- Marketing-Devicee: nur AD DS-joined, komplexe Software wird intern per IT installiert.
- Sales-Devicee: Azure AD joined, Devicee werden direkt vom OEM an die User geliefert, minimaler IT-Aufwand.

Question:
Which Deploymentsmethoden sollten für Marketing bzw. Sales empfohlen werden?
`,
    options: [
      { key: "A", text: `Marketing: Windows Autopilot; Sales: Configuration Manager` },
      { key: "B", text: `Marketing: Hybrid Azure AD join via Autopilot; Sales: Bare-metal Imaging` },
      { key: "C", text: `Marketing: Intune only; Sales: Windows Autopilot (user-driven, ohne OEM-Registrierung)` },
      { key: "D", text: `Marketing: Windows Autopilot (self-deploying); Sales: Configuration Manager` },
      { key: "E", text: `Marketing: Configuration Manager; Sales: Windows Autopilot mit OEM registration` }
    ],
    optionsEn: [
      { key: "A", text: `Marketing: Windows Autopilot; Sales: Configuration Manager` },
      { key: "B", text: `Marketing: Hybrid Azure AD join via Autopilot; Sales: Bare-metal Imaging` },
      { key: "C", text: `Marketing: Intune only; Sales: Windows Autopilot (user-driven, ohne OEM-Enrollment)` },
      { key: "D", text: `Marketing: Windows Autopilot (self-deploying); Sales: Configuration Manager` },
      { key: "E", text: `Marketing: Configuration Manager; Sales: Windows Autopilot mit OEM registration` }
    ],
    correctAnswers: ["E"],
...
`,
    explanationEn: `
Marketing benötigt klassische on-premises Domänen-Clients mit komplexen Softwareinstallationen – ideal für Configuration Manager. Sales-Devicee sollen direkt vom Hersteller an die User gehen und Azure AD joined sein – ideal für Windows Autopilot mit OEM-Enrollment.
`
  },
...
Windows 10 Pro → Enterprise Upgrade mit minimaler Userinteraktion

Einige User nutzen privat gekaufte Devicee mit Windows 10 Pro.
Du sollst:
- auf Windows 10 Enterprise upgraden,
- Azure AD-Join durchführen,
- Microsoft Store-Apps automatisch installieren,
ohne Userdaten oder Apps zu verlieren und mit minimaler Userinteraktion.

Question:
Which Lösung erfüllt die Anforderungen am besten?
`,
    options: [
      { key: "A", text: `Microsoft Deployment Toolkit (MDT) Task Sequence` },
      { key: "B", text: `Windows Deployment Services (WDS) Bare-Metal Deployment` },
    ...
    optionsEn: [
      ...
      { key: "B", text: `Windows Deployment Services (WDS) Bare-Metal Deployment` },
      { key: "C", text: `Windows Configuration Designer Provisioning Package` },
      { key: "D", text: `Windows Autopilot Reset und Neu-Deployment` }
    ],
    correctAnswers: ["C"],
    explanation: `
...
`,
    explanationEn: `
Ein Provisioning Package (.ppkg), erstellt mit Windows Configuration Designer, kann Edition-Upgrade, Azure AD-Join und App-Deployment durchführen, ohne das OS neu zu installieren und ohne Userdaten zu verlieren.
`
  },
...
- CAPolicy1: Tom, Plattformen Windows/iOS, Grant → Require MFA.
- CAPolicy2: Tom + Sarah, Plattformen Android/iOS, Gerätefilter: Geräte mit Namen, die '1' enthalten, werden ausgeschlossen; Grant → Block access.
...
1) Tom von Device1 (Android) → MFA erforderlich.
2) Sarah von Device1 (Android) → MFA erforderlich.
3) Sarah von Device2 (iOS) → Zugriff möglich.
...
Conditional Access – MehrfachPolicyn & Deviceefilterung

You have zwei Conditional Access Policies für Exchange Online:
- CAPolicy1: Tom, Plattformen Windows/iOS, Grant → Require MFA.
- CAPolicy2: Tom + Sarah, Plattformen Android/iOS, Deviceefilter: Devicee mit Namen, die '1' enthalten, werden ausgeschlossen; Grant → Block access.
...
Which Kombination beschreibt das tatsächliche Verhalten?
`,
    options: [
      { key: "A", text: `1) Ja, 2) Ja, 3) Ja` },
      { key: "B", text: `1) Nein, 2) Nein, 3) Nein – Zugriff wird blockiert` },
      { key: "C", text: `1) Nein, 2) Nein, 3) Ja` },
      { key: "D", text: `1) Ja, 2) Nein, 3) Nein` }
    ],
    optionsEn: [
      { key: "A", text: `1) Yes, 2) Yes, 3) Yes` },
      { key: "B", text: `1) No, 2) No, 3) No – Zugriff wird blockiert` },
      { key: "C", text: `1) No, 2) No, 3) Yes` },
      { key: "D", text: `1) Yes, 2) No, 3) No` }
    ],
    correctAnswers: ["B"],
    explanation: `
Device1 wird durch den Gerätefilter von CAPolicy2 ausgeschlossen, daher greifen keine CA-Richtlinien für Tom oder Sarah auf Device1 → kein MFA, kein Block. Device2 (iOS, Name enthält '2') fällt unter CAPolicy2 mit Block access, daher wird Sarah auf Device2 blockiert. Damit sind die Aussagen 'MFA erforderlich' bzw. 'Zugriff möglich' in allen drei Fällen falsch.
`,
    explanationEn: `
Device1 wird durch den Deviceefilter von CAPolicy2 ausgeschlossen, daher greifen keine CA-Policyn für Tom oder Sarah auf Device1 → kein MFA, kein Block. Device2 (iOS, Name enthält '2') fällt unter CAPolicy2 mit Block access, daher wird Sarah auf Device2 blockiert. Damit sind die Aussagen 'MFA erforderlich' bzw. 'Zugriff möglich' in allen drei Fällen incorrect.
`
  },
...
Microsoft Defender for Endpoint Policies auf macOS-Deviceen anwenden

You manage 500 macOS-Devicee, die bereits in Microsoft Intune eingeschrieben sind.
You want to mit minimalem administrativen Aufwand Microsoft Defender for Endpoint Antivirus-Policyn auf diese Devicee anwenden.

Question:
What should you do?
`,
    options: [
      { key: "A", text: `Im Microsoft Endpoint Manager admin center ein Konfigurationsprofil für Microsoft Defender for Endpoint erstellen und zuweisen` },
      { key: "B", text: `Eine Security Baseline im Endpoint Manager erstellen und auf macOS-Geräte anwenden` },
      { key: "C", text: `macOS-Geräte im Microsoft 365 Purview Compliance Center onboarden` },
      { key: "D", text: `Defender for Endpoint manuell auf allen macOS-Geräten installieren` }
    ],
    optionsEn: [
      { key: "A", text: `Im Microsoft Endpoint Manager admin center ein Configurationsprofil für Microsoft Defender for Endpoint erstellen und zuweisen` },
      { key: "B", text: `Eine Security Baseline im Endpoint Manager erstellen und auf macOS-Devicee anwenden` },
      { key: "C", text: `macOS-Devicee im Microsoft 365 Purview Compliance Center onboarden` },
      { key: "D", text: `Defender for Endpoint manuell auf allen macOS-Deviceen installieren` }
    ],
    correctAnswers: ["A"],
    explanation: `
...
`,
    explanationEn: `
Die empfohlene Methode ist die Deployment von Defender for Endpoint für macOS über ein Intune-Configurationsprofil (Onboarding-Profil). Dadurch kann Defender zentral ausgerollt und verwaltet werden, ohne manuelle Installation auf jedem Device.
`
  },
...
Question:
Erfüllt diese Lösung das Ziel eines In-Place-Upgrades mit Erhalt von Userdaten und Applicationen?
`,
    options: [
      { key: "A", text: `Yes` },
      { key: "B", text: `No` }
...
`,
    explanationEn: `
Die Standard Client Upgrade Task Sequence in MDT ist explizit für In-Place-Upgrades (z. B. Windows 10 → Windows 11) vorgesehen und erhält Userprofile und Applicationen.
`
  },
...
Question:
Erreicht dieses Vorgehen ein echtes In-Place-Upgrade mit Erhalt von Userdaten und Applicationen?
`,
    options: [
      { key: "A", text: `Yes` },
      { key: "B", text: `No` }
...
Question:
Erreicht dieses Vorgehen ein In-Place-Upgrade mit Erhalt von Userprofilen und Applicationen?
`,
    options: [
      { key: "A", text: `Yes` },
      { key: "B", text: `No` }
...
Question:
Erfüllt dieses Vorgehen das Ziel eines In-Place-Upgrades mit Erhalt von Userprofilen und Applicationen?
`,
    options: [
      { key: "A", text: `Yes` },
      { key: "B", text: `No` }
...
`,
    explanationEn: `
Ein In-Place-Upgrade wird erreicht, wenn setup.exe im Kontext des laufenden Windows 10 ausgeführt wird. Dabei können Userdateien und Programme beibehalten werden.
`
  },
...
Benutzer:
- Finn ist Mitglied in Group1 und Group2.
- Emma ist nur Mitglied in Group2.
...
You have einen Azure AD Premium P2 Tenant mit folgenden Settingen:
- MDM user scope: Group1
- MAM user scope: Group2
...
Question:
Bewerte, in Whichn Fällen eine automatische Deviceeeinschreibung in Intune möglich ist.
`,
    options: [
      { key: "A", text: `User1 kann Device1 automatisch registrieren; User1 kann Device2 automatisch registrieren; User2 kann Device1 automatisch registrieren` },
      { key: "B", text: `User1 kann Device1 automatisch registrieren; User1 kann Device2 automatisch registrieren; User2 kann Device1 nicht automatisch registrieren` },
      { key: "C", text: `User1 kann Device1 automatisch registrieren; User1 kann Device2 nicht automatisch registrieren; User2 kann Device1 nicht automatisch registrieren` },
      { key: "D", text: `User1 kann Device1 nicht automatisch registrieren; User1 kann Device2 automatisch registrieren; User2 kann Device1 automatisch registrieren` }
    ],
    optionsEn: [
      { key: "A", text: `User1 kann Device1 automatisch registrieren; User1 kann Device2 automatisch registrieren; User2 kann Device1 automatisch registrieren` },
      { key: "B", text: `User1 kann Device1 automatisch registrieren; User1 kann Device2 automatisch registrieren; User2 kann Device1 nicht automatisch registrieren` },
    ...
    correctAnswers: ["C"],
    explanation: `
Nur Benutzer im MDM user scope (Group1) können Geräte automatisch in Intune registrieren. Finn ist in Group1 → Device1 kann automatisch registriert werden. MAM scope (Group2) steuert nur App-Schutzrichtlinien, nicht die Geräteeinschreibung. Emma ist nur in Group2 → keine automatische Geräteeinschreibung.
`,
    explanationEn: `
Nur User im MDM user scope (Group1) können Devicee automatisch in Intune registrieren. Finn ist in Group1 → Device1 kann automatisch registriert werden. MAM scope (Group2) steuert nur App-SchutzPolicyn, nicht die Deviceeeinschreibung. Emma ist nur in Group2 → keine automatische Deviceeeinschreibung.
`
  },
...
In Intune verwaltest du drei Devicee:
- Device1: Windows 11, Intune MDM
- Device2: Android, Intune MDM
- Device3: iOS, Intune MDM

Im Intune admin center wurde ein Standort 'Location1' als Unternehmensnetzwerk definiert.
You want to network location-based Compliance (Network Fencing) nutzen.

Question:
Which Devicee können network location-based Compliance policies verwenden?
`,
    options: [
      { key: "A", text: `Nur Device1` },
...
Intune Data Warehouse – Deviceeinventarbericht

You want to einen Deviceeinventarbericht erstellen, der Daten aus dem Intune Data Warehouse verwendet.

Question:
Whichs Tool solltest du verwenden, um den Bericht zu erstellen?
`,
    options: [
...
Paul (Mitglied von Group1) kann jedoch weiterhin von iOS auf Exchange zugreifen.
...
You have eine Conditional Access Policy CAPolicy1 erstellt,
die den Zugriff auf Exchange Online von iOS-Deviceen für Group1 blockieren soll.
Paul (Mitglied von Group1) kann jedoch weiterhin von iOS auf Exchange zugreifen.

Question:
What do you need to do, um sicherzustellen, dass CAPolicy1 tatsächlich durchgesetzt wird?
`,
    options: [
    ...
    optionsEn: [
      ...
      { key: "B", text: `CAPolicy1 zusätzlich Group2 zuweisen` },
      { key: "C", text: `CAPolicy1 aktivieren (Enable Policy = On)` },
      { key: "D", text: `In CAPolicy1 einen Deviceefilter hinzufügen` }
    ],
    correctAnswers: ["C"],
    explanation: `
...
Dies ist ein Platzhalterobjekt für Q89.
Bitte ersetze Frage, Optionen, correcte Antwort und Erklärung später durch den tatsächlichen Inhalt.
`,
    options: [
...
You manage 1.000 Windows 11-Devicee, die alle in Intune registriert sind.
You want to Intune mit Microsoft Defender for Endpoint integrieren,
damit DeviceeSecuritysrisiken (Risk Level) in Intune für Compliance und Conditional Access nutzbar sind.

Question:
Which Setting im Intune admin center muss konfiguriert werden,
um eine Service-to-Service-Verbindung zwischen Intune und Defender for Endpoint herzustellen?
`,
    options: [
...
## Szenario
Dein Unternehmen verwendet **Windows Autopilot** zur Deployment neuer Windows 11-Devicee.
Es gibt zwei Deviceetypen:

- **Sales-Laptops**: Werden direkt vom OEM an die User geliefert,
  sollen **Azure AD joined** sein und **vom User selbst eingerichtet** werden.
- **Kiosk-PCs** im Foyer: Stehen öffentlich, werden **nicht von Usern personalisiert**,
  laufen mit einem **festen Kiosk-Account**, keine Userinteraktion bei der Deployment.

Du willst für beide Deviceetypen den passenden **Autopilot Deployment Mode** wählen.

## Aufgabe
Ordne den **correcten Autopilot-Modus** dem jeweiligen Szenario zu.

Which Kombination ist correct?

`,
    options: [
      { key: "A", text: `Sales-Laptops: Self-deploying mode | Kiosk: User-driven mode` },
      { key: "B", text: `Sales-Laptops: Pre-provisioned deployment | Kiosk: Self-deploying mode` },
      { key: "C", text: `Sales-Laptops: User-driven mode | Kiosk: Self-deploying mode` },
      { key: "D", text: `Sales-Laptops: User-driven mode | Kiosk: Pre-provisioned deployment` }
    ],
    optionsEn: [
      { key: "A", text: `Sales-Laptops: Self-deploying mode | Kiosk: User-driven mode` },
      { key: "B", text: `Sales-Laptops: Pre-provisioned deployment | Kiosk: Self-deploying mode` },
...
- **User-driven mode**:
  - Für **EndUserDevicee**.
  - Die User melden sich während des OOBE-Prozesses mit ihrem **Azure AD-Konto** an.
  - Ergebnis: Device wird **Azure AD joined** und in **Intune enRoled**.

- **Self-deploying mode**:
  - Für **Shared Devices, Kiosks, Digital Signage, Shared PCs**.
  - **Keine Usereingabe** für den Join.
  - Device meldet sich selbstständig bei Autopilot, wird **Azure AD joined** und in **Intune** aufgenommen.
  - Oft mit einem festen lokalen / Azure AD-Konto oder Kiosk-Configuration kombiniert.

### 💼 Application auf das Szenario
**Sales-Laptops**:
- Devicee werden vom OEM direkt zu den Anwendern geliefert.
- Die Nutzer sollen **ihre Devicee selbst einrichten** und sich mit ihrem Firmenkonto anmelden.
- Genau dafür ist der **User-driven mode** gedacht.

**Kiosk-PCs**:
- Öffentliche PCs, keine persönliche Anmeldung, kein individueller Userkontext.
- Sie sollen **ohne Interaktion** bereitgestellt werden.
- Typischer Einsatzfall für **Self-deploying mode**.

### ❌ Why die anderen Optionen incorrect sind
- **A**: Vertauscht – Sales im Self-deploying Mode passt nicht, da Userinteraktion gewünscht ist.
- **B**: Pre-provisioned (White Glove) ist vor allem für IT/OEM-Vorbereitung, aber nicht speziell für Kiosk ohne User.
- **D**: Kiosk mit Pre-provisioned ist möglich, aber nicht der passende Modus, wenn die Frage explizit nach dem Kiosk-Autopilot-Modus fragt.

📌 **Merksatz:**
- **User-driven** = User klickt sich durch OOBE.
- **Self-deploying** = Device macht alles allein (Kiosk, Shared).
`
  },
...
## Szenario
Dein Unternehmen hat **500 Windows 10 21H2** Devicee, alle:

- **Azure AD joined**
- über **Intune verwaltet**
- produktiv im Einsatz

You want to alle Devicee auf **Windows 11 23H2** aktualisieren,
ohne Userdaten oder installierte Applicationen zu verlieren.

You plan to, in Intune eine **Feature Update Policy for Windows 10 and later** zu konfigurieren
und auf eine DeviceeGroup anzuwenden.

## Frage
Which Aussage beschreibt correct, was passiert?

`,
    options: [
      { key: "A", text: `Die Geräte führen ein Clean Install (Wipe & Load) auf Windows 11 durch und alle Apps werden entfernt.` },
      { key: "B", text: `Die Geräte führen ein In-place Upgrade auf Windows 11 durch und behalten Daten und Apps.` },
      { key: "C", text: `Die Geräte müssen zuerst hybrid Azure AD joined werden, bevor ein Feature Update angewendet werden kann.` },
      { key: "D", text: `Feature Update Policies können nur auf Windows 10, nicht auf Windows 11 angewendet werden.` }
    ],
    optionsEn: [
      { key: "A", text: `Die Devicee führen ein Clean Install (Wipe & Load) auf Windows 11 durch und alle Apps werden entfernt.` },
      { key: "B", text: `Die Devicee führen ein In-place Upgrade auf Windows 11 durch und behalten Daten und Apps.` },
      { key: "C", text: `Die Devicee müssen zuerst hybrid Azure AD joined werden, bevor ein Feature Update angewendet werden kann.` },
      { key: "D", text: `Feature Update Policies können nur auf Windows 10, nicht auf Windows 11 angewendet werden.` }
    ],
    correctAnswers: ["B"],
    explanation: `
...
`,
    explanationEn: `
## ✅ correcte Antwort
**B) Die Devicee führen ein In-place Upgrade auf Windows 11 durch und behalten Daten und Apps.**
...
- Arbeiten auf bereits **installierten Windows-Versionen**.
- Führen ein **In-place Upgrade** durch:
  - Userprofile bleiben erhalten.
  - Installierte Applicationen bleiben erhalten.
  - Settingen bleiben weitgehend erhalten.

### Why ist B correct?
Im Scenario:
- Windows 10 21H2 → Ziel: Windows 11 23H2
- Devicee sind bereits **Azure AD joined** und intune-managed.
- Feature Update Policy wählt die Zielversion aus.

Intune veranlasst ein **In-place Upgrade** auf die gewünschte Version.
Das ist genau dafür gedacht, produktive Devicee ohne Wipe & Load zu aktualisieren.

### ❌ Why sind die anderen Antworten incorrect?
- **A – Clean Install / Wipe & Load:**
  - Feature Update Policies machen *kein* Clean Install.
  - Stattdessen wird das bestehende System auf eine neue Buildversion **hochgezogen**.

- **C – Zwang zu Hybrid Join:**
  - Feature Updates funktionieren mit **Azure AD joined** Deviceen problemlos.
  - Hybrid ist nicht Voraussetzung.
...
# 🧩 113 – Intune Filters für dynamische Policynzuweisung

## Szenario
You manage Windows-Devicee über Intune und verwendest **Azure AD-Groupn** zur Zuweisung von:

- DeviceeConfigurationsprofilen
- Compliance Policies
- App-Zuweisungen

You want to neue Policyn nur auf **Windows 11 Enterprise** Devicee anwenden,
ohne deine Groupnstruktur in Azure AD zu verändern.

## Aufgabe
You plan to, **Intune Filters** zu nutzen.

Which Aussage beschreibt correct, How Intune Filters funktionieren?

`,
    options: [
      { key: "A", text: `Filters ersetzen Azure AD-Gruppen vollständig und sollten statt Gruppen verwendet werden.` },
      { key: "B", text: `Filters werden bei der Richtlinienzuweisung zusätzlich zu Gruppen ausgewertet, um Zielgeräte ein- oder auszuschließen.` },
      { key: "C", text: `Filters können nur für App-Zuweisungen, nicht für Konfigurationsprofile verwendet werden.` },
      { key: "D", text: `Filters basieren nur auf Benutzerattributen, nicht auf Geräteeigenschaften.` }
    ],
    optionsEn: [
      { key: "A", text: `Filters ersetzen Azure AD-Groupn vollständig und sollten statt Groupn verwendet werden.` },
      { key: "B", text: `Filters werden bei der Policynzuweisung zusätzlich zu Groupn ausgewertet, um ZielDevicee ein- oder auszuschließen.` },
      { key: "C", text: `Filters können nur für App-Zuweisungen, nicht für Configurationsprofile verwendet werden.` },
      { key: "D", text: `Filters basieren nur auf Userattributen, nicht auf Deviceeeigenschaften.` }
    ],
    correctAnswers: ["B"],
    explanation: `
## ✅ Richtige Antwort
...
`,
    explanationEn: `
## ✅ correcte Antwort
**B) Filters werden bei der Policynzuweisung zusätzlich zu Groupn ausgewertet, um ZielDevicee ein- oder auszuschließen.**

### 🔍 Was sind Intune Filters?
Intune Filters sind **zusätzliche Kriterien**, die bei der Zuweisung von Policyn verwendet werden.

- Sie werden **zusätzlich** zu Azure AD-Groupn konfiguriert.
- Du weist eine Policy **z. B. der Group „All Windows devices“** zu und verwendest einen Filter,
  um nur Devicee zu treffen, die bestimmten Kriterien entsprechen.

Beispiele für Filterkriterien:
- OS-Typ (Windows, iOS, Android)
- OS-Version (z. B. 10.0.22631 für Windows 11)
- Deviceemanagement-Typ (MDM, Co-managed)
- Manufacturer, Device model, Device category etc.

### Application im Szenario
Du willst **nur Windows 11 Enterprise** Devicee treffen.
Du kannst z. B. Folgendes tun:

1. Policy an **eine breite Group** zuweisen (z. B. „All Windows Clients“).
2. Einen Filter definieren: \`osVersion >= 10.0.22000\` UND \`edition == Enterprise\`.
3. Filter als **Include filter** an die Policy anhängen.

Damit musst du **nicht** neue, fein granulare Azure AD-Groupn bauen.

### ❌ Why sind die anderen Antworten incorrect?
- **A – Ersetzen Groupn:**
  - Filters ergänzen Groupn, sie ersetzen sie nicht.
  - Ohne Group keine Zuweisung – Filter arbeiten *on top*.

- **C – Nur Apps:**
  - Filters funktionieren für **Configurationsprofile, Compliance Policies, Apps** usw.

- **D – Nur Userattribute:**
  - Filters sind primär auf **Deviceeeigenschaften** ausgerichtet, nicht auf Userattribute.

📌 **Merksatz:**
**Group = Wer grundsätzlich Ziel ist. Filter = Which Devicee innerhalb der Group es wirklich trifft.**
`
  },
...
## Szenario
Ein Windows 11-Device ist:

- **Azure AD joined**
- **In Intune enRoled**
- einem User zugeordnet, der das Unternehmen verlässt.

You want to das Device:
- für einen **neuen User in derselben Abteilung** vorbereiten,
- **Autopilot-Enrollment und Entra / Intune-Zuordnung behalten**,
- **OEM-Apps entfernen**,
- nur **Userdateien und -apps** zurücksetzen.

## Frage
Which Remote-Aktion in Intune ist am besten geeignet?
...
### 🔍 Vergleich der Aktionen
**Wipe**:
- Setzt das Device vollständig zurück.
- Entfernt alle User- und Firmendaten.
- Autopilot-Enrollment bleibt *in der Cloud* bestehen,
  aber auf dem Device wird ein kompletter Neuaufsetzungsprozess gestartet.
- Wird oft für Devicee genutzt, die an andere Standorte / Firmen gehen.

**Fresh Start**:
- Entfernt OEM-Bloatware und installiert Windows neu,
- behält optional einige Settingen und Daten.
- Ist **nicht** spezifisch für Autopilot-Szenarien
  und wird eher zur Bereinigung / Performanceoptimierung genutzt.

**Autopilot Reset**:
- Setzt das Device in einen **sauberen, betriebsbereiten Zustand** zurück.
- Entfernt **Userprofile, installierte Applicationen und lokale Änderungen**.
- **Behält Autopilot-Enrollment**, Azure AD Join und Intune Enrollment.
- Nach dem Reset startet das Device Howder im **„Business-ready“-Zustand**,
  sodass ein neuer User es einfach in Betrieb nehmen kann.

### Application im Szenario
Du willst:
- Das Device **für einen neuen Mitarbeiter** Howderverwenden.
- **Autopilot-Configuration und Intune-Management** sollen bleiben.
- Der Prozess soll **möglichst automatisiert** und standardisiert sein.

Genau dafür ist **Autopilot Reset** gedacht.

### ❌ Why nicht Wipe oder Fresh Start?
- **Wipe**:
  - Eher für „Device verlässt das Unternehmen“.
  - Es müsste danach erneut vollständig bereitgestellt werden.
...
# 🧩 115 – DeviceeCompliance und Conditional Access – Nicht konforme Devicee blockieren

## Szenario
You manage Devicee mit **Intune** und Useridentitäten mit **Entra ID (Azure AD)**.

Ziel:
- Nur **konforme Devicee** dürfen auf **Exchange Online** zugreifen.
- Nicht konforme Devicee sollen **automatisch blockiert** werden.

You have bereits:
- Eine **Compliance Policy** erstellt und Deviceen zugeHowsen.
- Devicee werden correct als *compliant* oder *non-compliant* angezeigt.

## Frage
Was musst du zusätzlich konfigurieren, um sicherzustellen, dass **nicht konforme Devicee keinen Zugriff** auf Exchange Online erhalten?

`,
    options: [
      { key: "A", text: `Eine App configuration policy für Exchange Online erstellen` },
      { key: "B", text: `Eine Conditional Access Policy erstellen, die nur Zugriff von compliant devices erlaubt` },
      { key: "C", text: `Die Compliance Policy so ändern, dass non-compliant Geräte automatisch gelöscht werden` },
      { key: "D", text: `Im Intune Admin Center die Option "Block noncompliant devices" global aktivieren` }
    ],
    optionsEn: [
      { key: "A", text: `Eine App configuration policy für Exchange Online erstellen` },
      { key: "B", text: `Eine Conditional Access Policy erstellen, die nur Zugriff von compliant devices erlaubt` },
      { key: "C", text: `Die Compliance Policy so ändern, dass non-compliant Devicee automatisch gelöscht werden` },
      { key: "D", text: `Im Intune Admin Center die Option "Block noncompliant devices" global aktivieren` }
    ],
    correctAnswers: ["B"],
    explanation: `
...
### 🔍 Zusammenspiel: Compliance Policy & Conditional Access
- **Compliance Policies** legen fest:
  - Which technischen Anforderungen ein Device erfüllen muss.
  - Example: BitLocker aktiv, Secure Boot, aktuelles OS, kein Yesilbreak/Root.
  - Ergebnis: Device ist **compliant** oder **non-compliant**.

- **Conditional Access Policies** legen fest:
  - Wer auf **Which Cloud-App** zugreifen darf.
  - Unter **Whichn Bedingungen** (z. B. MFA, compliant device, location).

Allein eine **Compliance Policy** blockiert keinen Zugriff.
Erst in Kombination mit **Conditional Access** entsteht:

> "Zulasse Zugriff **nur**, wenn das Device **compliant** ist."

### Konkretes Setup
1. **Compliance Policy** (bereits vorhanden):
   - Markiert Device als compliant/non-compliant.

2. **Conditional Access Policy** für Exchange Online:
   - **Assignments → Users/Groups**: ZielUser auswählen.
   - **Cloud apps**: \`Office 365 / Exchange Online\`.
   - **Conditions → Device platforms**: optional einschränken.
   - **Access controls → Grant**:
     - \`Grant access\`
...
Ergebnis:
- Device ist **compliant** → Zugriff erlaubt.
- Device ist **non-compliant** → Zugriff blockiert.

### ❌ Why sind die anderen Antworten incorrect?
- **A – App configuration policy**:
  - Steuert App-Settingen, aber keinen Zugriffsblock basierend auf Compliance.
...
📌 **Merksatz:**
**Compliance sagt, How sicher das Device ist – Conditional Access entscheidet, ob es trotz allem rein darf.**
`
  },
...
# 🧩 116 – Wahl des correcten App-Typs in Intune – Win32 vs. Store-App

## Szenario
You want to eine klassische **Win32-Application (Setup.exe)** auf
**Windows 11 Enterprise** Clients verteilen.
...
- Es gibt ein **Setup.exe** mit mehreren Parametern.
- Die App muss mit **Custom Install- und Uninstall-Commands** installiert werden.
- You want to **detection rules** konfigurieren (Registry/File Check).

## Frage
Whichn App-Typ solltest du in Intune verwenden?
...
- **Windows app (Win32)**:
  - Verpackt als **.intunewin** (über das Win32 Content Prep Tool).
  - Ideal für **klassische Win32-Applicationen (EXE, MSI mit Parametern)**.
  - Unterstützt:
    - Custom Install- & Uninstall-Commands
    - Detection Rules (File, Registry, MSI)
    - Abhängigkeiten, Supersedence etc.
...
- **Microsoft Store app (new)**:
  - Für Apps aus dem Microsoft Store.
  - Kein klassisches \`setup.exe\`, sondern Store-basierte Deployment.
...
### ❌ Why sind die anderen Optionen incorrect?
- **B – Store app (new)**:
  - Nur sinnvoll, wenn die App im Store vorliegt.
...
## Szenario
Dein Unternehmen setzt **einen Drittanbieter-Virenscanner** auf Windows 11-Deviceen ein.
You want to **Microsoft Defender Antivirus** nur als **Echtzeit-Scanner im Hintergrund** nutzen,
der aber **keinen Konflikt** mit der bestehenden Lösung verursacht.
...
## Frage
In Whichm Modus sollte Microsoft Defender Antivirus konfiguriert werden?
...
### Application im Szenario
You have bereits einen Drittanbieter-AV und möchtest:
- Defender nicht als **primäre Engine**,
- aber weiterhin **Telemetrie und Schutzfunktionen** für MDE nutzen.
...
- **D – Audit mode**:
  - Bezieht sich nicht auf die Role als primäre AV-Engine.
...
## Szenario
Deine Organisation setzt **Intune** und **Microsoft 365 E5** ein.
You have das Problem, dass auf einigen Windows 11-Deviceen:

- Ein Registry-Key für eine bestimmte Application fehlt.
- Wenn der Key fehlt, startet die Application nicht correct.
...
## Frage
Whichs Intune-Feature ist dafür am besten geeignet?

`,
    options: [
      { key: "A", text: `Device configuration profile (OMA-URI)` },
      { key: "B", text: `Intune PowerShell scripts (Run once)` },
      { key: "C", text: `Proactive remediations (Remediation scripts) in Endpoint analytics` },
    ...
    optionsEn: [
      ...
      { key: "B", text: `Intune PowerShell scripts (Run once)` },
      { key: "C", text: `Proactive remediations (Remediation scripts) in Endpoint analytics` },
      { key: "D", text: `Compliance policy mit Userdefinierter Regel` }
    ],
    correctAnswers: ["C"],
    explanation: `
## ✅ Richtige Antwort
...
### 🔍 Was sind Proactive Remediations?
Proactive Remediations sind ein Feature in **Endpoint Analytics** (Teil von Intune),
mit dem du **Howderkehrende Checks und Reparaturen** auf Clients ausführen kannst.

Sie bestehen aus zwei Skripten:
- **Detection script**: Prüft, ob ein Problem vorliegt.
- **Remediation script**: Führt eine correctur durch, wenn nötig.

Typische Einsätze:
- Registry-Fix ausRolen, wenn Key fehlt.
- Bestimmte Dienste sicherstellen (z. B. Windows Update Dienst läuft).
- Bereinigung von veralteten Configurationen.

### Application im Szenario
Du willst:
- Howderholt prüfen, ob ein Registry-Key vorhanden ist.
- Wenn nicht, automatisch einen Key setzen.

Genau das leisten **Proactive Remediations**.

### ❌ Why sind die anderen Optionen weniger geeignet?
- **A – Device configuration profile (OMA-URI)**:
  - Funktioniert für bekannte MDM-Settingen,
  - aber hier handelt es sich um **beliebige Registry-Fixes**.

- **B – Intune PowerShell scripts (Run once)**:
  - Standardmäßig werden diese nur **einmal** beim Enroll bzw. bei Zuweisung ausgeführt.
  - Kein Howderkehrendes Monitoring + Remediation.
...
📌 **Merksatz:**
**Howderkehrende „Check & Fix“-Jobs auf Windows-Clients → Proactive Remediations.**
`
  },
...
## Szenario
Dein Unternehmen möchte die **lokalen Administratorpasswörter** auf Windows 11-Deviceen:

- Einzigartig pro Device halten
- Regelmäßig rotieren
- Sicher in der Cloud speichern
...
You plan to, die **Cloud-basierte Windows LAPS-Integration** zu verwenden.
...
`,
    ...
    optionsEn: [
      { key: "A", text: `Nur lokal im TPM des Devices` },
      { key: "B", text: `In einem geheimen Attribut des lokalen SAM` },
      { key: "C", text: `In Microsoft Entra ID (Azure AD), im Deviceeobjekt` },
      { key: "D", text: `In Intune als Userdefiniertes Attribut` }
    ],
    correctAnswers: ["C"],
    explanation: `
## ✅ Richtige Antwort
...
`,
    explanationEn: `
## ✅ correcte Antwort
**C) In Microsoft Entra ID (Azure AD), im Deviceeobjekt**
...
Bei **Azure AD joined** Deviceen mit Cloud-LAPS:
- Das lokale Administratorpasswort wird **verschlüsselt** an Entra ID übertragen.
- Es wird **im Deviceeobjekt** in Entra gespeichert.
- Administratoren mit entsprechender Permission können das Passwort einsehen
  (z. B. über Entra Portal oder PowerShell).
...
📌 **Merksatz:**
**Cloud-LAPS (für Azure AD joined Clients) speichert das Passwort im Entra-Deviceeobjekt.**
`
  },
...
## Szenario
You create eine **Compliance Policy** für Windows 11-Devicee mit folgenden Anforderungen:

- **Device must be encrypted with BitLocker** = Required
- **Trusted Platform Module (TPM) required** = Required

Ein Device **Device1** hat folgende Eigenschaften:
...
## Frage
How wird Device1 nach Application der Compliance Policy bewertet?

`,
    options: [
      { key: "A", text: `Compliant, weil ein TPM vorhanden ist` },
      { key: "B", text: `Compliant, weil mindestens eine Bedingung erfüllt ist` },
      { key: "C", text: `Non-compliant, weil BitLocker fehlt` },
      { key: "D", text: `Non-compliant, aber nur, wenn auch Secure Boot deaktiviert ist` }
    ],
    optionsEn: [
      { key: "A", text: `Compliant, weil ein TPM vorhanden ist` },
      { key: "B", text: `Compliant, weil mindestens eine Bedingung erfüllt ist` },
...
### 🔍 How Compliance Policies auswerten
Eine Compliance Policy mit mehreren Anforderungen verwendet **logisches UND**:

- BitLocker erforderlich **UND**
- TPM erforderlich

Das Device ist nur **compliant**, wenn **alle Bedingungen** erfüllt sind.

### Application auf Device1
- TPM: ✅ vorhanden
- BitLocker: ❌ nicht aktiviert
...
- **B – Eine Bedingung reicht:**
  - incorrect, Compliance-Regeln sind standardmäßig **konjunktiv (UND)**.
...
You plan to, den Workload **Windows Updates** von Configuration Manager zu Intune zu verschieben,
möchtest aber, dass **alle anderen Workloads vorerst in SCCM** bleiben.

## Frage
Which Setting musst du anpassen, um nur den Windows Update Workload auf Intune umzustellen?

`,
    options: [
      { key: "A", text: `In Intune ein Windows Update Ring erstellen – mehr ist nicht nötig.` },
      { key: "B", text: `Im Co-management properties den Slider für „Compliance policies“ auf Intune setzen.` },
      { key: "C", text: `Im Co-management properties den Slider für „Windows Update policies“ auf Intune setzen.` },
      { key: "D", text: `Die Geräte neu in Intune ohne Co-management registrieren.` }
    ],
    optionsEn: [
      { key: "A", text: `In Intune ein Windows Update Ring erstellen – mehr ist nicht nötig.` },
      { key: "B", text: `Im Co-management properties den Slider für „Compliance policies“ auf Intune setzen.` },
      { key: "C", text: `Im Co-management properties den Slider für „Windows Update policies“ auf Intune setzen.` },
      { key: "D", text: `Die Devicee neu in Intune ohne Co-management registrieren.` }
    ],
    correctAnswers: ["C"],
    explanation: `
## ✅ Richtige Antwort
...
📌 **Merksatz:**
**Bei Co-management steuert der Workload-Slider, Whichs System das Sagen hat.**
`
  },
...
# 🧩 122 – iOS App Protection Policy – Zielebene User vs. Device

## Szenario
Dein Unternehmen verfolgt ein **BYOD-Konzept** für iOS/iPadOS:

- User bringen private iPhones mit.
- Devicee werden **nicht als MDM-Device** in Intune eingeschrieben.
- You want to nur **Unternehmensdaten in Apps** schützen (z. B. Outlook, OneDrive).

You create eine **App Protection Policy (APP)** für iOS.

## Frage
Auf Which Ebene sollte die Policy angewendet werden, damit sie unabhängig vom physischen Device wirkt?
...
`,
    ...
    optionsEn: [
      { key: "A", text: `Auf Deviceeebene (Device targeted)` },
      { key: "B", text: `Auf Userbasis (User targeted)` },
      { key: "C", text: `Auf Groupn von iOS-Deviceen in Intune` },
      { key: "D", text: `Nur über eine Compliance Policy` }
    ],
    correctAnswers: ["B"],
    explanation: `
...
`,
    explanationEn: `
## ✅ correcte Antwort
**B) Auf Userbasis (User targeted)**

### 🔍 Hintergrund: App Protection Policies (APP)
App Protection Policies schützen **Unternehmensdaten in Apps**, nicht das gesamte Device.

Typische Szenarien:
- BYOD-Devicee ohne vollwertige MDM-Einschreibung.
- Nur bestimmte Apps (Outlook, Teams, OneDrive) werden kontrolliert.

APPs werden in Intune immer **Usern** zugeHowsen:
- Zuweisung an **UserGroupn (Azure AD)**.
- Der Schutz folgt dem **Userkonto**, egal auf Whichm Device er die App verwendet.
...
Daher muss die Policy **User-basiert** zugeHowsen werden.
Wenn sich der User mit seinem Firmenkonto in Outlook anmeldet, greift die APP-Policy.

### ❌ Why sind die anderen Antworten incorrect?
- **A – Devices targeted:**
  - APPs zielen nicht auf Deviceeobjekte, sondern auf User.

- **C – DeviceeGroupn in Intune:**
  - BYOD-Devicee sind oft gar nicht in Intune als MDM-Device registriert.

- **D – Compliance Policy:**
  - Compliance betrifft Device, nicht App-Daten.

📌 **Merksatz:**
**App Protection = Userdaten in Apps schützen → immer User als Ziel, nicht Device.**
`
  },
...
## Szenario
You plan to, **Microsoft Tunnel for Intune** zu implementieren,
damit mobile Devicee per **VPN** sicher auf On-Premises-Ressourcen zugreifen können.

You want to wissen, für Which Plattformen du **Tunnel-Client und VPN-Profile** bereitstellen kannst.

## Frage
Which beiden Plattformen werden von Microsoft Tunnel **nativ** unterstützt?
...
- Auf einem **Linux-Server** (on-prem oder in der Cloud) läuft.
- Für **mobile Devicee** gedacht ist.
- Mit **Intune** verwaltet und ausgerollt wird.
...
Windows- und macOS-Devicee nutzen andere Zugriffswege (z. B. klassisches VPN, ZTNA, DirectAccess/Always On VPN etc.),
aber **nicht** Microsoft Tunnel als Client-Lösung.
...
# 🧩 124 – Deviceestatus in Intune: Pending, In Progress, Succeeded, Error

## Szenario
You have ein neues **Device configuration profile** für Windows 11 erstellt und es einer Group von 100 Deviceen zugeHowsen.

Im Intune-Portal siehst du bei den **Deviceestatusübersichten** folgende Werte:

- 70 Devicee = **Succeeded**
- 20 Devicee = **Pending**
- 5 Devicee = **In Progress**
- 5 Devicee = **Error**

## Frage
Which Aussage beschreibt den Status **Pending** correct?

`,
    options: [
      { key: "A", text: `Das Profil wurde auf das Gerät heruntergeladen, aber die Anwendung ist noch nicht abgeschlossen.` },
      { key: "B", text: `Das Gerät hat das Profil noch nicht angefordert oder synchronisiert.` },
      { key: "C", text: `Die Profilanwendung ist fehlgeschlagen und erfordert manuelles Eingreifen.` },
      { key: "D", text: `Das Gerät hat das Profil angewendet, wartet aber auf Benutzeraktion.` }
    ],
    optionsEn: [
      { key: "A", text: `Das Profil wurde auf das Device heruntergeladen, aber die Application ist noch nicht abgeschlossen.` },
      { key: "B", text: `Das Device hat das Profil noch nicht angefordert oder synchronisiert.` },
      { key: "C", text: `Die ProfilApplication ist fehlgeschlagen und erfordert manuelles Eingreifen.` },
      { key: "D", text: `Das Device hat das Profil angewendet, wartet aber auf Useraktion.` }
    ],
    correctAnswers: ["B"],
    explanation: `
## ✅ Richtige Antwort
...
`,
    explanationEn: `
## ✅ correcte Antwort
**B) Das Device hat das Profil noch nicht angefordert oder synchronisiert.**

### 🔍 Statusbedeutungen in Intune
- **Pending**:
  - Die Policy ist **zugeHowsen**,
  - aber das Device hat sie **noch nicht vom Intune-Dienst abgeholt**.
  - Häufig, wenn das Device **offline** ist oder sich noch nicht synchronisiert hat.

- **In Progress**:
  - Das Device hat die Policy erhalten und ist gerade dabei, sie anzuwenden.

- **Succeeded**:
  - Policy wurde erfolgreich angewendet.

- **Error**:
  - Application fehlgeschlagen.
  - Es gibt einen Fehlercode und Logs zur Analyse.

### Application im Szenario
Die 20 Devicee mit **Pending**:
- Haben das Profil noch **nicht verarbeitet**.
- Mögliche Gründe:
  - Device aus, offline, nicht mit Internet verbunden.
  - Längere Synchronisationsintervalle.

### ❌ Why die anderen Antworten incorrect sind?
- **A – Heruntergeladen, Application noch nicht fertig:**
  - Das wäre eher **In Progress**.

- **C – Fehlgeschlagen:**
  - Das ist **Error**.

- **D – Wartet auf Useraktion:**
  - Könnte in speziellen Szenarien zutreffen, aber nicht generisch für Pending.

📌 **Merksatz:**
**„Pending“ heißt im Grunde: Noch nicht beim Device angekommen.**
`
  },
...
## Szenario
You want to auf Windows 11-Deviceen **Microsoft Defender Antivirus** konfigurieren.
...
## Frage
Which Policy-Art ist die correcte, um **klassische AV-Settingen** (z. B. Echtzeitschutz, Cloud-Schutz, Scan) zu konfigurieren?

`,
    options: [
      { key: "A", text: `Endpoint security → Microsoft Defender for Endpoint Policy` },
    ...
    optionsEn: [
      ...
      { key: "B", text: `Endpoint security → Antivirus Policy` },
      { key: "C", text: `Device configuration → Custom OMA-URI Profile` },
      { key: "D", text: `Compliance Policy mit Antivirus-Setting` }
    ],
    correctAnswers: ["B"],
    explanation: `
## ✅ Richtige Antwort
...
- **Endpoint security → Microsoft Defender for Endpoint**:
  - Steuert die **Integration mit MDE**:
    - Onboarding/Offboarding von Deviceen
    - EDR in block mode
    - Integration für Attack Surface Reduction etc.
...
### ❌ Why sind die anderen Antworten incorrect?
- **A – MDE Policy**:
  - Dient hauptsächlich für Onboarding + EDR-Settingen,
    nicht für GrundConfiguration des AV.

- **C – Custom OMA-URI**:
  - Möglich, aber unnötig komplex, Intune hat native Templates.

- **D – Compliance Policy**:
  - Bewertet nur, ob Schutz aktiv ist, setzt aber keine Configuration.
...
- Devicee werden von der IT ausgegeben.
- Nutzer dürfen private Apps installieren, aber Unternehmensdaten sollen getrennt sein.
- You want to **Android Enterprise** verwenden.

## Frage
Which Enrollment-Methode passt am besten zu diesem Szenario?

`,
    options: [
      { key: "A", text: `Android Enterprise – Work Profile (BYOD)` },
      { key: "B", text: `Android Enterprise – Fully managed` },
      { key: "C", text: `Android Enterprise – Corporate-owned work profile (COPE)` },
...
### 🔍 Überblick Android Enterprise-Modi
- **Work Profile (BYOD)**:
  - Für **persönliche Devicee**.
  - Nur der Arbeitsbereich wird verwaltet.
  - Device bleibt im Besitz des Users.

- **Fully managed**:
  - Für **firmeneigene Devicee**.
  - Komplettes Device wird verwaltet.
  - Privatnutzung stark eingeschränkt oder unerwünscht.

- **Corporate-owned Work Profile (COPE)**:
  - Für **firmeneigene Devicee** mit **getrenntem Arbeits- UND Privatbereich**.
  - Ideal, wenn:
    - Firma Eigentümer des Devices ist,
    - User das Device aber auch privat nutzen darf.
...
Das ist genau der Applicationsfall für:
> **Corporate-owned work profile (COPE)**

### ❌ Why sind die anderen Optionen incorrect?
- **A – BYOD Work Profile**:
  - Devicee wären formell im Besitz des Users, nicht der Firma.
...
📌 **Merksatz:**
**FirmenDevice + private Nutzung erlaubt + saubere Trennung → COPE.**
`
  },
...
## Szenario
Dein Unternehmen modernisiert die Paketierung für Windows-Applicationen und
möchte zukünftig nach Möglichkeit **MSIX** statt klassischer Setup.exe-Installer verwenden.

You want to eine Application im **MSIX-Format** über Intune verteilen.

## Frage
Whichn App-Typ wählst du in Intune für eine MSIX-Datei?

`,
    options: [
      { key: "A", text: `Line-of-business app → Windows app (Win32)` },
      { key: "B", text: `Line-of-business app → Line-of-business app (Windows) mit MSIX` },
...
- **Line-of-business app (Windows)**
  - Unterstützt Formate How **.MSI**, **.MSIX**, **.APPX**.
...
## Szenario
You plan to, Windows Updates über Intune mit **Update Rings** und **Feature Update Policies** zu steuern.

Anforderungen:

- **Securitysupdates (Quality Updates)** sollen zeitnah installiert werden.
- **Funktionsupdates (Feature Updates / Versionen)** sollen nur nach Freigabe installiert werden.

## Frage
Which Kombination von Intune-Policies erfüllt diese Anforderungen am besten?

`,
    options: [
      { key: "A", text: `Nur Update Rings konfigurieren` },
      { key: "B", text: `Nur Feature Update Policies verwenden` },
      { key: "C", text: `Update Rings für Quality Updates + Feature Update Policy für Zielversion` },
      { key: "D", text: `Compliance Policy für Updates + Device configuration Profile für Reboot` }
    ],
    optionsEn: [
      { key: "A", text: `Nur Update Rings konfigurieren` },
      { key: "B", text: `Nur Feature Update Policies verwenden` },
...
### 🔍 Aufgabenteilung
- **Update Rings**:
  - Steuern **Quality Updates (Securitys-/Kumulativupdates)**.
  - Du kannst:
    - Installations-Deadlines definieren.
    - Defer-Perioden konfigurieren.
    - Neustartverhalten steuern.
...
- **Feature Update Policies**:
  - Erzwingen eine **spezifische Windows-Version** (z. B. 22H2, 23H2).
  - Halten Devicee auf einer definierten Build fest.

### Application im Szenario
- Securitysupdates sollen **zeitnah** kommen →
  → Steuere das über **Update Rings**.

- Feature Updates sollen **nur nach Freigabe** installiert werden →
  → Lege mit **Feature Update Policy** fest, auf Which Version aktualisiert werden darf.

Damit hast du:
- Klar getrennte KontRole über **Quality** und **Feature** Updates.
...
- **D – Compliance + Device Config**:
  - Compliance bewertet nur den Zustand, konfiguriert aber keine Updates.
  - Device config steuert nicht WUfB-Logik How Ringe & Feature-Ziele.
...
# 🧩 129 – Autopilot-Deviceezuordnung zu Usern (User Assignment)

## Szenario
You have mehrere Windows 11-Devicee per **Windows Autopilot** registriert.

Ziel:
- User sollen beim ersten Start **ihren Namen auf dem OOBE-Bildschirm** sehen.
- Jedes Device soll einem **konkreten User vorab zugeordnet** werden.

## Frage
How kannst du Devicee vorab bestimmten Usern zuordnen, damit deren Namen während Autopilot-One-Time-Setup angezeigt werden?

`,
    options: [
      { key: "A", text: `Im Intune Geräteobjekt die Primary User Eigenschaft setzen` },
      { key: "B", text: `Im Autopilot-Gerät die Benutzerzuweisung in der Autopilot-Device-Liste konfigurieren` },
      { key: "C", text: `In Azure AD die Eigenschaft „Owner“ des Geräts setzen` },
      { key: "D", text: `In Entra ID eine Conditional Access Policy pro Benutzer erstellen` }
    ],
    optionsEn: [
      { key: "A", text: `Im Intune Deviceeobjekt die Primary User Eigenschaft setzen` },
      { key: "B", text: `Im Autopilot-Device die Userzuweisung in der Autopilot-Device-Liste konfigurieren` },
      { key: "C", text: `In Azure AD die Eigenschaft „Owner“ des Devices setzen` },
      { key: "D", text: `In Entra ID eine Conditional Access Policy pro User erstellen` }
    ],
    correctAnswers: ["B"],
    explanation: `
## ✅ Richtige Antwort
...
`,
    explanationEn: `
## ✅ correcte Antwort
**B) Im Autopilot-Device die Userzuweisung in der Autopilot-Device-Liste konfigurieren**

### 🔍 Userzuordnung in Autopilot
In der Autopilot-Device-Liste (z. B. im Entra / Intune-Portal) kannst du:

- Ein Device anhand seiner Seriennummer / Device ID auswählen.
- Ihm einen **Assigned user** zuweisen.

Dadurch wird:
- Der **Name des Users** im OOBE angezeigt.
- Das Device **logisch vorab** dem User zugeordnet.
...
- **C – Azure AD Owner:**
  - Owner ist eher ein Managementsattribut, kein Autopilot-Feature.

- **D – Conditional Access:**
  - Hat nichts mit OOBE-Anzeige oder Autopilot-User-Zuweisung zu tun.

📌 **Merksatz:**
**OOBE-Useranzeigenamen im Autopilot → Zuweisung in der Autopilot Device-Liste.**
`
  },
...
## Szenario
You want to in Intune die **Administration nach Regionen** trennen:

- Ein Admin-Team **Europe-Admins** soll nur Devicee in Europa sehen und verwalten.
- Ein Team **US-Admins** soll nur US-Devicee sehen.

Die Devicee sind bereits in entsprechende **Azure AD-Groupn** sortiert:
- \`Devices-Europe\`
- \`Devices-US\`

## Frage
Which zwei Konzepte aus Intune-RBAC nutzt du, um diese Trennung umzusetzen?
...
- **Roles (Rolen)**: Was darf der Admin tun? (z. B. Lesen, Schreiben, Wipen)
- **Scope (Groups)**: **Which Objekte** (Devicee/User) fallen unter seine Zuständigkeit?
- **Scope tags**: Steuern, **Which Configurationen/Objekte** ein Admin überhaupt sieht.

### Application im Szenario
Du willst Regionen trennen:

1. **Scope (Groups)**:
   - Weise der Role für Europe-Admins die Group \`Devices-Europe\` als Scope zu.
   - Weise der Role für US-Admins die Group \`Devices-US\` als Scope zu.

2. **Scope tags**:
   - Markiere Configurationen (Profiles, Policies) mit Scope-Tag \`EU\` bzw. \`US\`.
   - Rolen der Europe-Admins erhalten nur Scope Tag \`EU\`.
   - Rolen der US-Admins bekommen \`US\`.

Ergebnis:
- Europe-Admins sehen nur EU-Devicee & EU-Policies.
- US-Admins sehen nur US-Devicee & US-Policies.
...
- **C – Filters + Config Profiles**:
  - Filters steuern Zuweisungen, nicht Admin-Permissionen.

- **D – Conditional Access + APP**:
  - Sind Identitäts-/ApplikationsSecuritysfunktionen, nicht RBAC in Intune.

📌 **Merksatz:**
**Intune-RBAC = Role (Rechte) + Scope (Groups) (Objekte) + Scope tags (sichtbare Configuration).**
`
  },
...
Therefore all three statements are correct: TB1 uses MDT3, DT1 uses en-gb, and LT1 uses MDT1.
`,
    explanationEn: `
MDT evaluates the [DefaultGateway] section first based on the client IP/gateway mapping.
If no mapping is found, MDT falls back to the [Default] section.
...
You manage an Azure AD tenant named motorenwerk-schmidt.de that contains the following devices and groups.
...
Tom wants to connect to a Windows 11 computer named Computer1 by using Remote Desktop (RDP).
...
`,
    options: [
      { key: "A", text: `Enable Network Level Authentication (NLA) for Remote Desktop.` },
      { key: "B", text: `Configure and start the Remote Desktop Configuration service.` },
      { key: "C", text: `Turn on reputation-based protection in Microsoft Defender.` },
...
- Remove all user data and user-installed apps.
- Minimize administrative effort.
- Keep the devices enRoled in Azure AD and Intune, so they remain managed.
...
`,
    options: [
      ...
      { key: "C", text: `Perform a local Reset this PC operation on each device.` },
...
Comparison with other options:
- **Wipe (Factory reset)** removes everything, including Azure AD join and Intune enrollment.
  The device must then be re-registered and re-enRoled → more administrative effort.
- **Fresh Start** removes OEM bloatware and some apps, but is not specifically designed to
  repurpose corporate devices for new users at scale.
- **Local Reset this PC** can be used, but offers less central control and may break the managed state
  if not executed via Autopilot/Intune workflows.
...
Your network contains an Active Directory domain named Kunde-GmbH.com.
...
| Max | Administrators                   |
| Lisa | Group1, Group2                   |
| Tom | Group1, Group3, Administrators   |
...
Evaluation:
- **Max** is a member of the Administrators group.
  Administrators are in the Allow list and are not denied → **Max can sign in via RDP**.

- **Lisa** is a member of Group1 and Group2.
  Group2 is explicitly listed in **Deny log on through Remote Desktop Services**.
  The Deny right overrides any implicit allows → **Lisa cannot sign in via RDP**.

- **Tom** is a member of Group1, Group3, and Administrators.
  Administrators are allowed, and no Deny applies → **Tom can sign in via RDP**.

Therefore, only **Max** and **Tom** can connect to Computer2 by using Remote Desktop.
`,
    explanationEn: `
To sign in via Remote Desktop, a user must:
- Be granted the right **Allow log on through Remote Desktop Services** (directly or via a group),
...
`,
    options: [
      ...
      { key: "F", text: `Enable Apply device name template and use PC-%SERIAL%.` }
    ],
    optionsEn: [
      { key: "A", text: `Set Deployment mode to Self-deploying (preview).` },
      { key: "B", text: `Disable the Enrollment Status Page (ESP).` },
...
Which type of object should you create and assign in the Microsoft Intune admin center to configure the OOBE settings for the Autopilot devices?
`,
    questionEn: `
## Scenario: Spedition Schnell
...
`,
    options: [
      ...
      { key: "E", text: `Upload APK files directly to Intune as Android store apps.` }
    ],
    optionsEn: [
      { key: "A", text: `Create an Android configuration profile in Intune.` },
      { key: "B", text: `Link your Managed Google Play account to Intune.` },
...
You manage 1,000 Android Enterprise devices that are enRoled in Microsoft Intune.
You create an **App configuration policy** with the following parameters:
...
`,
    options: [
      ...
      { key: "E", text: `Android store app (public Play Store app not managed)` }
    ],
    optionsEn: [
      { key: "A", text: `Web link` },
      { key: "B", text: `Built-in Android app` },
...
|-------|--------------------------|
| Max | Group1                   |
| Lisa | Group2 (member of Group1)|
| Tom | Group3 (member of Group1)|
...
User evaluation:
- **Max**: Member of Group1 → Policy1 (.ods, priority 0) applies.
- **Lisa**: Member of Group2 and Group1.
  - Policy2 (.xlsb) has priority 1.
  - Policy1 (.ods) has priority 0 → Policy1 overrides Policy2 → .ods.
- **Tom**: Member of Group3 and Group1.
...
Architekturbüro Modern, Ltd. manages devices by using Microsoft Intune and Configuration Manager (co-management).
All computers are members of the on-premises Active Directory domain architekturbüro-modern.de,
...
`,
    options: [
      ...
      { key: "C", text: `Policy1: Device1 and Device3 | Policy2: Device2 and Device4` },
      { key: "D", text: `Policy1: Device2 and Device3 | Policy2: Device1 and Device4` }
    ],
    optionsEn: [
      { key: "A", text: `Policy1: Device1 only   | Policy2: Device2 only` },
      { key: "B", text: `Policy1: Device3 only   | Policy2: Device4 only` },
...
Restaurant Genuss, Ltd. manages computers with Configuration Manager and mobile devices with Microsoft Intune.
...
|-------|---|---|
| Paul | Member of GroupA, Intune Administrator| Not a Device Enrollment Manager (DEM)|
| Mia | Standard user                         | Configured as a Device Enrollment Manager (DEM) in Intune |
...
What is the maximum number of devices that Paul and Mia can enroll?
`,
    questionEn: `
## Scenario: Restaurant Genuss
...
Evaluation:
- **Paul**: Intune administrator, but not configured as a DEM → limited by the standard device limit: **10 devices**.
- **Mia**: Configured as Device Enrollment Manager → can enroll **up to 1,000 devices**.

Therefore, the maximum is **Paul: 10 devices** and **Mia: 1,000 devices**.
`,
    explanationEn: `
By default, Intune enforces a **device limit per user**, for example 10 devices.
This limit applies to regular users and Administrators alike.
...
Buchhaltung Express, Ltd. manages devices with Microsoft Intune and Configuration Manager (co-management).
All computers are domain-joined to buchhaltung-express.de, which is synchronized to Azure AD.
...
Werbeagentur Kreativ Ltd. manages all corporate iPhones and iPads with Microsoft Intune.
...
`,
    options: [
      ...
      { key: "C", text: `A device configuration profile with Device restrictions` },
...
Nordwind GmbH, Ltd. uses a hybrid Azure AD tenant (nordwind-gmbh.de) with on-premises Windows Server 2016,
...
`,
    options: [
      { key: "A", text: `Extract the hardware ID (hardware hash) of each computer to a CSV file and upload the CSV file in the Intune admin center.` },
      { key: "B", text: `Run Sysprep /generalize on a reference computer and capture an image for SCCM OSD.` },
      { key: "C", text: `Record the serial number of each computer and create a device record manually in Azure AD.` },
      { key: "D", text: `Create a provisioning package (PPKG) and copy it to a USB drive for each Phoenix office computer.` }
    ],
    optionsEn: [
      { key: "A", text: `Extract the hardware ID (hardware hash) of each computer to a CSV file and upload the CSV file in the Intune admin center.` },
      { key: "B", text: `Run Sysprep /generalize on a reference computer and capture an image for SCCM OSD.` },
...
`,
    options: [
      ...
      { key: "C", text: `After a user approves the uninstall operation on each device.` },
...
`,
    options: [
      { key: "A", text: `Device1: App configuration policy | Device2: Device configuration profile | Device3: Device configuration profile` },
      { key: "B", text: `Device1: App configuration policy | Device2: Endpoint security policy | Device3: Device compliance policy` },
      { key: "C", text: `Device1: Device compliance policy | Device2: App configuration policy | Device3: Endpoint security policy` },
      { key: "D", text: `Device1: Device configuration profile | Device2: App configuration policy | Device3: App configuration policy` },
      { key: "E", text: `Device1: Endpoint security policy | Device2: Endpoint security policy | Device3: App configuration policy` },
      { key: "F", text: `Device1: Endpoint security policy | Device2: Device configuration profile | Device3: Device compliance policy` }
    ],
    optionsEn: [
      { key: "A", text: `Device1: App configuration policy | Device2: Device configuration profile | Device3: Device configuration profile` },
      { key: "B", text: `Device1: App configuration policy | Device2: Endpoint security policy | Device3: Device Compliance policy` },
...
You have a Microsoft 365 E5 subscription that contains a user named Tom and two devices:
- Device1 (Windows 10)
- Device2 (Windows 10)

Tom can currently access her Exchange Online mailbox from both Device1 and Device2.
...
You need to ensure that Tom can access Exchange Online only from Device1 and is blocked on Device2.
...
Kunde-GmbH Corporation uses Enterprise State Roaming (ESR) in a hybrid Azure AD environment.
...
1. Max adds a desktop shortcut on Device1 and expects it to appear on Device3.
2. Max changes the desktop background color to blue on Device2 and expects it to appear on Device4.
3. Lisa increases the command prompt font size on Device2 and expects it to appear on Device1.
...
You have four Azure AD-joined Windows 10 devices (Device1–Device4), all enRoled in Intune.
...
2. Desktop background color is part of Windows personalization settings →
   synchronized for ESR-enabled users such as Max → Yes.
3. Command Prompt font size is a traditional Win32 app setting and Lisa does not have ESR enabled → No.
...
Kunde-GmbH Corporation uses Microsoft Intune to deploy VPN profiles to Windows 10 devices.
...
Jonas is a member of Group1 and GroupA.
Jonas signs in to Device1 and Device2, which have the following group memberships:
...
You need to determine how many VPN connections are available to Jonas on each device.
...
Jonas is in Group1 and GroupA:
- **Connection1** is assigned to Group1, Group2, GroupA.
- **Connection2** is assigned to GroupA.

Device1 is in Group1:
- Jonas + Device1 receive Connection1 (via Group1/GroupA) and Connection2 (via GroupA).
  → **2 VPN connections**.
...
- In the scenario, an additional VPN configuration (for example, a pre-existing VPN) is also present,
  resulting in **3 total VPN connections** visible to Jonas.

Therefore, Jonas has **2 VPNs on Device1** and **3 VPNs on Device2**.
`,
    explanationEn: `
Connection assignments come from both user and device group membership, and identical profiles
are not duplicated on a device.
...
Kunde-GmbH Corporation plans to use Windows Autopilot to deploy new Windows 10 devices
...
`,
    options: [
      { key: "A", text: `Server2 (a member server that does not run the Intune Connector)` },
      { key: "B", text: `Server1 (the server that runs the Intune Connector for Active Directory)` },
    ...
    optionsEn: [
      ...
      { key: "B", text: `Server1 (the server that runs the Intune Connector for Active Directory)` },
      { key: "C", text: `GroupA (the group configured for MDM user scope)` },
      { key: "D", text: `DC1 (the domain contRoler)` }
    ],
    correctAnswers: ["B"],
    explanation: `
...
Granting permissions to other servers, groups, or the domain contRoler computer account
does not enable the connector on Server1 to create computer objects.
...
Kunde-GmbH Corporation uses Microsoft Intune device compliance policies to evaluate Windows 10 devices.
...
Kunde-GmbH Corporation uses Microsoft Intune and has a Microsoft 365 E5 subscription.
...
Therefore, **Finn, Emma, Paul, and Mia** can all register Device6.
`,
    explanationEn: `
All four users in the scenario have valid Intune (EMS) licenses.
...
Kunde-GmbH Corporation uses Enterprise State Roaming (ESR) in Azure AD.
...
You have two users:
- Max: Member of GroupA (ESR enabled)
- Lisa: Not a member of any ESR-enabled group

You need to determine on which devices the **Sync your settings** feature (Enterprise State Roaming)
can be used by each user.

For which devices can Max and Lisa synchronize settings?
`,
    questionEn: `
## Scenario: Druckerei Gutenberg
...
All Windows 10 devices (Device1–Device5) are Azure AD joined and enRoled in Intune.
...
- **Max** is in an ESR-enabled group (GroupA) → ESR is enabled for Max.
- **Lisa** is not in any ESR-enabled group → ESR is not enabled for Lisa.

Therefore:
- Max can use Sync your settings on **all 5 devices**.
- Lisa cannot use ESR on any device.

Correct option: **Max: Device1–5 | Lisa: None**.
`,
    explanationEn: `
Enterprise State Roaming requires:
- Azure AD Premium (or EMS) licensing, and
...
Kunde-GmbH Corporation uses Microsoft Defender controlled folder access (CFA) via Intune.
...
1. Jonas creates a file D:\\\\Folder1\\\\file1.txt on Device4 by using Notepad.
2. Laura removes D:\\\\Folder1 from the list of protected folders on Device2.
3. Finn creates C:\\\\Users\\\\Finn\\\\Desktop\\\\file1.txt by running a PowerShell script on Device2.
...
Kunde-GmbH Corporation uses Microsoft Defender contRoled folder access (CFA) via Intune.
...
`,
    ...
    correctAnswers: ["F"],
    explanation: `
1. **Jonas with Notepad in D:\\\\Folder1**:
...
2. **Laura removing D:\\\\Folder1 from protection**:
   ...
   - Therefore, Laura cannot remove D:\\\\Folder1 from the protected list → **No**.

3. **Finn creating a file on the Desktop via PowerShell script**:
...
2. **Laura removing D:\\\\Folder1 from protection**:
   - The ContRoled Folder Access configuration is delivered and enforced via Intune.
   - Local users cannot permanently remove a protected folder defined by policy.
   - Therefore, Laura cannot remove D:\\\\Folder1 from the protected list → **No**.
...
Kunde-GmbH Corporation uses Intune device configuration profiles.
...
`,
    options: [
      ...
      { key: "C", text: `An app protection policy (App Protection Policy) for iOS` },
...
You manage a hybrid Microsoft Entra ID (Azure AD) tenant that synchronizes an on-premises Active Directory domain named anwaltskanzlei-recht.de.
Max signs in to two domain-joined devices:

- Device1 runs Windows 10 Pro.
- Device2 runs Windows 11 Pro.

In the Microsoft Entra admin center you assign Max a Windows 11 Enterprise E5 license.

You need to determine what happens the next time Max signs in to each device.
...
`,
    options: [
      { key: "A", text: `Device1 and Device2 will both be upgraded to Windows 11 Enterprise automatically.` },
      { key: "B", text: `Device1 will be upgraded to Windows 11 Enterprise; Device2 will remain Windows 11 Pro.` },
      { key: "C", text: `Device1 will remain Windows 10 Pro; Device2 will activate as Windows 11 Enterprise.` },
      { key: "D", text: `Neither device will change edition or activation state.` }
    ],
    optionsEn: [
      { key: "A", text: `Device1 and Device2 will both be upgraded to Windows 11 Enterprise automatically.` },
      { key: "B", text: `Device1 will be upgraded to Windows 11 Enterprise; Device2 will remain Windows 11 Pro.` },
...
Device2 läuft bereits mit Windows 11 Pro. Wenn sich Max mit der zugewiesenen Windows 11 Enterprise E5 Lizenz anmeldet und das Gerät Azure AD/hybrid joined ist, erfolgt ein automatisches Edition-Upgrade auf Windows 11 Enterprise per Subscription Activation.
Daher: Device1 bleibt Windows 10 Pro, Device2 wird als Windows 11 Enterprise aktiviert.
`,
    explanationEn: `
Windows Subscription Activation kann nur die Edition, nicht aber die Windows-Version ändern.
Ein Device mit Windows 10 Pro wird durch Zuweisung einer Windows 11 Enterprise E5 Lizenz NICHT automatisch auf Windows 11 aktualisiert. Device1 bleibt daher Windows 10 Pro.
Device2 läuft bereits mit Windows 11 Pro. Wenn sich Max mit der zugeHowsenen Windows 11 Enterprise E5 Lizenz anmeldet und das Device Azure AD/hybrid joined ist, erfolgt ein automatisches Edition-Upgrade auf Windows 11 Enterprise per Subscription Activation.
Daher: Device1 bleibt Windows 10 Pro, Device2 wird als Windows 11 Enterprise aktiviert.
`
  },
...
`,
    options: [
      { key: "A", text: `Standard Client: Only standard images; Standard Client Upgrade: Only custom images` },
      { key: "B", text: `Standard Client: Only custom captured images; Standard Client Upgrade: Standard images and custom images` },
      { key: "C", text: `Standard Client: Standard images only; Standard Client Upgrade: Custom captured images only` },
      { key: "D", text: `Standard Client: All standard and custom images; Standard Client Upgrade: Only standard Windows install images from Microsoft media` }
    ],
    optionsEn: [
      { key: "A", text: `Standard Client: Only standard images; Standard Client Upgrade: Only custom images` },
      { key: "B", text: `Standard Client: Only custom captured images; Standard Client Upgrade: Standard images and custom images` },
...
`,
    options: [
      { key: "A", text: `Use a Deployment Profile to show the progress of app and profile deployments and the Enrollment Status Page (ESP) to join devices to Azure AD.` },
      { key: "B", text: `Use a Device Configuration profile to show the progress of app and profile deployments and a Deployment Profile to join devices to Azure AD.` },
      { key: "C", text: `Use the Enrollment Status Page (ESP) to show the progress of app and profile deployments and a Device Configuration profile to join devices to Azure AD.` },
      { key: "D", text: `Use the Enrollment Status Page (ESP) to show the progress of app and profile deployments and a Windows Autopilot Deployment Profile to join devices to Azure AD.` }
    ],
    optionsEn: [
      { key: "A", text: `Use a Deployment Profile to show the progress of app and profile deployments and the Enrollment Status Page (ESP) to join devices to Azure AD.` },
      { key: "B", text: `Use a Device Configuration profile to show the progress of app and profile deployments and a Deployment Profile to join devices to Azure AD.` },
...
`,
    explanationEn: `
Die Enrollment Status Page (ESP) zeigt während der Autopilot-Deployment den Fortschritt von App-, Policyn- und ProfilDeploymenten an und kann den Zugriff blockieren, bis die Installation abgeschlossen ist.
Das Windows Autopilot Deployment Profile legt u. a. fest, ob Devicee Azure AD joined oder hybrid joined werden und steuert das OOBE-Verhalten.
Daher verwendet man die ESP für die Anzeige des Deploymentsfortschritts und das Deployment Profile für den Azure AD Join.
`
  },
...
`,
    options: [
      { key: "A", text: `On the General tab, specify the gateway FQDN as the computer name.` },
      { key: "B", text: `On the Local Resources tab, configure Remote audio playback.` },
      { key: "C", text: `On the Advanced tab, configure the Connect from anywhere Remote Desktop Gateway settings.` },
      { key: "D", text: `On the Experience tab, configure the connection speed.` }
    ],
    optionsEn: [
      { key: "A", text: `On the General tab, specify the gateway FQDN as the computer name.` },
      { key: "B", text: `On the Local Resources tab, configure Remote audio playback.` },
...
Der RD Gateway Server wird im RDP-Client unter „Advanced → Settings → Connect from anywhere“ konfiguriert.
Dort wird festgelegt, dass Verbindungen über den RD Gateway laufen und es wird der Gateway-Servername eingetragen.
Nur diese Setting sorgt dafür, dass die Verbindung zu Server1 tatsächlich über das RD Gateway aufgebaut wird.
`
  },
...
Sysprep bereitet ein Windows-Abbild für die Verteilung vor, indem es hardware- und systemspezifische Informationen (z. B. SID) entfernt und das System in den OOBE-Modus versetzt.
Der typische Befehl für ein Referenzimage lautet: sysprep /generalize /oobe /shutdown.
Nur so kann das erfasste Image später sauber auf mehreren Deviceen ausgerollt werden.
`
  },
...
`,
    options: [
      { key: "A", text: `Export the hardware hash from the device, but the device will be hybrid Azure AD joined.` },
      { key: "B", text: `Import a CSV file with the device hardware IDs into Windows Autopilot; the device will be Azure AD joined only.` },
      { key: "C", text: `Add the device manually in Intune; the device will be Azure AD registered only.` },
      { key: "D", text: `No preparation is required; the device will be hybrid Azure AD joined automatically.` }
    ],
    optionsEn: [
      { key: "A", text: `Export the hardware hash from the device, but the device will be hybrid Azure AD joined.` },
      { key: "B", text: `Import a CSV file with the device hardware IDs into Windows Autopilot; the device will be Azure AD joined only.` },
...
`,
    explanationEn: `
Bevor ein Device ein Autopilot-Profil erhalten kann, muss es im Autopilot-Dienst registriert werden. Dies geschieht typischerweise durch Import einer CSV mit Hardware Hash/Seriennummer in Intune.
Da im Deployment Profile „Join to Azure AD as = Azure AD joined“ konfiguriert ist, wird das Device nach der Deployment als „Azure AD joined“ (und nicht hybrid) geführt.
Daher: CSV-Import in Autopilot und Ergebniszustand: Azure AD joined only.
`
  },
...
You have a Microsoft Entra ID tenant named techfabrik-ag.de and plan to use Windows Autopilot Self-deploying mode to provision several Windows 11 devices.
...
`,
    explanationEn: `
Der Windows Autopilot Self-deploying Mode erfordert TPM 2.0 mit Attestation-Unterstützung.
Devicee ohne TPM oder mit TPM 1.2 können diesen Modus nicht nutzen.
Im Szenario erfüllt nur Device3 die Anforderung (TPM 2.0) und kann daher im Self-deploying Mode bereitgestellt werden.
`
  },
...
`,
    options: [
      { key: "A", text: `Allow Remote Desktop connections from any version of Remote Desktop` },
      { key: "B", text: `Enable the Remote Registry service and open port 445 in the firewall` },
      { key: "C", text: `Allow Windows Remote Management (WinRM) through the Microsoft Defender Firewall and ensure the WinRM service is running.` },
...
`,
    explanationEn: `
Windows Admin Center verwendet WinRM (PowerShell Remoting/WMI) zur Management von Zielsystemen.
Dazu muss auf dem verwalteten Computer der WinRM-Dienst aktiviert und die passende Firewallregel („Windows Remote Management (HTTP-In)“) zugelassen sein.
Daher ist das Zulassen von WinRM durch die Defender-Firewall auf Computer2 erforderlich.
`
  },
...
`,
    options: [
      { key: "A", text: `Marketing: Windows 11 Home; Research: Windows 11 Pro` },
      { key: "B", text: `Marketing: Windows 11 Pro; Research: Windows 11 Pro` },
      { key: "C", text: `Marketing: Windows 11 Pro; Research: Windows 11 Enterprise` },
      { key: "D", text: `Marketing: Windows 11 Home; Research: Windows 11 Enterprise` }
    ],
    optionsEn: [
      { key: "A", text: `Marketing: Windows 11 Home; Research: Windows 11 Pro` },
      { key: "B", text: `Marketing: Windows 11 Pro; Research: Windows 11 Pro` },
...
`,
    options: [
      { key: "A", text: `1) Create a Task Sequence; 2) Create a Deployment Share; 3) Import the custom image` },
      { key: "B", text: `1) Import the custom image; 2) Create a Deployment Share; 3) Create a Task Sequence` },
      { key: "C", text: `1) Create a Deployment Share; 2) Import the custom image into the Deployment Share; 3) Create a Task Sequence that uses the imported image` },
      { key: "D", text: `1) Create a Task Sequence; 2) Import drivers; 3) Import the custom image` }
    ],
    optionsEn: [
      { key: "A", text: `1) Create a Task Sequence; 2) Create a Deployment Share; 3) Import the custom image` },
      { key: "B", text: `1) Import the custom image; 2) Create a Deployment Share; 3) Create a Task Sequence` },
...
`,
    explanationEn: `
In MDT ist die correcte Reihenfolge:
1) Zuerst wird ein Deployment Share erstellt, der als Container für OS-Images, Applicationen, Treiber und Task Sequences dient.
2) Anschließend wird das Userdefinierte Windows-Image als Operating System in diesen Deployment Share importiert.
3) Danach wird eine Task Sequence erstellt, die auf diesem importierten Image basiert.
Diese Reihenfolge ist erforderlich, damit die Task Sequence das gewünschte Image referenzieren kann.
`
  },
...
`,
    options: [
      { key: "A", text: `Deploy Always On VPN to ensure devices can always reach the domain controllers and modify the Autopilot deployment profile to install the LOB app.` },
      { key: "B", text: `Install the Intune Connector for Active Directory and create a Microsoft Intune app deployment for the Marketing group.` },
      { key: "C", text: `Create a device configuration profile for Hybrid Azure AD Join and manually install the LOB app on all Marketing devices.` },
      { key: "D", text: `Edit co-management settings for Configuration Manager and assign the LOB app as an optional application.` }
    ],
    optionsEn: [
      { key: "A", text: `Deploy Always On VPN to ensure devices can always reach the domain contRolers and modify the Autopilot deployment profile to install the LOB app.` },
      { key: "B", text: `Install the Intune Connector for Active Directory and create a Microsoft Intune app deployment for the Marketing group.` },
      { key: "C", text: `Create a device configuration profile for Hybrid Azure AD Join and manually install the LOB app on all Marketing devices.` },
      { key: "D", text: `Edit Co-management settings for Configuration Manager and assign the LOB app as an optional application.` }
    ],
...
`,
    explanationEn: `
Für Autopilot-Deploymenten mit Hybrid Azure AD Join wird der Intune Connector for Active Directory benötigt. Dieser erstellt im Auftrag von Intune die Computerobjekte im lokalen AD und ermöglicht damit den Domain Join unabhängig vom Standort.
Um die LOB-Application automatisch für die Marketing-Abteilung bereitzustellen, wird in Intune ein App Deployment (z. B. Required-Zuweisung an die Marketing-Group) konfiguriert.
VPN oder Co-management sind für diese Anforderungen nicht zwingend erforderlich und würden den administrativen Aufwand erhöhen.
`
  },
...
`,
    options: [
      { key: "A", text: `Enable the 'Allow Remote Shell access' Group Policy setting.` },
      { key: "B", text: `Enable the 'Allow remote server management through WinRM Group Policy setting.` },
      { key: "C", text: `Configure the Windows Remote Management (WS-Management) service startup type to Automatic by using Group Policy preferences.` },
      { key: "D", text: `Enable the "Allow inbound Remote Desktop exceptions" firewall rule in Group Policy.` },
      { key: "E", text: `Start and configure the Remote Registry service on all computers.` },
      { key: "F", text: `Enable the Windows Defender Firewall rule that allows inbound remote administration (WinRM) traffic.` }
    ],
    optionsEn: [
      { key: "A", text: `Enable the 'Allow Remote Shell access' Group Policy setting.` },
      { key: "B", text: `Enable the 'Allow remote server management through WinRM Group Policy setting.` },
...
`,
    explanationEn: `
Für die WinRM-Aktivierung per GPO sind im Wesentlichen drei Dinge erforderlich:
- Die Policy „Allow remote server management through WinRM“ muss aktiviert werden, damit WinRM Verbindungen akzeptiert.
- Der Dienst „Windows Remote Management (WS-Management)“ sollte per GPO-Preferences auf Starttyp „Automatic“ gesetzt werden, damit er beim Systemstart läuft.
- Die passende Firewallregel (z. B. „Windows Remote Management (HTTP-In)“ bzw. Remote Administration) muss aktiviert werden, damit eingehende WinRM-Verbindungen zugelassen werden.
Remote Desktop, Remote Shell oder Remote Registry sind für die reine WinRM-Funktion nicht notwendig.
`
...
`,
    options: [
      { key: "A", text: `Perform an in-place upgrade by using Windows 10 Enterprise installation media on each device.` },
      { key: "B", text: `Use Windows Autopilot to redeploy all devices as Windows 10 Enterprise.` },
      { key: "C", text: `Use Windows Subscription Activation for Windows 10 Enterprise.` },
      { key: "D", text: `Capture a Windows 10 Enterprise image and deploy it with MDT to all devices.` }
    ],
    optionsEn: [
      { key: "A", text: `Perform an in-place upgrade by using Windows 10 Enterprise installation media on each device.` },
      { key: "B", text: `Use Windows Autopilot to redeploy all devices as Windows 10 Enterprise.` },
...
`,
    explanationEn: `
Windows Subscription Activation ermöglicht ein automatisches Edition-Upgrade von Windows 10/11 Pro auf Enterprise basierend auf der zugeHowsenen M365 E3/E5-Lizenz.
Die Devicee müssen bereits mit einer gültigen Pro-Lizenz aktiviert und Azure AD/hybrid joined sein; eine Neuinstallation ist nicht erforderlich.
Sobald sich ein User mit gültiger Enterprise-Lizenz anmeldet, wird die Edition automatisch auf Windows 10 Enterprise angehoben.
Dies erfüllt die Anforderung nach minimalem administrativem Aufwand.
`
  },
...
All devices are enRoled and not rooted.
You need to determine which devices will be marked compliant by Intune.
...
`,
    explanationEn: `
Die Compliance-Policy verlangt, dass sich das Device innerhalb der definierten Network Location 192.168.0.0/16 befindet.
Device1 (192.168.10.5) und Device3 (192.168.200.8) liegen beide im Bereich 192.168.x.x und sind damit hinsichtlich Ort compliant (sofern sie nicht gerootet sind).
Device2 (10.0.0.10) liegt außerhalb des Bereichs und wird deshalb sofort als nicht konform markiert.
Damit sind Device1 und Device3 compliant, Device2 nicht.
`
...
`,
    options: [
      { key: "A", text: `Register the devices as Microsoft Entra registered devices.` },
      { key: "B", text: `Join the devices as Microsoft Entra joined devices.` },
      { key: "C", text: `Configure the devices as Hybrid Microsoft Entra joined devices.` },
      { key: "D", text: `Do not register devices; use only app-based sign-in.` }
    ],
    optionsEn: [
      { key: "A", text: `Register the devices as Microsoft Entra registered devices.` },
      { key: "B", text: `Join the devices as Microsoft Entra joined devices.` },
...
`,
    explanationEn: `
Für BYOD-Szenarien mit persönlicher Windows-Anmeldung werden Devicee als „Microsoft Entra registered“ (Workplace Join) registriert.
Die User melden sich weiterhin mit ihrem persönlichen Windows-Konto an, während die Devicee im Hintergrund mit Entra ID registriert und über Intune verwaltet werden können.
Azure AD/Entra Join oder Hybrid Join wären eher für vollständig verwaltete UnternehmensDevicee geeignet und widersprechen der Vorgabe, nur das persönliche Konto für die Windows-Anmeldung zu nutzen.
`
  },
...
`,
    options: [
      { key: "A", text: `Requirement 1: Device compliance policy; Requirement 2: Conditional Access policy` },
      { key: "B", text: `Requirement 1: Device compliance policy; Requirement 2: Device configuration profile` },
      { key: "C", text: `Requirement 1: Conditional Access policy; Requirement 2: Device configuration profile` },
      { key: "D", text: `Requirement 1: Conditional Access policy; Requirement 2: Device compliance policy` }
    ],
    optionsEn: [
      { key: "A", text: `Requirement 1: Device Compliance policy; Requirement 2: Conditional Access policy` },
      { key: "B", text: `Requirement 1: Device Compliance policy; Requirement 2: Device configuration profile` },
...
`,
    explanationEn: `
Zugriff basierend auf Standort (z. B. Named Locations, IP-Bereiche, Länder) wird mit Conditional Access Policyn in Microsoft Entra ID umgesetzt.
Die Bewertung des Deviceezustands bzw. des Defender-Risikostatus erfolgt über Intune Device Compliance Policies, die den Risikolevel von Defender for Endpoint auswerten.
Conditional Access kann dann auf den Compliance-Status reagieren (z. B. nur konforme Devicee zulassen).
Daher: Requirement 1 mit Conditional Access, Requirement 2 mit einer Compliance-Policy.
`
  },
...
`,
    options: [
      { key: "A", text: `Group1: Help Desk Operator; Group2: Intune Service Administrator` },
      { key: "B", text: `Group1: Intune Role Administrator; Group2: Help Desk Operator` },
      { key: "C", text: `Group1: Intune Role Administrator; Group2: Policy and Profile Manager` },
      { key: "D", text: `Group1: Intune Service Administrator; Group2: Policy and Profile Manager` }
    ],
    optionsEn: [
      { key: "A", text: `Group1: Help Desk Operator; Group2: Intune Service Administrator` },
      { key: "B", text: `Group1: Intune Role Administrator; Group2: Help Desk Operator` },
...
`,
    explanationEn: `
Der Intune Role Administrator darf Intune-Rolen und Rolenzuweisungen verwalten und passt damit zu den Anforderungen von Group1.
Der Help Desk Operator kann u. a. vorhandene Policyn und Apps zuweisen, ohne die vollen Administrationsrechte eines Intune Service Administrator oder Policy and Profile Manager zu benötigen – das entspricht dem Prinzip der minimalen Rechte für Group2.
Daher: Group1 → Intune Role Administrator; Group2 → Help Desk Operator.
`
  },
...
`,
    explanationEn: `
Device1 (Windows 10, Group1) erhält Policy1 und Policy2. Ein Device ist nur dann compliant, wenn es alle ihm zugeHowsenen Policyn erfüllt. Im ursprünglichen Szenario ist mindestens eine der Policyn nicht erfüllt, daher ist Device1 nicht compliant.
Device2 (Windows 10, Group2) erhält nur Policy2 und erfüllt diese, also ist Device2 compliant.
Device3 (Android, Group3) erhält Policy3 und Policy4. Policy3 ist auf Windows 10 beschränkt und wird auf Android nicht angewendet; Policy4 ist eine Android-Policy, die erfüllt wird. Damit ist Device3 compliant.
Daher: Device1 = No, Device2 = Yes, Device3 = Yes.
`
...
You manage a Microsoft Entra ID (Azure AD) tenant named hotel-alpenblick.de.
...
`,
    explanationEn: `
In den Microsoft Entra (Azure AD) Device Settings kann konfiguriert werden, Which User oder Groupn lokale Administratoren auf Azure AD joined Deviceen sind.
Über die Setting „Additional local Administrators on Azure AD joined devices“ bzw. die Zuweisung der Role „Device Administrators“ lässt sich steuern, dass normale User bei einem Azure AD Join nicht mehr automatisch lokale Administratoren werden.
Autopilot, Provisioning Packages oder Security Defaults ändern dieses Standardverhalten nicht direkt.
Daher müssen die Device Settings in Microsoft Entra ID angepasst werden.
`
  },
...
- auf Max angewendet wird,
- für Office 365 SharePoint Online gilt,
- und beim Grant Access fordert: Device must be marked as compliant.

Frage:
Kann Max auf SharePoint Online über Microsoft Edge von jedem der drei Geräte zugreifen?
`,
    questionEn: `
## Scenario: Anwaltskanzlei Recht

Conditional Access mit DeviceeCompliance (Compliant Device Access)

Ein Unternehmen verwendet Microsoft 365 mit Microsoft Intune zur DeviceeManagement.
User: Max
Zielressource: Microsoft SharePoint Online.

Deviceeübersicht:
- Device1: Keine Compliance Policy zugeHowsen, Standard-Tenant-Setting markiert Devicee ohne Policy als compliant
- Device2: Compliance Policy 'Compliance1' zugeHowsen, DatenträgerEncryption aktiviert, Status: compliant
- Device3: Compliance Policy 'Compliance2' zugeHowsen, DatenträgerEncryption nicht aktiviert, Status: non-compliant

Tenantenweite Compliance-Settingen:
- Mark devices with no Compliance policy assigned as: Compliant
- Require encryption on devices: Enabled
- Compliance validity period (days): 30
...
Question:
Kann Max auf SharePoint Online über Microsoft Edge von jedem der drei Devicee zugreifen?
`,
    options: [
...
`,
    explanationEn: `
Devicee ohne zugeHowsene Compliance Policy werden durch die Setting 'Mark devices with no Compliance policy assigned as compliant' als compliant behandelt. Daher ist Device1 compliant.
Device2 erfüllt die Anforderungen der Policy 'Compliance1', insbesondere die aktivierte DatenträgerEncryption. Es ist als compliant markiert.
Device3 hat eine Policy, die Encryption verlangt, diese ist aber nicht aktiv. Daher ist Device3 non-compliant.
Die Conditional Access Policy erlaubt nur den Zugriff für Devicee, die als compliant markiert sind. Folglich:
- Device1: Zugriff erlaubt
- Device2: Zugriff erlaubt
- Device3: Zugriff blockiert.
`
...
You have ein Azure-Abonnement und ein lokales Windows 11-Device mit dem Namen Device1.
You plan to, Device1 mit Azure Monitor zu überwachen und erstellst eine Data Collection Rule (DCR) mit dem Namen DCR1.
...
`,
    options: [
      ...
      { key: "D", text: `Monitored Object (generischer Container ohne Geräteziel)` }
    ],
    optionsEn: [
      { key: "A", text: `Azure Network Watcher` },
      { key: "B", text: `Device1` },
      { key: "C", text: `Log Analytics Workspace` },
      { key: "D", text: `Monitored Object (generischer Container ohne Deviceeziel)` }
    ],
    correctAnswers: ["B"],
    explanation: `
...
`,
    explanationEn: `
Eine Data Collection Rule (DCR) definiert, Which Daten gesammelt, How sie optional transformiert und wohin sie gesendet werden.
Ziel der DCR-Zuordnung ist immer ein konkretes Resource- oder Deviceeobjekt, zum Beispiel ein Server, eine VM oder ein über Azure Arc eingebundenes Device.
In diesem Szenario ist Device1 das zu überwachende Objekt. Die DCR1 muss daher direkt Device1 zugeordnet werden.
Der Log Analytics Workspace wird als Destination innerhalb der DCR konfiguriert, ist aber nicht das Objekt, an das die DCR gebunden wird.
`
  },
...
Windows Update Ring Configuration in Intune

You have ein Microsoft 365-Abonnement mit Microsoft Intune.
You want to einen Update Ring konfigurieren, der folgende Anforderungen erfüllt:

- Quality Updates (Securitys- und Qualitätsupdates) können 14 Tage aufgeschoben werden und installieren sich 7 Tage nach Deployment automatisch.
- Feature Updates (Funktionsupdates) können 90 Tage aufgeschoben werden und installieren sich 10 Tage nach Deployment automatisch.
- Devicee müssen automatisch 3 Tage nach der Installation neu starten.

Question:
Which Configuration der Update Ring Settingen entspricht diesen Anforderungen?
`,
    options: [
      { key: "A", text: `Feature update deferral: 30 Tage; Quality update deferral: 7 Tage; Deadline for feature updates: 5 Tage; Grace period: 1 Tag` },
      { key: "B", text: `Feature update deferral: 90 Tage; Quality update deferral: 14 Tage; Deadline for feature updates: 10 Tage; Grace period: 3 Tage` },
      { key: "C", text: `Feature update deferral: 120 Tage; Quality update deferral: 0 Tage; Deadline for feature updates: 10 Tage; Grace period: 7 Tage` },
      { key: "D", text: `Feature update deferral: 90 Tage; Quality update deferral: 14 Tage; Deadline for feature updates: 0 Tage; Grace period: 0 Tage` }
    ],
    optionsEn: [
      { key: "A", text: `Feature update deferral: 30 Tage; Quality update deferral: 7 Tage; Deadline for feature updates: 5 Tage; Grace period: 1 Tag` },
      { key: "B", text: `Feature update deferral: 90 Tage; Quality update deferral: 14 Tage; Deadline for feature updates: 10 Tage; Grace period: 3 Tage` },
...
`,
    explanationEn: `
Der Deferral-Period-Wert bestimmt, How viele Tage nach Veröffentlichung ein Update zurückgehalten wird.
Für Funktionsupdates ist ein Aufschub von 90 Tagen gefordert. Das entspricht 'Feature update deferral period (days) = 90'.
Für Qualitätsupdates ist ein Aufschub von 14 Tagen gefordert. Das entspricht 'Quality update deferral period (days) = 14'.
Die Deadline für Feature Updates legt fest, How viele Tage nach Ablauf des Aufschubs das Update zwangsweise installiert wird. Gefordert sind 10 Tage, also 'Deadline for feature updates (days) = 10'.
Die Grace Period legt fest, nach How vielen Tagen nach der Installation ein Neustart erzwungen wird. Gefordert sind 3 Tage, also 'Grace period (days) = 3'.
Damit erfüllt nur die Configuration aus Antwort B alle genannten Anforderungen.
`
  },
...
You manage 1.000 Computer mit Windows 11, die Mitglieder einer lokalen Active Directory-Domäne sind.
You want to die Ereignisprotokolle dieser Computer in Azure erfassen, um sie zentral zu analysieren und zu überwachen.

Question:
Which Azure-Komponente solltest du bereitstellen und Which Aktion musst du auf den Computern durchführen, damit Ereignisprotokolle zentral in Azure erfasst werden?
`,
    options: [
      { key: "A", text: `Azure Storage Account bereitstellen und auf den Computern den Microsoft Monitoring Agent installieren` },
      { key: "B", text: `Azure Storage Account bereitstellen und auf den Computern eine Collector-initiated Subscription konfigurieren` },
      { key: "C", text: `Azure Cosmos DB bereitstellen und die Geräte bei Intune anmelden` },
      { key: "D", text: `Azure SQL Database bereitstellen und auf den Computern eine Collector-initiated Subscription konfigurieren` },
      { key: "E", text: `Log Analytics Workspace bereitstellen und die Geräte bei Azure AD registrieren` },
      { key: "F", text: `Log Analytics Workspace bereitstellen und auf den Computern den Microsoft Monitoring Agent installieren` }
    ],
    optionsEn: [
      { key: "A", text: `Azure Storage Account bereitstellen und auf den Computern den Microsoft Monitoring Agent installieren` },
      { key: "B", text: `Azure Storage Account bereitstellen und auf den Computern eine Collector-initiated Subscription konfigurieren` },
      { key: "C", text: `Azure Cosmos DB bereitstellen und die Devicee bei Intune anmelden` },
      { key: "D", text: `Azure SQL Database bereitstellen und auf den Computern eine Collector-initiated Subscription konfigurieren` },
      { key: "E", text: `Log Analytics Workspace bereitstellen und die Devicee bei Azure AD registrieren` },
      { key: "F", text: `Log Analytics Workspace bereitstellen und auf den Computern den Microsoft Monitoring Agent installieren` }
    ],
    correctAnswers: ["F"],
    explanation: `
...
Der Microsoft Monitoring Agent (bzw. Azure Monitor Agent) wird auf jedem Windows-Client installiert und sammelt Ereignisprotokolle und Leistungsdaten.
Diese Daten werden über HTTPS (Port 443) an den konfigurierten Log Analytics Workspace gesendet.
Daher ist die correcte Kombination: Log Analytics Workspace bereitstellen und auf den Computern den Microsoft Monitoring Agent installieren.
`
  },
...
Computer1 verwendet Windows 11. You have ein PowerShell-Skript 'config.ps1' erstellt, das nach einem Feature-Update automatisch ausgeführt werden soll.

Question:
Which Datei auf Computer1 musst du anpassen, damit das Skript nach der Installation eines Feature-Updates automatisch ausgeführt wird?
`,
    options: [
...
Windows 10 und Windows 11 unterstützen die Datei SetupConfig.ini, um Setup-Parameter für Upgrades und Feature-Updates zu definieren.
Über SetupConfig.ini können unter anderem PostOOBE-Aktionen angegeben werden, die nach Abschluss des Out-of-Box-Experiences ausgeführt werden.
Mit einem Eintrag How 'PostOOBE=C:\\Scripts\\config.ps1' in SetupConfig.ini wird sichergestellt, dass config.ps1 nach einem Feature-Update automatisch ausgeführt wird.
LiteTouch.wsf gehört zu MDT, Unattend.bat ist kein Bestandteil moderner Setup-Pfade und Unattend.xml wird primär für vollständige unbeaufsichtigte Installationen genutzt, nicht gezielt für Post-Feature-Update-Skripte.
`
  },
...
You manage 1.000 Devicee mit Microsoft Intune und möchtest Trends zur Devicee-Compliance über einen längeren Zeitraum analysieren.
Im Intune Admin Center steht dir der Bericht 'Device Compliance trends' zur Verfügung.

Question:
Für Whichn Zeitraum zeigt der Bericht 'Device Compliance trends' die Verlaufsdaten an?
`,
    options: [
      { key: "A", text: `30 Tage` },
      { key: "B", text: `60 Tage` },
...
`,
    explanationEn: `
Der Bericht 'Device Compliance trends' im Intune Admin Center dient dazu, die Entwicklung der Devicee-Compliance über die letzten 60 Tage anzuzeigen.
Damit können Administratoren Muster und Veränderungen der Compliance-Rate über einen Zeitraum von zwei Monaten analysieren.
`
  },
...
You have ein Microsoft 365 E5-Abonnement und möchtest die Microsoft 365 Defender Devicee-Onboarding-Funktion nutzen.
Ziele sind:
- Devicee anzeigen, die die Chromium-basierte Version von Microsoft Edge installiert haben.
- Ein Onboarding-Paket für ein Windows-11-Device herunterladen.
- Den administrativen Aufwand minimieren.

Question:
Which zwei Bereiche im Microsoft 365 Defender-Portal solltest du verwenden, um diese Anforderungen zu erfüllen?
`,
    options: [
...
`,
    explanationEn: `
Über 'Vulnerability management' lässt sich die Software-Inventarisierung einsehen, unter anderem installierte Browser-Versionen How Microsoft Edge (Chromium).
Über 'Settings' im Microsoft 365 Defender-Portal gelangt man zu den Endpoint-Settingen, unter denen sich die Onboarding-Pakete für Windows 10/11 herunterladen lassen.
Damit werden sowohl die Übersicht über Devicee mit Edge als auch das Onboarding mit minimalem Zusatzaufwand ermöglicht.
`
  },
...
Android-Devicee in Intune mit Zero-Touch-Enrollment bereitstellen

Dein Unternehmen verwaltet Android-Devicee über Microsoft Intune.
Neue Devicee sollen beim ersten Einschalten automatisch UnternehmensPolicyn und Apps erhalten, ohne manuelle Usereingriffe.
Ziel ist die Deployment über Zero-Touch Enrollment (ZTE).

Question:
Which Schritte sind erforderlich, um Zero-Touch-Enrollment für Android-Devicee mit Intune zu implementieren?
`,
    options: [
      { key: "A", text: `Nur ein Managed Google Play-Konto mit Intune verknüpfen; der Rest erfolgt automatisch ohne weitere Konfiguration.` },
      { key: "B", text: `Im Zero-Touch-Portal ein Konfigurationsprofil erstellen, Geräte über den Händler dem Zero-Touch-Konto zuordnen und beim ersten Start die manuelle Intune-App-Installation durch den Benutzer verlangen.` },
      { key: "C", text: `Managed Google Play-Konto mit Intune verknüpfen, im Zero-Touch-Portal eine Konfiguration erstellen, Geräte beim Händler mit ZTE-Fähigkeit registrieren und die automatische Intune-Registrierung beim ersten Start nutzen.` },
      { key: "D", text: `Nur Apple Business Manager und Apple Configurator einrichten, Zero-Touch wird für alle mobilen Plattformen gemeinsam dort verwaltet.` }
    ],
    optionsEn: [
      { key: "A", text: `Nur ein Managed Google Play-Konto mit Intune verknüpfen; der Rest erfolgt automatisch ohne weitere Configuration.` },
      { key: "B", text: `Im Zero-Touch-Portal ein Configurationsprofil erstellen, Devicee über den Händler dem Zero-Touch-Konto zuordnen und beim ersten Start die manuelle Intune-App-Installation durch den User verlangen.` },
      { key: "C", text: `Managed Google Play-Konto mit Intune verknüpfen, im Zero-Touch-Portal eine Configuration erstellen, Devicee beim Händler mit ZTE-Fähigkeit registrieren und die automatische Intune-Enrollment beim ersten Start nutzen.` },
      { key: "D", text: `Nur Apple Business Manager und Apple Configurator einrichten, Zero-Touch wird für alle mobilen Plattformen gemeinsam dort verwaltet.` }
    ],
    correctAnswers: ["C"],
    explanation: `
...
`,
    explanationEn: `
Zero-Touch Enrollment ist eine Google-Technologie für die automatische Deployment von Android-Deviceen.
Für den Einsatz mit Intune müssen:
- Ein Managed Google Play-Konto mit Intune verknüpft werden.
- Im Zero-Touch-Portal Configurationen angelegt werden, die unter anderem die Intune-Enrollment definieren.
- Devicee beim autorisierten Händler mit dem Zero-Touch-Konto des Unternehmens (per IMEI oder Seriennummer) verknüpft werden.
Beim ersten Start des Devices lädt Android dann automatisch die angegebene Management-App und führt die Intune-Enrollment durch.
Damit ist Antwort C die einzige Option, die den vollständigen Ablauf correct beschreibt.
`
  },
...
Device1 ist ein Windows 11 Device, das:
- Domänenmitglied (AD joined) ist,
- bei Microsoft Intune registriert ist,
- sowohl durch lokale GroupnPolicyn (GPO) als auch durch Intune-Policyn verwaltet wird.

You want to sicherstellen, dass bei Konflikten Intune-Settingen Vorrang vor GroupnPolicyn haben.

Question:
Was solltest du konfigurieren, damit Intune-Settingen widersprüchliche GroupnPolicyn überschreiben?
`,
    options: [
      { key: "A", text: `Ein Device Configuration Profile in Intune, das den CSP 'ControlPolicyConflict' mit 'MDMWinsOverGP' setzt` },
      { key: "B", text: `Eine Device Compliance Policy` },
      { key: "C", text: `Ein MDM Security Baseline Profile` },
      { key: "D", text: `Ein zusätzliches Group Policy Object (GPO), das alle Werte auf 'Not Configured' setzt` }
    ],
    optionsEn: [
      { key: "A", text: `Ein Device Configuration Profile in Intune, das den CSP 'ControlPolicyConflict' mit 'MDMWinsOverGP' setzt` },
      { key: "B", text: `Eine Device Compliance Policy` },
...
`,
    explanationEn: `
Der Policy-CSP 'ControlPolicyConflict' steuert, ob bei Konflikten zwischen MDM-Policyn und GroupnPolicyn die MDM-Seite oder die GPO-Seite gewinnt.
Mit der Setting 'MDMWinsOverGP' wird festgelegt, dass Intune- (MDM-) Policyn Vorrang vor lokalen oder domänenbasierten GroupnPolicyn haben.
Diese Setting wird typischerweise über ein Device Configuration Profile mit Settings Catalog in Intune konfiguriert.
Compliance Policies, Security Baselines oder zusätzliche GPOs steuern die Konfliktauflösung nicht direkt.
`
  },
...
Migration von GPO-Settingen für Microsoft Office zu Intune

You have eine lokale Active Directory-Domäne, die mit einem Microsoft Entra ID Tenant synchronisiert ist.
Windows-11-Devicee sind hybrid Microsoft Entra joined und in Intune eingeschrieben.
Microsoft Office-Settingen auf diesen Deviceen werden aktuell über Group Policy Objects (GPOs) verwaltet.
You want to diese Office-GPO-Settingen nach Intune migrieren.

Question:
Which drei Aktionen solltest du in der correcten Reihenfolge durchführen, um die Microsoft Office GPO-Settingen nach Intune zu migrieren?
`,
    options: [
      { key: "A", text: `Ein Security Baseline Profile für Office in Intune erstellen` },
      { key: "B", text: `Das Group Policy Analytics Tool in Intune verwenden, um GPOs zu analysieren` },
      { key: "C", text: `Die GPO-Einstellungen über Get-GPOReport als XML exportieren` },
      { key: "D", text: `Ein Custom OMA-URI-Profile in Intune erstellen` },
      { key: "E", text: `Ein Configuration Profile vom Typ Administrative Templates in Intune erstellen und die Office-Einstellungen nachbilden` }
    ],
    optionsEn: [
      { key: "A", text: `Ein Security Baseline Profile für Office in Intune erstellen` },
      { key: "B", text: `Das Group Policy Analytics Tool in Intune verwenden, um GPOs zu analysieren` },
      { key: "C", text: `Die GPO-Settingen über Get-GPOReport als XML exportieren` },
      { key: "D", text: `Ein Custom OMA-URI-Profile in Intune erstellen` },
      { key: "E", text: `Ein Configuration Profile vom Typ Administrative Templates in Intune erstellen und die Office-Settingen nachbilden` }
    ],
...
Zur Migration von Office-GPOs nach Intune wird zunächst das Group Policy Analytics Tool verwendet, um die vorhandenen GPOs zu analysieren und deren MDM-Kompatibilität zu prüfen.
Dazu werden die relevanten GPOs per PowerShell (zum Beispiel mit Get-GPOReport -ReportType XML) exportiert und die erzeugten XML-Dateien im Group Policy Analytics Tool hochgeladen.
Anschließend werden die als kompatibel identifizierten Settingen in Intune über ein Configuration Profile vom Typ Administrative Templates nachgebildet.
Security Baselines und Custom OMA-URI-Profile sind für diesen konkreten Migrationspfad unnötig komplex oder ungeeignet.
`
  },
...
Question:
Whichs Tool solltest du einsetzen, um die Computer mit minimalen Zusatzkosten und kontrolliertem Prozess auf Windows 11 zu aktualisieren?
`,
    options: [
      { key: "A", text: `Windows Autopilot` },
      { key: "B", text: `System Center Configuration Manager (Configuration Manager)` },
...
`,
    explanationEn: `
Microsoft Deployment Toolkit (MDT) ist ein kostenloses Microsoft-Tool zur automatisierten Deployment und zum Upgrade von Windows-Betriebssystemen.
MDT kann sowohl In-Place-Upgrades als auch Neuinstallationen durchführen und ist ideal, wenn keine bestehende SCCM- oder Intune-Infrastruktur vorhanden ist.
Windows Autopilot ist primär für die Deployment neuer oder zurückgesetzter Devicee gedacht, nicht für Massen-Upgrades von bestehenden AD-Clients.
Configuration Manager verursacht zusätzliche Lizenz- und Infrastrukturkosten und ist für 100 Clients oft überdimensioniert.
Subscription Activation ermöglicht ein Edition-Upgrade (z. B. Pro zu Enterprise), aber kein Versionsupgrade von Windows 10 auf Windows 11.
`
  },
...
Ein Benutzer Jonas soll nicht mehr Mitglied der lokalen Administratorgruppe auf den verwalteten Geräten sein.

Frage:
Welche Intune-Richtlinie solltest du verwenden, um Jonas automatisch aus der lokalen Administratorgruppe aller verwalteten Windows-Geräte zu entfernen?
`,
    questionEn: `
## Scenario: Energie-Direkt AG

Entfernen eines Users aus der lokalen AdministratorGroup über Intune

You manage Windows-11-Devicee mit Microsoft Intune in einer Microsoft-365-Umgebung.
Ein User Jonas soll nicht mehr Mitglied der lokalen AdministratorGroup auf den verwalteten Deviceen sein.

Question:
Which Intune-Policy solltest du verwenden, um Jonas automatisch aus der lokalen AdministratorGroup aller verwalteten Windows-Devicee zu entfernen?
`,
    options: [
...
Über eine solche Account Protection Policy kann Jonas automatisiert aus der lokalen Administratorgruppe entfernt werden.
...
`,
    explanationEn: `
In Intune können lokale User- und Groupnmitgliedschaften über Endpoint Security Account Protection Policies verwaltet werden.
Mit einem Profil vom Typ Local User Group Membership für die Group 'Administrators' kann festgelegt werden, Which Konten hinzugefügt oder entfernt werden.
Über eine solche Account Protection Policy kann Jonas automatisiert aus der lokalen AdministratorGroup entfernt werden.
Compliance Policies bewerten nur den Deviceestatus; App Configuration und ASR-Policies steuern andere Bereiche und greifen nicht in lokale Groupnmitgliedschaften ein.
`
  },
...
Ein User arbeitet auf Computer1 mit Windows 11, der via Windows Autopilot bereitgestellt wurde.
Der User:
- erstellt eine VPN-Verbindung zum Firmennetzwerk,
- installiert eine Microsoft Store App namens App1,
- verbindet das Device mit einem Wi-Fi-Netzwerk.

Ein Administrator führt anschließend auf dem Device einen Windows Autopilot Reset durch.

Question:
In Whichm Zustand befinden sich nach dem Autopilot Reset die Wi-Fi-Verbindung, App1 und die VPN-Verbindung, wenn der User sich erneut anmeldet?
`,
    options: [
      { key: "A", text: `Wi-Fi: entfernt; App1: beibehalten; VPN: beibehalten` },
      { key: "B", text: `Wi-Fi: beibehalten (Passphrase entfernt); App1: beibehalten; VPN: entfernt` },
      { key: "C", text: `Wi-Fi: beibehalten (Passphrase beibehalten); App1: entfernt; VPN: entfernt` },
      { key: "D", text: `Wi-Fi: entfernt; App1: entfernt; VPN: beibehalten` }
    ],
    optionsEn: [
      { key: "A", text: `Wi-Fi: entfernt; App1: beibehalten; VPN: beibehalten` },
      { key: "B", text: `Wi-Fi: beibehalten (Passphrase entfernt); App1: beibehalten; VPN: entfernt` },
...
`,
    explanationEn: `
Ein Windows Autopilot Reset setzt das Device in einen geschäftsbereiten Zustand zurück, ohne die Azure-AD- und Intune-Enrollment zu entfernen.
Dabei werden Userdateien, Userapps und Userspezifische Configurationen entfernt.
Wi-Fi-Configurationen inklusive Passphrase werden beibehalten, damit das Device sich nach dem Reset Howder mit dem Netzwerk verbinden kann.
Userinstallierte Store-Apps How App1 werden entfernt. Unternehmens-Apps werden bei der erneuten Intune-Synchronisation neu installiert.
Aus Securitysgründen werden VPN-Profile und dazugehörige Anmeldeinformationen entfernt.
Daher: Wi-Fi beibehalten (inklusive Passphrase), App1 entfernt, VPN entfernt.
`
  },
...
You have eine Microsoft-365-Subscription und planst die Intune-Enrollment für zwei Deviceetypen:
- Windows-11-Devicee, die derzeit über Configuration Manager (ConfigMgr) verwaltet werden.
- iOS-Devicee im BYOD-Szenario, die den Usern gehören.

Ziel ist, die Enrollment in Intune zu aktivieren, ohne User unnötig zu unterbrechen.

Question:
Which Enrollment-Methode sollte für jeden Deviceetyp verwendet werden?
`,
    options: [
      { key: "A", text: `Windows 11: Manual Enrollment; iOS: Device Enrollment (ADE)` },
      { key: "B", text: `Windows 11: Co-management mit ConfigMgr; iOS: User Enrollment` },
      { key: "C", text: `Windows 11: Windows Autopilot; iOS: Apple Configurator Enrollment` },
      { key: "D", text: `Windows 11: Nur Intune Enrollment ohne ConfigMgr; iOS: Full Device Enrollment (DEP/ADE)` }
    ],
    optionsEn: [
      { key: "A", text: `Windows 11: Manual Enrollment; iOS: Device Enrollment (ADE)` },
      { key: "B", text: `Windows 11: Co-management mit ConfigMgr; iOS: User Enrollment` },
...
`,
    explanationEn: `
Für bestehende Windows-Clients, die bereits durch Configuration Manager verwaltet werden, ist Co-management der empfohlene Weg. Dabei werden die Devicee zusätzlich an Intune angebunden, ohne sie neu aufzusetzen.
Co-management erlaubt, Workloads schrittweise von ConfigMgr zu Intune zu verschieben und minimiert Unterbrechungen für User.
Für persönliche iOS-Devicee (BYOD) ist User Enrollment vorgesehen. Dabei wird ein geschützter Arbeitsbereich erzeugt, während persönliche Daten des Users privat bleiben.
Deviceebasierte Enrollment-Methoden How ADE/DEP sind für firmeneigene iOS-Devicee gedacht, nicht für BYOD.
`
  },
...
Ein Unternehmen hat 500 Windows-11-Computer, die über Microsoft Intune verwaltet werden.
Anforderungen:
- Updates sollen zuerst auf eine TestGroup ausgerollt werden.
- Die restlichen Devicee sollen 15 Tage später automatisch aktualisiert werden.
- Es geht ausschließlich um monatliche Securitysupdates (Quality Updates).

Question:
Which Configuration im Microsoft Endpoint Manager Admin Center sollte verwendet werden, um dieses Rolloutmodell umzusetzen?
`,
    options: [
      { key: "A", text: `Zwei Windows Update Rings mit unterschiedlichen Deferral-Perioden konfigurieren` },
      { key: "B", text: `Ein Feature Update Profile für alle Geräte erstellen` },
      { key: "C", text: `Nur eine Device Configuration Policy verwenden` },
      { key: "D", text: `Eine Security Baseline für Updates verwenden` }
    ],
    optionsEn: [
      { key: "A", text: `Zwei Windows Update Rings mit unterschiedlichen Deferral-Perioden konfigurieren` },
      { key: "B", text: `Ein Feature Update Profile für alle Devicee erstellen` },
      { key: "C", text: `Nur eine Device Configuration Policy verwenden` },
      { key: "D", text: `Eine Security Baseline für Updates verwenden` }
    ],
    correctAnswers: ["A"],
...
Windows Update for Business wird in Intune über Update Rings für Windows 10 and later konfiguriert.
Um ein Staged Rollout zu implementieren, erstellt man mindestens zwei Update Rings:
- Ein Test-Ring mit Quality Update Deferral = 0 Tage für die PilotDevicee.
- Ein Produktions-Ring mit Quality Update Deferral = 15 Tage für die übrigen Devicee.
Dadurch erhalten TestDevicee die Updates sofort, während ProduktionsDevicee die gleichen Updates automatisch 15 Tage später erhalten.
Feature Update Profiles steuern Versionssprünge, nicht monatliche Qualitätsupdates; Device Configuration und Security Baselines sind für diesen konkreten Applicationsfall nicht ausreichend.
`
  },
...
User dürfen Microsoft Defender Antivirus nicht deaktivieren

You have 500 Windows-11-Computer, die Azure AD joined sind und in Intune registriert sind.
You plan to, Microsoft Defender Antivirus zentral zu verwalten und möchtest verhindern, dass User den Defender deaktivieren können.

Question:
Was solltest du im Microsoft Intune Admin Center konfigurieren, um zu verhindern, dass User Microsoft Defender Antivirus deaktivieren?
`,
    options: [
      { key: "A", text: `Eine Conditional Access Policy im Entra Admin Center` },
      { key: "B", text: `Eine Security Baseline in Intune` },
      { key: "C", text: `Eine Attack Surface Reduction (ASR) Policy in Intune` },
      { key: "D", text: `Eine Antivirus Policy in Intune mit aktivierter Tamper Protection` }
    ],
    optionsEn: [
      { key: "A", text: `Eine Conditional Access Policy im Entra Admin Center` },
      { key: "B", text: `Eine Security Baseline in Intune` },
...
`,
    explanationEn: `
Ob User Defender-Settingen deaktivieren können, wird durch den Manipulationsschutz (Tamper Protection) gesteuert.
Tamper Protection ist Teil von Microsoft Defender for Endpoint und kann über eine Antivirus Policy in Intune für Windows-Clients aktiviert werden.
Mit aktivierter Tamper Protection sind zentrale SecuritysSettingen How Echtzeitschutz oder Cloudbasierter Schutz vor unerwünschten Änderungen durch lokale Administratoren oder User geschützt.
Conditional Access, Security Baselines und ASR-Policies spielen zwar eine Role für Security und Angriffsflächen, verhindern aber nicht direkt das Abschalten von Defender durch User.
`
  },
...
Dein Unternehmen hat ein Azure-Abonnement mit mehreren Deviceen.
Es existieren dynamische DeviceeGroupn (Dynamic Device Groups), die anhand von Eigenschaften How Deviceebesitz (Company vs. Personal) gefüllt werden.
Die Devicee sind in Intune registriert und You create eine Microsoft 365 Apps for Windows 10/11 App, die an eine dynamische DeviceeGroup mit firmeneigenen Windows-Deviceen zugeHowsen wird.

Drei Devicee sind relevant:
- LT1: FirmenDevice (Corporate-owned), Windows 10/11, erfüllt die Groupnregel.
- LT2: Persönliches Device (BYOD), erfüllt die Bedingung 'deviceOwnership = Company' nicht.
- LT3: Device, das nicht Mitglied der zugeHowsenen DeviceeGroup ist.

Question:
Wird die Microsoft-365-Apps-Application auf LT1, LT2 und LT3 installiert?
`,
    options: [
...
`,
    explanationEn: `
Die Microsoft-365-Apps-Application wird an eine dynamische DeviceeGroup zugeHowsen, die nur firmeneigene Devicee (Company-owned) enthält.
LT1 ist ein firmeneigenes Windows-Device und erfüllt die dynamische Groupnregel, daher wird die App installiert.
LT2 ist ein persönliches Device (BYOD) und erfüllt die Bedingung 'deviceOwnership = Company' nicht, daher ist es nicht Mitglied der ZielGroup und erhält die App nicht.
LT3 ist nicht Mitglied der dynamischen DeviceeGroup und erhält daher ebenfalls keine Zuweisung für die Microsoft-365-Apps-Application.
Damit wird die App nur auf LT1 installiert.
`
  },
...
Ein Unternehmen verwaltet alle Devicee mit Microsoft Intune in einem Microsoft 365-Tenant.

Deviceeübersicht:
• Device1 ist in Group1 und wird als compliant angezeigt.
• Device2 ist in keiner Group und wird fälschlicherweise als compliant angezeigt.
• Device3 ist in keiner Group und wird fälschlicherweise als compliant angezeigt.

Es gibt eine Compliance Policy Policy1, die nur Group1 zugeHowsen ist.

Du stellst fest, dass Devicee ohne zugeHowsene Compliance Policy trotzdem als compliant angezeigt werden.

You need to sicherstellen, dass nur Devicee mit einer zugeHowsenen Compliance Policy als compliant gelten und alle anderen Devicee automatisch als not compliant markiert werden.

Was solltest du im Intune Admin Center konfigurieren?
`,
    options: [
      { key: "A", text: `In Intune unter Device compliance die Actions for noncompliance konfigurieren` },
      { key: "B", text: `In Intune unter Device compliance die Compliance policy settings konfigurieren` },
      { key: "C", text: `Im Entra ID (Azure AD) Admin Center eine Conditional Access Policy erstellen` },
      { key: "D", text: `In Intune unter Device compliance die Diagnostic settings konfigurieren` }
    ],
    optionsEn: [
      { key: "A", text: `In Intune unter Device Compliance die Actions for nonCompliance konfigurieren` },
      { key: "B", text: `In Intune unter Device Compliance die Compliance policy settings konfigurieren` },
...
`,
    explanationEn: `
Standardmäßig markiert Intune Devicee ohne zugeHowsene Compliance Policy als compliant. Dieses Verhalten wird über die Tenantenweiten **Compliance policy settings** gesteuert.
...
Damit gilt:
• Nur Devicee, die tatsächlich mindestens eine Compliance Policy zugeHowsen bekommen und die Anforderungen erfüllen, können als compliant angezeigt werden.
• Alle anderen Devicee ohne Policy werden automatisch als **Not compliant** behandelt.

**Why die anderen Optionen nicht passen:**
• **Actions for nonCompliance** (A) steuert nur, was passiert, wenn ein Device bereits als noncompliant gilt (z. B. E-Mail-Benachcorrectung, Grace Period), ändert aber nicht den Standardstatus von Deviceen ohne Policy.
• **Conditional Access** (C) bewertet lediglich den von Intune gelieferten Compliancestatus und kann diesen nicht selbst festlegen.
• **Diagnostic settings** (D) betreffen nur die Protokollierung und haben keinen Einfluss auf die Compliance-Logik.
`
  },
...
You manage 500 Windows 10-Computer, die in Microsoft Entra ID (Azure AD) eingebunden und in Microsoft Intune registriert sind.
You plan to, Certificatee über SCEP (Simple Certificate Enrollment Protocol) an die Devicee zu verteilen.

Die Infrastruktur enthält folgende Server:
• Server1: Intune Connector
• Server2: Web Application Proxy
• Server3: Subordinate CA (stellt Certificatee aus, NDES-Integration)
• Server4: Root CA

You create in Intune ein SCEP-Certificateprofil und musst das erforderliche Root-Certificate angeben, dem die Devicee vertrauen sollen.

Auf Whichm Server befindet sich das Root-Certificate, das du im SCEP-Profil referenzieren musst?
`,
    options: [
...
`,
    explanationEn: `
Für SCEP-Certificatee müssen die Devicee der Zertifizierungskette vertrauen. Dazu verteilst du in Intune ein Trusted Certificate Profile mit dem Root-CA-Certificate (und ggf. Intermediate-Certificateen).

In der Praxis exportierst du das Root-Certificate häufig von der **Subordinate CA (Server3)** oder einem Client, der der Kette bereits vertraut – dort liegt die komplette Certificateskette vor. Dieses Root-Certificate (öffentlicher Teil, z. B. als .cer) wird dann in Intune hochgeladen und dem SCEP-Profil zugeordnet.

• **Server3 (Subordinate CA)** stellt die eigentlichen Devicee-Certificatee aus und verfügt über die Certificateskette inklusive Root-CA-Certificate im Certificatesspeicher, von wo aus du es exportierst.
• **Server4 (Root CA)** ist zwar die Stammsignierende CA, wird aber oft offline oder besonders geschützt betrieben und nicht direkt mit Intune verknüpft.

Deshalb ist in der typischen SCEP-/NDES-Topologie **Server3** der Server, von dem du das erforderliche Root-CA-Certificate exportierst, das in Intune als Trusted Root hinterlegt wird.
`
  },
...
You have ein Microsoft 365 E5-Abonnement mit Microsoft Intune.
Es sollen nur bestimmte Deviceeplattformen in Intune registriert werden dürfen:

• Android-Devicee, die Android Enterprise Work Profile unterstützen.
• iOS-Devicee, die mindestens iOS 11.0 ausführen.

You want to verhindern, dass ältere iOS-Versionen und klassische Android Device Administrator-Enrollmenten verwendet werden.

Which zwei **Enrollment Restrictions** musst du in Intune anpassen, um diese Anforderungen umzusetzen? (Jede correcte Antwort ist ein Punkt.)
`,
    options: [
      { key: "A", text: `Device limit restrictions – Maximum number of devices per user` },
      { key: "B", text: `Android Enterprise – Personally-owned work profile (BYOD) – Versions` },
...
`,
    explanationEn: `
Die Steuerung, Which Devicee sich in Intune registrieren dürfen, erfolgt über **Enrollment Restrictions**. Es gibt dabei zwei relevante Dimensionen:
• Plattformen (Android, iOS/iPadOS, Windows, macOS)
• Betriebssystemversionen (Minimum/Maximum)
...
Damit dürfen nur noch:
• Android-Devicee, die als Android Enterprise (Work Profile) registriert werden.
• iOS-Devicee mit Version 11.0 oder höher.

**Andere Optionen:**
• A, D, E steuern entweder Anzahl Devicee pro User oder Versionen anderer Plattformen.
• B betrifft Versionen für Android Enterprise BYOD, ändert jedoch nicht die Blockierung von Android device Administrator als Plattform.
`
  },
...
You have einen Hyper-V-Host mit mehreren virtuellen Maschinen, die aktuell Windows 10 ausführen.
Die Configuration der VMs ist How folgt:
...
You want to die VMs auf Windows 11 aktualisieren.

Which VMs erfüllen die Mindestanforderungen von Windows 11 und können direkt auf Windows 11 aktualisiert werden?
`,
    options: [
...
You need to Windows Admin Center verwenden, um die Computer remote zu verwalten.

Von Whichm Computer aus kannst du dich mit dem Windows Admin Center verbinden,
und Which Computer kannst du mit WAC verwalten?
`,
    options: [
      { key: "A", text: `Connect from: Computer1 only | Manage: Computer1 only` },
      { key: "B", text: `Connect from: Computer1 only | Manage: Computer1, Computer2, Computer3 und Computer4` },
      { key: "C", text: `Connect from: Computer1 und Computer2 | Manage: Computer1 und Computer2` },
      { key: "D", text: `Connect from: Computer1 und Computer3 | Manage: Computer1, Computer2 und Computer4` },
      { key: "E", text: `Connect from: alle vier Computer | Manage: Computer1 only` },
      { key: "F", text: `Connect from: alle vier Computer | Manage: Computer1 und Computer3 only` }
    ],
    optionsEn: [
      { key: "A", text: `Connect from: Computer1 only | Manage: Computer1 only` },
      { key: "B", text: `Connect from: Computer1 only | Manage: Computer1, Computer2, Computer3 und Computer4` },
...
• Da WAC auf **Computer1** installiert ist und die benötigten Ports (80/443/6516) offen sind, kannst du dich **nur von Computer1** direkt mit der WAC-Webkonsole verbinden (bei einer reinen Client-Installation).
• Die Management der anderen Computer erfolgt remote über **WinRM / PowerShell Remoting**.

Die übrigen Computer sind How folgt vorbereitet:
• **Computer2**: Enable-PSRemoting ausgeführt → WinRM aktiviert.
• **Computer3**: Firewall-Regel für WinRM aktiviert.
• **Computer4**: winrm quickconfig ausgeführt → WinRM konfiguriert.
...
correcte Kombination ist daher:
• **Connect from**: Computer1 only
• **Manage**: Computer1, Computer2, Computer3 und Computer4
`
  },
...
You have eine Microsoft 365 E5-Subscription und 100 nicht verwaltete iPad-Devicee.

You want to:
• ein bestimmtes iOS/iPadOS-Update zentral auf die Devicee verteilen und
• verhindern, dass User manuell eine **neuere** iOS-Version installieren.

Which zwei Aktionen musst du durchführen, um dies mit Intune umzusetzen? (Jede correcte Antwort ist einen Punkt wert.)
`,
    options: [
      { key: "A", text: `Ein Device Configuration Profile erstellen, um iOS/iPadOS Softwareupdate-Richtlinien zu konfigurieren` },
      { key: "B", text: `Die Geräte über Apple Business Manager (ABM) per Automated Device Enrollment (ADE) in Intune einschreiben` },
      { key: "C", text: `Eine Compliance Policy erstellen, die die iOS-Version prüft` },
      { key: "D", text: `Ein iOS App Provisioning Profile erstellen` },
      { key: "E", text: `Die Geräte nur über die Intune Company Portal App als User-Enrolled Devices registrieren` }
    ],
    optionsEn: [
      { key: "A", text: `Ein Device Configuration Profile erstellen, um iOS/iPadOS Softwareupdate-Policyn zu konfigurieren` },
      { key: "B", text: `Die Devicee über Apple Business Manager (ABM) per Automated Device Enrollment (ADE) in Intune einschreiben` },
      { key: "C", text: `Eine Compliance Policy erstellen, die die iOS-Version prüft` },
      { key: "D", text: `Ein iOS App Provisioning Profile erstellen` },
      { key: "E", text: `Die Devicee nur über die Intune Company Portal App als User-EnRoled Devices registrieren` }
    ],
    correctAnswers: ["A", "B"],
    explanation: `
...
`,
    explanationEn: `
Um iOS-/iPadOS-Updates kontrolliert zu verteilen und User daran zu hindern, eine neuere Version manuell zu installieren, müssen die Devicee **supervised** sein und über Update-Policyn gesteuert werden.

Dazu sind zwei Schritte erforderlich:

1) **Enrollment über Apple Business Manager (ABM)** (B):
   • Nur Devicee, die per **Automated Device Enrollment (ADE)** über ABM in Intune eingeschrieben werden, sind supervised.
   • Nur supervised-Devicee unterstützen die vollständige Update-Steuerung.
...
Damit kannst du:
• eine konkrete iOS-Version auf alle Devicee ausRolen und
• verhindern, dass User eigenständig auf eine höhere Version aktualisieren.

**Why die anderen Optionen nicht ausreichen:**
• **Compliance Policy (C)** prüft nur, ob die Version konform ist, verhindert aber keine Updates.
• **iOS App Provisioning Profile (D)** betrifft App-Verteilung, nicht OS-Updates.
• **Company Portal (E)** führt zu User Enrollment ohne Supervision und bietet nicht die nötige OS-Update-KontRole.
`
  },
...
You use Microsoft Deployment Toolkit (MDT), um Windows-Deployments zu verwalten.
Im Deployment Share stehen folgende Betriebssystemimages zur Verfügung:

• Image1.wim – Userdefiniertes Windows 11-Image mit vorinstallierten Apps
• Image2.wim – Userdefiniertes Windows 11-Image ohne Apps
• Install.wim – Standard-Windows-11-Image aus der Microsoft-ISO

You need to mehrere Computer von Windows 10 per **In-Place Upgrade** auf Windows 11 aktualisieren und dabei den administrativen Aufwand möglichst gering halten.

Which Kombination aus Task-Sequence-Template und Betriebssystemimage solltest du in MDT verwenden?
`,
    options: [
      { key: "A", text: `Template: Standard Client Task Sequence | Image: Image1.wim` },
      { key: "B", text: `Template: Standard Client Upgrade Task Sequence | Image: Install.wim` },
      { key: "C", text: `Template: Standard Client Task Sequence | Image: Install.wim` },
      { key: "D", text: `Template: Standard Client Upgrade Task Sequence | Image: Image2.wim` }
    ],
    optionsEn: [
      { key: "A", text: `Template: Standard Client Task Sequence | Image: Image1.wim` },
      { key: "B", text: `Template: Standard Client Upgrade Task Sequence | Image: Install.wim` },
...
`,
    explanationEn: `
Ein **In-Place Upgrade** aktualisiert ein bestehendes Windows-System auf eine neue Version, ohne Userprofile, Daten oder Applicationen zu löschen.

In MDT ist dafür speziell vorgesehen:
• das Template **Standard Client Upgrade Task Sequence**
• in Kombination mit einem **Standard-Installationsimage (Install.wim)** aus der originalen Microsoft-ISO.

Die Userdefinierten Images (Image1.wim, Image2.wim) sind typischerweise für Neuinstallationen (Bare-Metal/Refresh) geeignet, enthalten aber nicht unbedingt alle Komponenten und Setup-Logik, die ein generisches Upgrade unterstützt.

Daher ist die correcte Kombination:
→ **Template: Standard Client Upgrade Task Sequence**
→ **Operating system image: Install.wim**.
`
  },
...
You have einen Workgroup-Computer namens Client1 mit Windows 11.
Der Computer ist mit einem öffentlichen Netzwerk verbunden.

You want to PowerShell-Remoting auf Client1 aktivieren, aber nur Verbindungen aus dem **lokalen Subnetz** zulassen.

Whichn PowerShell-Befehl solltest du ausführen?
`,
    options: [
      ...
      { key: "D", text: `Set-NetFirewallRule -Name "WINRM-HTTP-In-TCP-PUBLIC" -RemoteAddress Any` }
    ],
    optionsEn: [
      { key: "A", text: `Set-PSSessionConfiguration -AccessMode Local` },
      { key: "B", text: `Enable-PSRemoting -SkipNetworkProfileCheck` },
...
Auf Clients mit **öffentlichem Netzwerkprofil** verweigert \`Enable-PSRemoting\` standardmäßig die Configuration, um Securitysrisiken zu vermeiden.
...
• \`-Force\` (C) unterdrückt Nachfragen, ändert aber nicht das Verhalten gegenüber öffentlichen Netzwerken.
• \`Set-PSSessionConfiguration -AccessMode Local\` (A) beschränkt auf lokale Sitzungen – keine Remotezugriffe.
• \`Set-NetFirewallRule ... -RemoteAddress Any\` (D) würde alle Remoteadressen zulassen und ist Securitystechnisch nicht gewünscht.
`
  },
...
You manage 1.000 Windows-10-Computer, die alle in Microsoft Intune registriert sind.
Die Servicing-Channel-Settingen (Update-Ringe) werden über Intune konfiguriert.

You need to den **Servicing-Status eines bestimmten Devices** prüfen, also sehen, How der Update-Ring auf dieses Device angewendet wurde und ob Updates erfolgreich sind.

Wo im Intune Admin Center kannst du diese Information abrufen?
`,
    options: [
      { key: "A", text: `Unter Reports den Bericht „Device configuration“ anzeigen` },
      { key: "B", text: `Unter Windows devices die Ansicht „Per update ring deployment state“ nutzen` },
      { key: "C", text: `Unter Windows devices die Compliance policies des Geräts anzeigen` },
      { key: "D", text: `Unter Reports den Bericht „Device compliance“ anzeigen` }
    ],
    optionsEn: [
      { key: "A", text: `Unter Reports den Bericht „Device configuration“ anzeigen` },
      { key: "B", text: `Unter Windows devices die Ansicht „Per update ring deployment state“ nutzen` },
      { key: "C", text: `Unter Windows devices die Compliance policies des Devices anzeigen` },
      { key: "D", text: `Unter Reports den Bericht „Device Compliance“ anzeigen` }
    ],
    correctAnswers: ["B"],
    explanation: `
...
Dort siehst du pro Device:
• ob der Ring angewendet wurde,
• den aktuellen Update-Status,
• etwaige Fehler oder ausstehende Neustarts.

Die anderen Bereiche:
• **Device configuration** (A) zeigt nur Configurationsprofile, nicht den Patch-Servicing-Status.
• **Compliance policies** (C, D) beziehen sich auf die Compliancestatus, nicht auf den detaillierten Update-Rollout pro Ring.
`
  },
...
Dein Netzwerk enthält eine mit Microsoft Entra ID synchronisierte Active Directory-Domäne.
Es gibt 500 domain-joined Windows-11-Computer, die alle in Microsoft Intune registriert sind.
You plan to, **Microsoft Defender Exploit Guard** bereitzustellen und eine Userdefinierte Exploit-Guard-Policy auf alle Computer auszuRolen.

You need to:
1) Die Exploit-Guard-Settingen zentral konfigurieren.
2) Die Policy über Intune an alle Windows-11-Computer verteilen.

Which Kombination aus Tool und Verteilungsmethode solltest du verwenden?
`,
    options: [
      { key: "A", text: `Tool: Microsoft 365 Defender-Portal | Distribution: Attack Surface Reduction (ASR) Policy` },
      { key: "B", text: `Tool: Microsoft Purview compliance portal | Distribution: Device configuration profile (Device restrictions)` },
      { key: "C", text: `Tool: Windows Security App auf einem Referenzgerät | Distribution: Security baseline` },
      { key: "D", text: `Tool: Microsoft Intune admin center | Distribution: Endpoint Protection configuration profile` }
    ],
    optionsEn: [
      { key: "A", text: `Tool: Microsoft 365 Defender-Portal | Distribution: Attack Surface Reduction (ASR) Policy` },
      { key: "B", text: `Tool: Microsoft Purview Compliance portal | Distribution: Device configuration profile (Device restrictions)` },
      { key: "C", text: `Tool: Windows Security App auf einem ReferenzDevice | Distribution: Security baseline` },
      { key: "D", text: `Tool: Microsoft Intune admin center | Distribution: Endpoint Protection configuration profile` }
    ],
    correctAnswers: ["D"],
    explanation: `
...
`,
    explanationEn: `
Microsoft Defender Exploit Guard ist Teil von Microsoft Defender und kann über Intune auf verwalteten Windows-Deviceen konfiguriert und verteilt werden.

Dazu verwendest du:
• das **Microsoft Intune admin center**, um die Policy zu erstellen, und
• ein **Endpoint Protection configuration profile**, um Defender-/Exploit-Guard-Settingen zu verteilen.

Pfad in Intune:
Endpoint security → Endpoint protection → Create policy → Plattform: Windows 10 and later.
Dort findest du u. a. Configurationen für:
• Exploit protection
• Attack surface reduction (ASR) rules
• Network protection
...
Andere Optionen passen nicht:
• Das **Defender-Portal** kann zwar Policyn anzeigen, aber für MDM-Deployment in dieser Umgebung wird Intune verwendet.
• **Purview** ist für Compliance-/DLP-Szenarien zuständig, nicht für Exploit Guard.
• Security baselines enthalten nur vordefinierte Settingen und sind kein Ersatz für eine Userdefinierte Exploit-Guard-Policy.
`
  },
...
Dein Unternehmen verfügt über einen Microsoft 365 E5-Tenant.
Alle Devicee sind in Microsoft Intune registriert.

You want to **erweiterte, Userdefinierte Reports** mit eigenen Abfragen und Visualisierungen
auf Basis von Rohdaten aus Intune erstellen (z. B. per KQL, Workbooks, Power BI).

Which drei Aktionen solltest du in der correcten Reihenfolge ausführen?
`,
    options: [
      { key: "A", text: `1) Intune diagnostic settings konfigurieren, 2) Intune mit Log Analytics verknüpfen, 3) Power BI mit dem Intune Data Warehouse verbinden` },
      { key: "B", text: `1) Einen Azure Log Analytics workspace erstellen, 2) Intune mit diesem Workspace verknüpfen, 3) Intune diagnostic settings konfigurieren, um Daten zu exportieren` },
      { key: "C", text: `1) Endpoint analytics aktivieren, 2) Intune Data Warehouse nutzen, 3) Power BI mit dem Data Warehouse verbinden` },
      { key: "D", text: `1) Intune Data Warehouse mit Log Analytics verknüpfen, 2) Ein Workbook in Azure Monitor erstellen, 3) Power BI direkt an den Workspace anbinden` }
    ],
    optionsEn: [
      { key: "A", text: `1) Intune diagnostic settings konfigurieren, 2) Intune mit Log Analytics verknüpfen, 3) Power BI mit dem Intune Data Warehouse verbinden` },
      { key: "B", text: `1) Einen Azure Log Analytics workspace erstellen, 2) Intune mit diesem Workspace verknüpfen, 3) Intune diagnostic settings konfigurieren, um Daten zu exportieren` },
...
`,
    explanationEn: `
Um Rohdaten aus Intune für **Userdefinierte Abfragen und Visualisierungen** in Azure Monitor / Log Analytics zu nutzen, gehst du How folgt vor:
...
3) **Auf Basis des Workspaces Reports erstellen**:
   • You use KQL-Abfragen im Log Analytics workspace oder erstellst Workbooks.
   • Optional bindest du Power BI an den Workspace an.

Die Antwortvariante B bildet diese Reihenfolge correct ab:
1) Workspace erstellen
2) Intune an den Workspace anbinden
3) Diagnostic Settings konfigurieren (bzw. konkret den Export einrichten).
`
...
Du betreibst ein Microsoft Deployment Toolkit (MDT) Deployment Share unter D:\\MDTShare.
You want to ein Feature Pack (z. B. WinPE-PowerShell oder .NET Framework) in das MDT-Bootimage (Windows PE) integrieren.

Which drei Aktionen musst du in der correcten Reihenfolge ausführen, damit das Feature Pack im Bootimage verfügbar ist?
`,
    options: [
      { key: "A", text: `1) Das Feature Pack in den Ordner D:\\MDTShare\\Out-of-Box Drivers kopieren, 2) Eine neue Task Sequence erstellen, 3) Deployment Share aktualisieren` },
      { key: "B", text: `1) Ein Selection Profile erstellen, 2) Dieses dem Boot Image zuweisen, 3) Deployment Share aktualisieren` },
      { key: "C", text: `1) Das Feature Pack in den Ordner D:\\MDTShare\\Packages kopieren, 2) Windows PE Properties ändern, 3) Deployment Share aktualisieren` },
      { key: "D", text: `1) Das Feature Pack in D:\\MDTShare\\Tools\\(x86/x64) kopieren, 2) Die Windows PE Properties des Deployment Shares anpassen, 3) Den Deployment Share aktualisieren` }
    ],
    optionsEn: [
      { key: "A", text: `1) Das Feature Pack in den Ordner D:\\MDTShare\\Out-of-Box Drivers kopieren, 2) Eine neue Task Sequence erstellen, 3) Deployment Share aktualisieren` },
      { key: "B", text: `1) Ein Selection Profile erstellen, 2) Dieses dem Boot Image zuweisen, 3) Deployment Share aktualisieren` },
...
`,
    explanationEn: `
WinPE-Feature Packs (z. B. WinPE-PowerShell, .NET, HTA) werden über MDT How folgt in das Bootimage eingebunden:
...
You plan to, Windows 11 auf 200 neuen Computern mit Microsoft Deployment Toolkit (MDT) und Windows Deployment Services (WDS) zu installieren.
Das Unternehmen besitzt ein Volume Licensing Agreement und verwendet einen zentralen Product Key (MAK oder KMS) für Windows 11.

Die neuen Computer sollen während der Installation automatisch den correcten Produktschlüssel erhalten, ohne dass der Administrator ihn manuell eingeben muss.

Was musst du in MDT konfigurieren?
`,
    options: [
      { key: "A", text: `Den Product Key in einer MDT Task Sequence konfigurieren` },
      { key: "B", text: `Den Product Key in der Bootstrap.ini hinterlegen` },
      { key: "C", text: `Den Product Key in WDS als Standard-Key konfigurieren` },
      { key: "D", text: `Den Product Key manuell in der Unattend.xml auf jedem Client eintragen` }
    ],
    optionsEn: [
      { key: "A", text: `Den Product Key in einer MDT Task Sequence konfigurieren` },
      { key: "B", text: `Den Product Key in der Bootstrap.ini hinterlegen` },
...
`,
    explanationEn: `
In MDT werden alle Settingen für das Betriebssystem-Deployment über die **Task Sequence** und die dazugehörigen Unattend-Vorlagen gesteuert.
...
Alternative Methoden (Bootstrap.ini, WDS) sind für Dinge How Verbindungsinformationen oder PXE-Boot zuständig, aber nicht der primäre Ort für die automatisierte Lizenzierung im MDT-Kontext.

Daher ist die correcte Answer: **Produkt-Key in einer MDT Task Sequence konfigurieren.**
`
  },
...
You use Windows Autopilot und Microsoft Intune, um Windows-11-Devicee bereitzustellen.

Während der Deployment sollen folgende Anforderungen erfüllt sein:
• Der User soll den **Fortschritt** der App- und Profilinstallation sehen können.
• Die Useranmeldung soll **so lange blockiert** werden, bis alle zugeHowsenen Apps und Profile erfolgreich installiert sind.

Which Intune-Funktion musst du konfigurieren, um diese Anforderungen zu erfüllen?
`,
    options: [
...
`,
    explanationEn: `
Die **Enrollment Status Page (ESP)** in Intune wird während der Windows-Autopilot-Deployment angezeigt.
Sie zeigt den Fortschritt bei der Application von:
• Configurationsprofilen
• Apps
• Skripten
und kann die Nutzung des Devices blockieren, bis alle erforderlichen Zuweisungen abgeschlossen sind.

In der ESP-Configuration kannst du u. a. einstellen:
• „Show app and profile installation progress“ = Yes
• „Block device use until all apps and profiles are installed“ = Yes

Damit werden beide Anforderungen erfüllt:
• Sichtbarer Installationsfortschritt
• Blockierung der Anmeldung, bis das Device vollständig konfiguriert ist.

Andere Policyntypen (App configuration, Compliance, Enrollment restrictions) bieten diese OOBE-Blocking-Funktion nicht.
`
  },
...
You manage eine Microsoft-365-Umgebung mit Microsoft Intune.

Anforderungen:
1) Nur Devicee mit **genehmigten Plattformen und OS-Versionen** sollen sich in Intune registrieren dürfen.
2) Während der Enrollment sollen User eine **Kategorie** auswählen (z. B. Vertrieb, IT, Management),
   und basierend auf dieser Auswahl sollen die Devicee automatisch den passenden Azure-AD-Groupn beitreten.

Which beiden Intune-Funktionen musst du konfigurieren, um diese Anforderungen zu erfüllen? (Jede correcte Antwort ist einen Punkt wert.)
`,
    options: [
...
2) **Devicee basierend auf einer Userauswahl automatisch Groupn zuordnen**:
   • Dafür verwendest du **Device categories** (E).
   • User wählen bei der Enrollment eine Kategorie (z. B. „Sales“, „IT“).
   • Du kannst diese Kategorien mit dynamischen Azure-AD-Groupn verknüpfen und so Zuweisungen (Apps, Policies) steuern.

Andere Optionen:
• Configuration profiles (A) und Compliance policies (B) konfigurieren Settingen oder prüfen Compliance, steuern aber nicht, ob sich Devicee überhaupt registrieren dürfen.
• App protection policies (D) schützen Apps/Daten, haben nichts mit Enrollment- oder Groupnbeitrittslogik zu tun.
`
  },
...
You manage einen in Intune registrierten Windows-11-Computer namens Computer1.

Computer1 soll als **öffentliche Workstation** in einer Filiale dienen und ausschließlich eine einzige, kundenorientierte Application im **Vollbildmodus** ausführen.
User sollen keinen Zugriff auf Desktop, Startmenü oder andere Apps haben.

Whichn Configurationstemplate-Typ solltest du im Intune Admin Center verwenden, um Computer1 entsprechend zu konfigurieren?
`,
    options: [
...
`,
    explanationEn: `
Für Szenarien, in denen ein Windows-Device nur eine oder wenige Apps (z. B. Kasse, Info-Terminal, Kunden-App) ausführen soll, ist der **Kiosk-Modus** vorgesehen.

In Intune erstellst du dazu ein Configurationsprofil:
Devices → Configuration profiles → Create profile → Plattform: Windows 10 and later → Template: **Kiosk**.

Dort kannst du:
• Single-app oder multi-app Kiosk konfigurieren,
• festlegen, Which App im Vollbild gestartet wird,
• das Kiosk-Konto definieren.

Andere Templates:
• **Shared multi-user device**: für gemeinsam genutzte Devicee (z. B. Schichtbetrieb), aber kein Single-App-Lockdown.
• **Device restrictions**: kann zwar viele Funktionen sperren, aber nicht so komfortabel einen Kiosk-Single-App-Modus abbilden.
• **Endpoint protection**: für Securitys-/Defender-Settingen, nicht für Kiosk-Szenarien.
`
  },
...
You manage ein MDT Deployment Share DS1 mit folgender Treiberstruktur:
...
Ziel ist, dass während der Deployment automatisch alle Treiber installiert werden,
die zum **Hersteller und Modell** des jeweiligen Computers passen –
ohne Plug-and-Play-Erkennung und ohne Selection Profiles.

In Whichr Phase der MDT-Tasksequenz und mit Whichr Aktion solltest du das konfigurieren?
`,
    options: [
      { key: "A", text: `Phase: Install | Task: Inject Drivers` },
      { key: "B", text: `Phase: Install | Task: Set Task Sequence Variable` },
      { key: "C", text: `Phase: Preinstall | Task: Set Task Sequence Variable` },
      { key: "D", text: `Phase: Preinstall | Task: Validate` },
      { key: "E", text: `Phase: Validation | Task: Set Task Sequence Variable` },
...
Typische Configuration in der Task Sequence:
• Phase: **Preinstall**
• Task: **Set Task Sequence Variable**
• Variable: DriverGroup001
• Wert: z. B. \`Windows 10 x64\\%Make%\\%Model%\`
...
Der eigentliche Schritt „Inject Drivers“ bleibt zwar in der Install-Phase, aber *die Steuerung*, Whichr Ordner verwendet wird, wird in der **Preinstall-Phase** über **Set Task Sequence Variable** vorgenommen.
...
`,
    options: [
      { key: "A", text: `Administrator password: CustomSettings.ini | Computer names: CustomSettings.ini` },
      { key: "B", text: `Administrator password: Bootstrap.ini | Computer names: CustomSettings.ini` },
      { key: "C", text: `Administrator password: Bootstrap.ini | Computer names: Bootstrap.ini` },
      { key: "D", text: `Administrator password: Unattend.xml | Computer names: CustomSettings.ini` }
    ],
    optionsEn: [
      { key: "A", text: `Administrator password: CustomSettings.ini | Computer names: CustomSettings.ini` },
      { key: "B", text: `Administrator password: Bootstrap.ini | Computer names: CustomSettings.ini` },
    ...
    correctAnswers: ["A"],
    explanation: `
In MDT werden sowohl die Admin-Passwortabfrage (SkipAdminPassword / AdminPassword) als auch die automatische Computerbenennung (OSDComputerName) über die Regeln in der CustomSettings.ini gesteuert. Bootstrap.ini definiert nur den Zugriff auf die Deployment-Share (DeployRoot, UserID usw.) und ist für diese Anforderungen nicht zuständig. Da die Regeln zur Laufzeit eingelesen werden, muss das WinPE-Image nicht neu erzeugt werden.
`,
    explanationEn: `
In MDT werden sowohl die Admin-Passwortabfrage (SkipAdminPassword / AdminPassword) als auch die automatische Computerbenennung (OSDComputerName) über die Regeln in der CustomSettings.ini gesteuert. Bootstrap.ini definiert nur den Zugriff auf die Deployment-Share (DeployRoot, UserID usw.) und ist für diese Anforderungen nicht zuständig. Da die Regeln zur Laufzeit eingelesen werden, muss das WinPE-Image nicht neu erzeugt werden.
`
...
You have a Microsoft 365 subscription with 1,000 Windows 11 devices enRoled in Microsoft Intune.
...
`,
    ...
    correctAnswers: ["B", "F"],
    explanation: `
Die Anforderung ‚Secure Boot erforderlich‘ wird in einer Intune-Compliance-Richtlinie im Abschnitt Device health konfiguriert. Die Bewertung anhand des Geräte-Risikoscores stammt aus Microsoft Defender for Endpoint und wird im Abschnitt Microsoft Defender for Endpoint der Compliance-Richtlinie aktiviert. Andere Bereiche wie Device properties oder System security decken diese beiden Anforderungen nicht ab.
`,
    explanationEn: `
Die Anforderung ‚Secure Boot erforderlich‘ wird in einer Intune-Compliance-Policy im Abschnitt Device health konfiguriert. Die Bewertung anhand des Devicee-Risikoscores stammt aus Microsoft Defender for Endpoint und wird im Abschnitt Microsoft Defender for Endpoint der Compliance-Policy aktiviert. Andere Bereiche How Device properties oder System security decken diese beiden Anforderungen nicht ab.
`
  },
...
`,
    options: [
      { key: "A", text: `Each computer has a line of sight to a domain controller.` },
      { key: "B", text: `Each computer is enrolled in Microsoft Intune before the hybrid join.` },
      { key: "C", text: `Each computer is configured for Windows Hello for Business.` },
      { key: "D", text: `Each computer has a device certificate issued by an enterprise CA.` }
    ],
    optionsEn: [
      { key: "A", text: `Each computer has a line of sight to a domain contRoler.` },
      { key: "B", text: `Each computer is enRoled in Microsoft Intune before the hybrid join.` },
      { key: "C", text: `Each computer is configured for Windows Hello for Business.` },
      { key: "D", text: `Each computer has a device certificate issued by an enterprise CA.` }
    ],
    correctAnswers: ["A"],
    explanation: `
Für einen erfolgreichen Microsoft Entra Hybrid Join muss das Gerät regelmäßig eine Netzwerkverbindung (‚line of sight‘) zu einem Domänencontroller haben, damit der Join-Workflow abgeschlossen werden kann. Fehlt diese Verbindung (z. B. nur Internet ohne VPN), verbleibt das Gerät im Status ‚Pending‘. Intune-Enrollment, WHfB oder Zertifikate sind hier nicht die primäre Voraussetzung für den Abschluss des Hybrid Join.
`,
    explanationEn: `
Für einen erfolgreichen Microsoft Entra Hybrid Join muss das Device regelmäßig eine Netzwerkverbindung (‚line of sight‘) zu einem DomänencontRoler haben, damit der Join-Workflow abgeschlossen werden kann. Fehlt diese Verbindung (z. B. nur Internet ohne VPN), verbleibt das Device im Status ‚Pending‘. Intune-Enrollment, WHfB oder Certificatee sind hier nicht die primäre Voraussetzung für den Abschluss des Hybrid Join.
`
  },
...
`,
    options: [
      { key: "A", text: `Research: FIDO2 security keys | Sales: Microsoft Authenticator` },
      { key: "B", text: `Research: Microsoft Authenticator | Sales: FIDO2 security keys` },
      { key: "C", text: `Research: Windows Hello for Business | Sales: Microsoft Authenticator` },
      { key: "D", text: `Research: Certificate-based authentication | Sales: Temporary Access Pass` }
    ],
    optionsEn: [
      { key: "A", text: `Research: FIDO2 security keys | Sales: Microsoft Authenticator` },
      { key: "B", text: `Research: Microsoft Authenticator | Sales: FIDO2 security keys` },
    ...
    correctAnswers: ["A"],
    explanation: `
Für Research sind FIDO2-Sicherheitsschlüssel ideal, weil sie plattformunabhängig (inkl. Linux) funktionieren und kein Smartphone benötigen. Für Sales ist die Microsoft Authenticator App die geeignete, passwortlose Methode, da explizit eine Authentifizierung über Mobiltelefone gefordert ist. Windows Hello for Business setzt Windows-Clients voraus und eignet sich daher nicht für reine Linux-Umgebungen.
`,
    explanationEn: `
Für Research sind FIDO2-Securitysschlüssel ideal, weil sie plattformunabhängig (inkl. Linux) funktionieren und kein Smartphone benötigen. Für Sales ist die Microsoft Authenticator App die geeignete, passwortlose Methode, da explizit eine Authentication über Mobiltelefone gefordert ist. Windows Hello for Business setzt Windows-Clients voraus und eignet sich daher nicht für reine Linux-Umgebungen.
`
  },
...
`,
    ...
    correctAnswers: ["D"],
    explanation: `
Damit Policy1 immer gemeinsam mit den Konfigurationsprofilen aus Set1 zugewiesen wird, muss Policy1 in den Set1 configurations als Bestandteil des Policy Sets hinzugefügt werden. Reine Assignments von Policy1 oder Set1 stellen keine logische Kopplung zwischen den Objekten her.
`,
    explanationEn: `
Damit Policy1 immer gemeinsam mit den Configurationsprofilen aus Set1 zugeHowsen wird, muss Policy1 in den Set1 configurations als Bestandteil des Policy Sets hinzugefügt werden. Reine Assignments von Policy1 oder Set1 stellen keine logische Kopplung zwischen den Objekten her.
`
  },
...
The company purchases 100 new Windows client devices.
You plan to use Windows Autopilot so that the devices are automatically joined to Microsoft Entra ID and enRoled into Intune.

Which management tool should you use, and which information must you collect from each device?
`,
    options: [
      { key: "A", text: `Tool: Windows Deployment Services console | Information: MAC address only` },
      { key: "B", text: `Tool: Microsoft Intune admin center | Information: Device serial number and hardware hash` },
      { key: "C", text: `Tool: Microsoft Entra admin center | Information: Computer name and on-premises domain` },
      { key: "D", text: `Tool: Volume Activation Management Tool | Information: Windows product key and edition` }
    ],
    optionsEn: [
      { key: "A", text: `Tool: Windows Deployment Services console | Information: MAC address only` },
      { key: "B", text: `Tool: Microsoft Intune admin center | Information: Device serial number and hardware hash` },
    ...
    correctAnswers: ["B"],
    explanation: `
Windows Autopilot-Geräte werden im Microsoft Intune admin center registriert, indem eine CSV-Datei mit Seriennummer und Hardware-Hash der Geräte importiert wird. WDS, VAMT oder nur MAC-Adressen reichen für eine Autopilot-Registrierung nicht aus.
`,
    explanationEn: `
Windows Autopilot-Devicee werden im Microsoft Intune admin center registriert, indem eine CSV-Datei mit Seriennummer und Hardware-Hash der Devicee importiert wird. WDS, VAMT oder nur MAC-Adressen reichen für eine Autopilot-Enrollment nicht aus.
`
  },
...
`,
    options: [
      { key: "A", text: `Create a Microsoft Entra device group that uses a dynamic membership rule based on the ZTDID tag.` },
      { key: "B", text: `Create a security group and manually add Autopilot devices to the group.` },
      { key: "C", text: `Assign a Windows Autopilot deployment profile to the dynamic device group.` },
      { key: "D", text: `Assign the Windows Autopilot deployment profile directly to each user account.` }
    ],
    optionsEn: [
      { key: "A", text: `Create a Microsoft Entra device group that uses a dynamic membership rule based on the ZTDID tag.` },
      { key: "B", text: `Create a security group and manually add Autopilot devices to the group.` },
    ...
    correctAnswers: ["A", "C"],
    explanation: `
Autopilot-Geräte werden typischerweise über eine dynamische Gerätegruppe erkannt, deren Regel auf der Eigenschaft devicePhysicalIds mit dem Tag [ZTDId] basiert. Das Windows Autopilot Deployment Profile wird anschließend dieser dynamischen Gruppe zugewiesen, sodass alle neuen Autopilot-Geräte automatisch das Profil erhalten. Manuelle Gruppenpflege oder Zuweisung pro Benutzer ist fehleranfällig und nicht erforderlich.
`,
    explanationEn: `
Autopilot-Devicee werden typischerweise über eine dynamische DeviceeGroup erkannt, deren Regel auf der Eigenschaft devicePhysicalIds mit dem Tag [ZTDId] basiert. Das Windows Autopilot Deployment Profile wird anschließend dieser dynamischen Group zugeHowsen, sodass alle neuen Autopilot-Devicee automatisch das Profil erhalten. Manuelle Groupnpflege oder Zuweisung pro User ist fehleranfällig und nicht erforderlich.
`
  },
...
You have a user named Jonas with the UPN Jonas@architekturbüro-modern.de

You need to allow Jonas to connect to the devices by using Remote Desktop.
...
`,
    options: [
      { key: "A", text: `net localgroup "AzureADUser1@contoso.com" /add "Device Owners"` },
      { key: "B", text: `net localgroup "contosoUser1" /add "Remote Desktop Users"` },
      { key: "C", text: `net localgroup "Device Owners" /add "contosoUser1"` },
      { key: "D", text: `net localgroup "Remote Desktop Users" /add "AzureADUser1@contoso.com"` },
      { key: "E", text: `net localgroup "User1@contoso.com" /add "Remote Desktop Users"` }
    ],
    optionsEn: [
      { key: "A", text: `net localgroup "AzureADUser1@contoso.com" /add "Device Owners"` },
      { key: "B", text: `net localgroup "contosoUser1" /add "Remote Desktop Users"` },
    ...
    correctAnswers: ["D"],
    explanation: `
Auf Azure AD-joined Geräten werden Cloudbenutzer lokal im Format AzureADUPN referenziert. Damit Jonas RDP nutzen darf, muss sein Konto der lokalen Gruppe Remote Desktop Users hinzugefügt werden: net localgroup "Remote Desktop Users" /add "AzureADJonas@architekturbüro-modern.de".
`,
    explanationEn: `
Auf Azure AD-joined Deviceen werden CloudUser lokal im Format AzureADUPN referenziert. Damit Jonas RDP nutzen darf, muss sein Konto der lokalen Group Remote Desktop Users hinzugefügt werden: net localgroup "Remote Desktop Users" /add "AzureADJonas@architekturbüro-modern.de".
`
  },
...
`,
    ...
    correctAnswers: ["D"],
    explanation: `
Microsoft Defender for Endpoint unterstützt Windows 10/11 (Pro, Enterprise, Education) sowie aktuelle macOS-Versionen. Damit sind Device1 (Windows 11), Device2 (Windows 10) und Device3 (aktuelles macOS) onboard-fähig. Das veraltete macOS X auf Device4 wird nicht mehr von MDE unterstützt.
`,
    explanationEn: `
Microsoft Defender for Endpoint unterstützt Windows 10/11 (Pro, Enterprise, Education) soHow aktuelle macOS-Versionen. Damit sind Device1 (Windows 11), Device2 (Windows 10) und Device3 (aktuelles macOS) onboard-fähig. Das veraltete macOS X auf Device4 wird nicht mehr von MDE unterstützt.
`
  },
...
`,
    options: [
      { key: "A", text: `Device1 can get updates from Device3 only. Device2 cannot get updates from any device.` },
      { key: "B", text: `Device1 cannot get updates from any device. Device2 can get updates from Device3 only.` },
      { key: "C", text: `Device1 can get updates from Device2 and Device3 only. Device2 can get updates from Device1 and Device3 only.` },
      { key: "D", text: `Device1 can get updates from Device2, Device3, and Device4. Device2 can get updates from Device1, Device3, and Device4.` }
    ],
    optionsEn: [
      { key: "A", text: `Device1 can get updates from Device3 only. Device2 cannot get updates from any device.` },
      { key: "B", text: `Device1 cannot get updates from any device. Device2 can get updates from Device3 only.` },
    ...
    correctAnswers: ["A"],
    explanation: `
Mit Download mode = 2 (Private Group) und ‚Restrict peer selection = Subnet mask‘ dürfen Peers nur innerhalb desselben Subnetzes Inhalte austauschen. Im Szenario liegt nur Device3 im gleichen Subnetz wie Device1; Device2 hat in seinem Subnetz keinen weiteren Peer. Somit kann Device1 nur von Device3 beziehen, Device2 von keinem anderen Gerät.
`,
    explanationEn: `
Mit Download mode = 2 (Private Group) und ‚Restrict peer selection = Subnet mask‘ dürfen Peers nur innerhalb desselben Subnetzes Inhalte austauschen. Im Szenario liegt nur Device3 im gleichen Subnetz How Device1; Device2 hat in seinem Subnetz keinen weiteren Peer. Somit kann Device1 nur von Device3 beziehen, Device2 von keinem anderen Device.
`
  },
...
You have a Microsoft 365 E5 subscription.
A Windows 11 computer named Computer1 is enRoled in Microsoft Intune.
...
`,
    options: [
      { key: "A", text: `Use Deployment Image Servicing and Management (DISM) | File format: .ipa` },
      { key: "B", text: `Use Microsoft Application Virtualization (App-V) Sequencer | File format: .appv` },
      { key: "C", text: `Use Microsoft Application Virtualization (App-V) Sequencer | File format: .ipa` },
      { key: "D", text: `Use Win32 Content Prep Tool | File format: .intunewin` },
      { key: "E", text: `Use Windows Package Manager | File format: .apk` },
      { key: "F", text: `Use Windows Package Manager | File format: .intunewin` }
    ],
    optionsEn: [
      { key: "A", text: `Use Deployment Image Servicing and Management (DISM) | File format: .ipa` },
      { key: "B", text: `Use Microsoft Application Virtualization (App-V) Sequencer | File format: .appv` },
    ...
    correctAnswers: ["D"],
    explanation: `
Für Win32-Apps in Intune müssen die Installationsdateien mit dem Microsoft Win32 Content Prep Tool (IntuneWinAppUtil.exe) in das Format .intunewin verpackt werden. Dieses Paket wird anschließend im Intune Admin Center als Win32-App hochgeladen. DISM, App-V oder Winget erzeugen nicht das für Intune benötigte .intunewin-Format.
`,
    explanationEn: `
Für Win32-Apps in Intune müssen die Installationsdateien mit dem Microsoft Win32 Content Prep Tool (IntuneWinAppUtil.exe) in das Format .intunewin verpackt werden. Dieses Paket wird anschließend im Intune Admin Center als Win32-App hochgeladen. DISM, App-V oder Winget erzeugen nicht das für Intune benötigte .intunewin-Format.
`
...
You manage the Microsoft Entra ID tenant nordwind-gmbh.de.
...
During the Windows out-of-box experience (OOBE), users must:
• Sign in with their corporate account.
• Have the device automatically enRoled into Microsoft Intune.
...
`,
    options: [
      ...
      { key: "B", text: `Automatic enrollment for Windows devices in Microsoft Intune` },
      { key: "C", text: `A provisioning package (PPKG) applied from USB` },
      { key: "D", text: `A self-deploying Autopilot deployment profile` },
      { key: "E", text: `A Windows Autopilot deployment profile configured for user-driven mode` }
    ],
    optionsEn: [
      { key: "A", text: `An Enrollment Status Page (ESP) profile` },
      { key: "B", text: `Automatic enrollment for Windows devices in Microsoft Intune` },
    ...
    correctAnswers: ["B", "E"],
    explanation: `
Für das Szenario ‚Benutzer meldet sich während OOBE an und Gerät wird automatisch in Intune eingeschrieben‘ sind zwei Dinge nötig: • Automatic enrollment in Intune für Azure AD-(Entra)-Beitritte. • Ein Windows Autopilot Deployment Profile im User-driven mode, das die OOBE steuert. PPKG oder Self-deploying-Profile sind eher für Kiosk- oder Offline-Szenarien geeignet.
`,
    explanationEn: `
Für das Szenario ‚User meldet sich während OOBE an und Device wird automatisch in Intune eingeschrieben‘ sind zwei Dinge nötig: • Automatic enrollment in Intune für Azure AD-(Entra)-Beitritte. • Ein Windows Autopilot Deployment Profile im User-driven mode, das die OOBE steuert. PPKG oder Self-deploying-Profile sind eher für Kiosk- oder Offline-Szenarien geeignet.
`
  },
...
3. Finn requires an additional license to activate Windows 11 on Device3 by using Subscription Activation.
...
`,
    ...
    correctAnswers: ["E"],
    explanation: `
Device1 erfüllt aufgrund von TPM 1.2 nicht die Mindestanforderungen von Windows 11 und kann daher nicht (unterstützt) aktualisiert und per Subscription Activation genutzt werden → Aussage 1 = No. Device2 erfüllt bereits alle Windows-11-Hardwareanforderungen, daher ist keine zusätzliche Hardware nötig → Aussage 2 = No. Finn benötigt eine passende Windows-Enterprise-Lizenz (z. B. über Microsoft 365 E3/E5) für Subscription Activation; im Szenario ist eine zusätzliche Lizenz nötig → Aussage 3 = Yes. Damit ergibt sich die Kombination: Device1: No, Device2: No, Finn: Yes.
`,
    explanationEn: `
Device1 erfüllt aufgrund von TPM 1.2 nicht die Mindestanforderungen von Windows 11 und kann daher nicht (unterstützt) aktualisiert und per Subscription Activation genutzt werden → Aussage 1 = No. Device2 erfüllt bereits alle Windows-11-Hardwareanforderungen, daher ist keine zusätzliche Hardware nötig → Aussage 2 = No. Finn benötigt eine passende Windows-Enterprise-Lizenz (z. B. über Microsoft 365 E3/E5) für Subscription Activation; im Szenario ist eine zusätzliche Lizenz nötig → Aussage 3 = Yes. Damit ergibt sich die Kombination: Device1: No, Device2: No, Finn: Yes.
`
...
Your on-premises network contains an Active Directory domain named medizintechnik-plus.de.
...
`,
    options: [
      ...
      { key: "B", text: `In Active Directory, configure Computer2 as Trusted for Delegation.` },
      { key: "C", text: `On Computer1, run New-PSSession.` },
      { key: "D", text: `On Computer2, add Computer1 to the Remote Management Users group.` }
    ],
    optionsEn: [
      { key: "A", text: `On Computer2, run Enable-PSRemoting.` },
      { key: "B", text: `In Active Directory, configure Computer2 as Trusted for Delegation.` },
    ...
    correctAnswers: ["A"],
    explanation: `
Damit Computer2 PowerShell-Remoteanfragen akzeptiert, muss dort zunächst Enable-PSRemoting ausgeführt werden. Der Befehl konfiguriert WinRM, erstellt Listener und passt die Firewall an, sodass Invoke-Command, Enter-PSSession usw. funktionieren. Delegation oder New-PSSession allein aktivieren PSRemoting nicht.
`,
    explanationEn: `
Damit Computer2 PowerShell-Remoteanfragen akzeptiert, muss dort zunächst Enable-PSRemoting ausgeführt werden. Der Befehl konfiguriert WinRM, erstellt Listener und passt die Firewall an, sodass Invoke-Command, Enter-PSSession usw. funktionieren. Delegation oder New-PSSession allein aktivieren PSRemoting nicht.
`
...
Your network contains an Active Directory domain named Kunde-GmbH.com and a workgroup.
The network has three Windows 10 computers configured as follows:

• Computer1: Member of the Kunde-GmbH.com domain. Windows Defender Firewall is enabled.
• Computer2: Member of the Kunde-GmbH.com domain. The local Administrator account has the same name and password as on Computer1.
...
`,
    options: [
      { key: "A", text: `Statement 1: Yes | Statement 2: Yes | Statement 3: Yes` },
      { key: "B", text: `Statement 1: Yes | Statement 2: Yes | Statement 3: No` },
      { key: "C", text: `Statement 1: Yes | Statement 2: No | Statement 3: No` },
      { key: "D", text: `Statement 1: No | Statement 2: Yes | Statement 3: Yes` },
      { key: "E", text: `Statement 1: No | Statement 2: Yes | Statement 3: No` },
    ...
    correctAnswers: ["F"],
    explanation: `
Für die Remoteverwaltung von Datenträgern wird die Firewall-Ausnahme für Remote Volume Management benötigt, die auf Computer1 deaktiviert ist – Disk Management funktioniert daher nicht remote. Der Dienst ‚Remote Registry‘ ist gestoppt, daher kann die Registrierung von Computer1 nicht remote bearbeitet werden. Für Performance Counter-Abfragen sind funktionierende RPC-/Firewall-Pfade nötig; die aktuelle Konfiguration verhindert auch diese Verbindung. Damit sind alle drei Aussagen falsch und die Kombination No/No/No (Option F) ist korrekt.
`,
    explanationEn: `
Für die RemoteManagement von Datenträgern wird die Firewall-Ausnahme für Remote Volume Management benötigt, die auf Computer1 deaktiviert ist – Disk Management funktioniert daher nicht remote. Der Dienst ‚Remote Registry‘ ist gestoppt, daher kann die Enrollment von Computer1 nicht remote bearbeitet werden. Für Performance Counter-Abfragen sind funktionierende RPC-/Firewall-Pfade nötig; die aktuelle Configuration verhindert auch diese Verbindung. Damit sind alle drei Aussagen incorrect und die Kombination No/No/No (Option F) ist correct.
`
  },
...
`,
    ...
    correctAnswers: ["C"],
    explanation: `
Windows Subscription Activation setzt voraus, dass das Gerät mindestens Windows Pro ausführt und Microsoft Entra-joined oder hybrid-joined ist. Azure AD registered (nur registriert) reicht nicht aus. Damit erfüllen nur Device1 (Windows 11 Pro, joined) und Device3 (Windows 10 Pro, joined) die Voraussetzungen.
`,
    explanationEn: `
Windows Subscription Activation setzt voraus, dass das Device mindestens Windows Pro ausführt und Microsoft Entra-joined oder hybrid-joined ist. Azure AD registered (nur registriert) reicht nicht aus. Damit erfüllen nur Device1 (Windows 11 Pro, joined) und Device3 (Windows 10 Pro, joined) die Voraussetzungen.
`
  },
...
`,
    options: [
      ...
      { key: "B", text: `Import a full set of source files for Windows 11 into the deployment share.` },
      { key: "C", text: `Import a custom captured image (custom image file) into the deployment share.` },
      { key: "D", text: `Run the Update Deployment Share Wizard to regenerate the boot images.` }
    ],
    optionsEn: [
      { key: "A", text: `Enable monitoring for the deployment share.` },
      { key: "B", text: `Import a full set of source files for Windows 11 into the deployment share.` },
    ...
    correctAnswers: ["B"],
    explanation: `
Upgrade-Tasksequenzen in MDT erwarten ein vollständiges Betriebssystem-Setup (install.wim aus der Original-ISO). Dafür muss ein ‚Full set of source files‘ für Windows 10/11 importiert werden. Custom Images werden für In-place-Upgrades nicht unterstützt und Boot-Image-Updates allein liefern keine OS-Images.
`,
    explanationEn: `
Upgrade-Tasksequenzen in MDT erwarten ein vollständiges Betriebssystem-Setup (install.wim aus der Original-ISO). Dafür muss ein ‚Full set of source files‘ für Windows 10/11 importiert werden. Custom Images werden für In-place-Upgrades nicht unterstützt und Boot-Image-Updates allein liefern keine OS-Images.
`
...
`,
    options: [
      { key: "A", text: `Prepare the contents of App1 by using the Microsoft Win32 Content Prep Tool.` },
      { key: "B", text: `Create an Android application package (.apk) for App1.` },
      { key: "C", text: `Upload the raw App1 installation files directly to Intune as a line-of-business app.` },
      { key: "D", text: `Install the Microsoft Deployment Toolkit (MDT) and create an MDT application.` }
    ],
    optionsEn: [
      { key: "A", text: `Prepare the contents of App1 by using the Microsoft Win32 Content Prep Tool.` },
      { key: "B", text: `Create an Android application package (.apk) for App1.` },
    ...
    correctAnswers: ["A"],
    explanation: `
Win32-Anwendungen müssen vor dem Upload nach Intune mit dem Microsoft Win32 Content Prep Tool (IntuneWinAppUtil.exe) in das Format .intunewin verpackt werden. APK-Dateien gelten nur für Android, MDT ist für OS-Deployment gedacht, und das direkte Hochladen mehrerer lose Dateien als LOB-App ist für Win32-Apps nicht vorgesehen.
`,
    explanationEn: `
Win32-Applicationen müssen vor dem Upload nach Intune mit dem Microsoft Win32 Content Prep Tool (IntuneWinAppUtil.exe) in das Format .intunewin verpackt werden. APK-Dateien gelten nur für Android, MDT ist für OS-Deployment gedacht, und das direkte Hochladen mehrerer lose Dateien als LOB-App ist für Win32-Apps nicht vorgesehen.
`
  },
...
`,
    ...
    correctAnswers: ["D"],
    explanation: `
Endpoint Analytics verwendet in Intune eine spezielle Datensammlungsrichtlinie, um Leistungs- und Startmetriken von Windows-Geräten zu erfassen. Azure Monitor, Compliance-Richtlinien oder Conditional Access liefern zwar Telemetrie bzw. Zugriffssteuerung, erfassen aber keine Endpoint-Analytics-Leistungsdaten.
`,
    explanationEn: `
Endpoint Analytics verwendet in Intune eine spezielle DatensammlungsPolicy, um Leistungs- und Startmetriken von Windows-Deviceen zu erfassen. Azure Monitor, Compliance-Policyn oder Conditional Access liefern zwar Telemetrie bzw. Zugriffssteuerung, erfassen aber keine Endpoint-Analytics-Leistungsdaten.
`
  },
...
`,
    ...
    correctAnswers: ["C"],
    explanation: `
Policy Sets können mehrere Intune-Objekte bündeln, darunter Device Compliance Policies und Device Configuration Profiles. Conditional Access wird in Entra ID verwaltet und ist kein direktes Intune-Objekt in Policy Sets. Daher lassen sich Comply2 (weitere Compliance-Richtlinie) und Conf1 (Konfigurationsprofil) in Set1 ergänzen.
`,
    explanationEn: `
Policy Sets können mehrere Intune-Objekte bündeln, darunter Device Compliance Policies und Device Configuration Profiles. Conditional Access wird in Entra ID verwaltet und ist kein direktes Intune-Objekt in Policy Sets. Daher lassen sich Comply2 (weitere Compliance-Policy) und Conf1 (Configurationsprofil) in Set1 ergänzen.
`
  },
...
`,
    ...
    correctAnswers: ["A"],
    explanation: `
Number Matching ist eine Funktion der Microsoft Authenticator App in Verbindung mit passwortloser bzw. MFA-Anmeldung in Microsoft Entra ID. Telefonanruf und SMS sind klassische MFA-Methoden ohne Number Matching, FIDO2 arbeitet hardwarebasiert und zeigt keine solche Zahl auf dem Telefon an.
`,
    explanationEn: `
Number Matching ist eine Funktion der Microsoft Authenticator App in Verbindung mit passwortloser bzw. MFA-Anmeldung in Microsoft Entra ID. Telefonanruf und SMS sind klassische MFA-Methoden ohne Number Matching, FIDO2 arbeitet hardwarebasiert und zeigt keine solche Zahl auf dem Telefon an.
`
...
• Max: Member of Group1, licensed with Microsoft 365 E1
• Lisa: Member of Group1, licensed with Microsoft 365 E3
• Tom: Member of Group2, licensed with Microsoft 365 E5
...
Statement 1: Max can complete the Autopilot provisioning process on Device1.
Statement 2: Lisa can complete the Autopilot provisioning process on Device1.
Statement 3: Tom can view information about Device1 on the Enrollment Status Page during provisioning.
...
`,
    options: [
      { key: "A", text: `Statement 1: Yes | Statement 2: Yes | Statement 3: Yes` },
      { key: "B", text: `Statement 1: Yes | Statement 2: No | Statement 3: Yes` },
      { key: "C", text: `Statement 1: No | Statement 2: Yes | Statement 3: No` },
      { key: "D", text: `Statement 1: No | Statement 2: No | Statement 3: Yes` },
      { key: "E", text: `Statement 1: No | Statement 2: Yes | Statement 3: Yes` }
    ],
    optionsEn: [
      { key: "A", text: `Statement 1: Yes | Statement 2: Yes | Statement 3: Yes` },
      { key: "B", text: `Statement 1: Yes | Statement 2: No | Statement 3: Yes` },
    ...
    correctAnswers: ["E"],
    explanation: `
Microsoft 365 E1 enthält kein Intune, daher kann Max den Autopilot-Bereitstellungsprozess nicht erfolgreich abschließen. Lisa verfügt über M365 E3 mit Intune und kann Device1 (Windows 10 Pro, Autopilot-registriert) per Autopilot bereitstellen. Tom hat M365 E5 und ist Mitglied der Gruppe, die der Enrollment Status Page zugewiesen ist – er sieht daher während des Deployments die ESP-Informationen. Damit ergibt sich die Kombination No / Yes / Yes (Option E).
`,
    explanationEn: `
Microsoft 365 E1 enthält kein Intune, daher kann Max den Autopilot-Deploymentsprozess nicht erfolgreich abschließen. Lisa verfügt über M365 E3 mit Intune und kann Device1 (Windows 10 Pro, Autopilot-registriert) per Autopilot bereitstellen. Tom hat M365 E5 und ist Mitglied der Group, die der Enrollment Status Page zugeHowsen ist – er sieht daher während des Deployments die ESP-Informationen. Damit ergibt sich die Kombination No / Yes / Yes (Option E).
`
  },
...
• Device1: iOS, enRoled by using Apple Automated Device Enrollment (ADE) (supervised)
• Device2: iPadOS, enRoled by using Apple Automated Device Enrollment (ADE) (supervised), member of Group2
• Device3: iPadOS, enRoled by using the Company Portal app (user-enRoled, not supervised)
...
`,
    ...
    correctAnswers: ["C"],
    explanation: `
Nur supervised Geräte, die von ADE stammen und Ziel der Richtlinie sind, können Updates automatisch installieren. Device1 ist supervised und vom Profil erfasst – Updates innerhalb des Zeitfensters werden automatisch installiert. Device2 ist zwar supervised, gehört aber zu einer Gruppe, die explizit vom Profil ausgeschlossen ist – damit erfolgt keine automatische Installation. Device3 ist nur per Company Portal registriert (nicht supervised), iOS/iPadOS-Updateprofile können hier nicht automatisch durchgesetzt werden. Daher: Ja für Szenario 1, Nein für Szenario 2 und 3.
`,
    explanationEn: `
Nur supervised Devicee, die von ADE stammen und Ziel der Policy sind, können Updates automatisch installieren. Device1 ist supervised und vom Profil erfasst – Updates innerhalb des Zeitfensters werden automatisch installiert. Device2 ist zwar supervised, gehört aber zu einer Group, die explizit vom Profil ausgeschlossen ist – damit erfolgt keine automatische Installation. Device3 ist nur per Company Portal registriert (nicht supervised), iOS/iPadOS-Updateprofile können hier nicht automatisch durchgesetzt werden. Daher: Yes für Szenario 1, No für Szenario 2 und 3.
`
  },
...
• Computer1: Microsoft Entra ID joined, Intune enRoled, BitLocker disabled, Firewall enabled
• Computer2: Microsoft Entra ID registered, Intune enRoled, BitLocker enabled, Firewall enabled
• Computer3: Microsoft Entra ID registered, not enRoled in Intune, BitLocker enabled, Firewall disabled
...
Computer1 and Computer2 are members of Group1.
Computer3 is not enRoled in Intune.
...
`,
    options: [
      { key: "A", text: `Computer1 is Not compliant; Computer2 is Compliant; Computer3 is Not compliant.` },
      { key: "B", text: `Computer1 is In grace period; Computer2 is Compliant; Computer3 is Not evaluated.` },
      { key: "C", text: `Computer1 is Not compliant; Computer2 is In grace period; Computer3 is Not evaluated.` },
      { key: "D", text: `Computer1 is Compliant; Computer2 is Compliant; Computer3 is Not evaluated.` }
    ],
    optionsEn: [
      { key: "A", text: `Computer1 is Not compliant; Computer2 is Compliant; Computer3 is Not compliant.` },
      { key: "B", text: `Computer1 is In grace period; Computer2 is Compliant; Computer3 is Not evaluated.` },
    ...
    correctAnswers: ["B"],
    explanation: `
Computer1 ist in Intune registriert, Mitglied von Group1 und erfüllt die BitLocker-Anforderung nicht – er befindet sich nach Richtlinienzuweisung zunächst im Zustand ‚In grace period‘. Computer2 ist in Intune registriert, Mitglied von Group1 und erfüllt die BitLocker-Anforderung – er ist konform. Computer3 ist nicht in Intune enrolled; seine Compliance wird daher nicht bewertet und erscheint als ‚Not evaluated‘, nicht als ‚Not compliant‘.
`,
    explanationEn: `
Computer1 ist in Intune registriert, Mitglied von Group1 und erfüllt die BitLocker-Anforderung nicht – er befindet sich nach Policynzuweisung zunächst im Zustand ‚In grace period‘. Computer2 ist in Intune registriert, Mitglied von Group1 und erfüllt die BitLocker-Anforderung – er ist konform. Computer3 ist nicht in Intune enRoled; seine Compliance wird daher nicht bewertet und erscheint als ‚Not evaluated‘, nicht als ‚Not compliant‘.
`
  },
...
`,
    ...
    correctAnswers: ["B"],
    explanation: `
Cloud-only Microsoft 365-Gruppen und Sicherheitsgruppen (Group2 und Group3) können direkt im Entra Admin Center verwaltet werden. Mail-enabled und Distribution Groups werden primär über das Exchange Admin Center verwaltet, synchronisierte Gruppen (Group5) nur im lokalen AD. Daher sind nur Group2 und Group3 im Azure-Portal voll verwaltbar.
`,
    explanationEn: `
Cloud-only Microsoft 365-Groupn und SecuritysGroupn (Group2 und Group3) können direkt im Entra Admin Center verwaltet werden. Mail-enabled und Distribution Groups werden primär über das Exchange Admin Center verwaltet, synchronisierte Groupn (Group5) nur im lokalen AD. Daher sind nur Group2 und Group3 im Azure-Portal voll verwaltbar.
`
  },
...
`,
    options: [
      ...
      { key: "B", text: `Statement 1: Yes | Statement 2: Yes | Statement 3: No` },
      { key: "C", text: `Statement 1: Yes | Statement 2: No | Statement 3: No` },
      { key: "D", text: `Statement 1: No | Statement 2: Yes | Statement 3: No` },
      { key: "E", text: `Statement 1: No | Statement 2: No | Statement 3: Yes` }
    ],
    optionsEn: [
      { key: "A", text: `Statement 1: Yes | Statement 2: Yes | Statement 3: Yes` },
      { key: "B", text: `Statement 1: Yes | Statement 2: Yes | Statement 3: No` },
    ...
    correctAnswers: ["C"],
    explanation: `
Application Guard im Enterprise Managed Mode erfordert Windows Enterprise – dies ist auf Computer1 der Fall, daher kann der Modus genutzt werden. Clipboard-Einstellungen müssen korrekt und vollständig konfiguriert sein; in der Prüfungslogik gilt die konkrete Konfiguration auf Computer2 nicht als ausreichend, um Copy Edge → App Guard zu erlauben (Antwort: No). Application Guard mit Dateidownloads zum Host wird nur auf Enterprise/Education unterstützt; Computer3 mit Windows 11 Pro kann diese Richtlinie effektiv nicht nutzen. Somit ist nur Aussage 1 wahr; 2 und 3 sind falsch (Option C).
`,
    explanationEn: `
Application Guard im Enterprise Managed Mode erfordert Windows Enterprise – dies ist auf Computer1 der Fall, daher kann der Modus genutzt werden. Clipboard-Settingen müssen correct und vollständig konfiguriert sein; in der Prüfungslogik gilt die konkrete Configuration auf Computer2 nicht als ausreichend, um Copy Edge → App Guard zu erlauben (Answer: No). Application Guard mit Dateidownloads zum Host wird nur auf Enterprise/Education unterstützt; Computer3 mit Windows 11 Pro kann diese Policy effektiv nicht nutzen. Somit ist nur Aussage 1 true; 2 und 3 sind incorrect (Option C).
`
  },
...
`,
    options: [
      { key: "A", text: `Roaming user profiles in on-premises Active Directory` },
    ...
    correctAnswers: ["C"],
    explanation: `
Enterprise State Roaming synchronisiert Benutzer- und Systemeinstellungen (z. B. Themes, Taskleiste, Sprache, Bluetooth) für Entra-joined Windows-Geräte über die Cloud. Roaming Profiles und Folder Redirection sind klassische On-Prem-Techniken und decken primär Profile bzw. Ordner ab. OneDrive Known Folder Move synchronisiert Dateien (Dokumente, Desktop), nicht jedoch allgemeine Windows-Einstellungen.
`,
    explanationEn: `
Enterprise State Roaming synchronisiert User- und SystemSettingen (z. B. Themes, Taskleiste, Sprache, Bluetooth) für Entra-joined Windows-Devicee über die Cloud. Roaming Profiles und Folder Redirection sind klassische On-Prem-Techniken und decken primär Profile bzw. Ordner ab. OneDrive Known Folder Move synchronisiert Dateien (Dokumente, Desktop), nicht jedoch allgemeine Windows-Settingen.
`
  },
...
🧩 272. MDT – WinPE Settingen ändern & Boot Images aktualisieren
📘 Szenario

You use das Microsoft Deployment Toolkit (MDT),
um Windows 11 Deployments zu verwalten.

Im Deployment Workbench hast du die WinPE-Settingen angepasst, z. B.:
...
Which Aktion musst du durchführen, um die neuen WinPE-Settingen in die Boot-Images zu übernehmen?
`,
    options: [
...
`,
    explanationEn: `
➡️ correcte Answer: ✅ B – From the Deployment Shares node, update the deployment share

Wenn du Änderungen an der WinPE-Configuration eines MDT-Deployment-Shares vornimmst (z. B. PowerShell, .NET, Treiber, Skripte, zusätzliche Tools), werden die vorhandenen LiteTouchPE-Boot-Images nicht automatisch aktualisiert.
...
🧩 273. Windows Autopilot – Automatische Enrollment bestehender Devicee
📘 Szenario

You have eine Microsoft 365 Subscription mit den folgenden Computern:

Name	Microsoft Entra ID join type	EnRoled in Microsoft Intune	Operating system	Processor type
Computer1	Microsoft Entra ID registered	✅ Yes	Windows 11 Pro	x64
Computer2	Microsoft Entra ID joined	❌ No	Windows 10 Pro	x86

You want to sicherstellen, dass beide Devicee die automatische Enrollment in Windows Autopilot unterstützen.

Windows Autopilot soll in der Lage sein, die Devicee zu erkennen,
automatisch zu registrieren und den Hardware Hash an den Tenant zu übermitteln.

❓ Frage

Was musst du für jeden Computer tun, um die automatische Enrollment in Windows Autopilot zu ermöglichen?
`,
    options: [
...
Für die automatische Enrollment bestehender Devicee in Windows Autopilot gelten u. a. diese Voraussetzungen:

Unterstütztes OS: Windows 10/11 Pro, Enterprise oder Education

Device ist über MDM (Intune) verwaltet

Device ist Microsoft Entra ID joined (nicht nur „registered“)
...
Status: Entra ID registered, bereits in Intune enRoled

„Registered“ = BYOD-Szenario (UserDevice), kein vollwertiges Azure AD Join

→ Für Autopilot-Auto-Registration muss das Device Azure AD / Entra ID joined sein

Aktion: Join the computer to Microsoft Entra ID

Computer2

Status: Entra ID joined, aber nicht in Intune enRoled

Ohne MDM-Enrollment kann Intune keinen Hardware-Hash auslesen und nicht zu Autopilot hochladen

Aktion: Enroll the computer in Intune

Erst wenn beide Bedingungen (Entra ID Joined und Intune Enrollment) erfüllt sind, kann die automatische Autopilot-Enrollment greifen.
`
  },
...
You have einen Server namens Server1,
auf dem das Microsoft Deployment Toolkit (MDT) bereits installiert ist.
...
You need to auf Server1 einen Deployment Share erstellen,
um das Upgrade auf Windows 11 bereitzustellen.

Was solltest du auf Server1 tun
und Which minimalen Komponenten musst du dem MDT Deployment Share hinzufügen?
`,
    options: [
...
Task Sequences correct auszuführen
...
Weitere Komponenten How Packages, Applications, Language Packs sind optional und für ein reines Windows 11-Upgrade nicht zwingend notwendig.
`
  },
...
You manage 25 Computer mit Windows 10 Pro.
Dein Unternehmen verfügt über eine Microsoft 365 E5 Subscription mit Microsoft Intune.

You want to die Devicee auf Windows 11 Enterprise upgraden – per In-Place Upgrade und mit minimalem administrativem Aufwand.
...
`,
    options: [
      { key: "A", text: `Microsoft Endpoint Configuration Manager und ein benutzerdefiniertes Windows 11 Enterprise-Image` },
      { key: "B", text: `Subscription Activation` },
      { key: "C", text: `Microsoft Deployment Toolkit (MDT) und ein Standardimage von Windows 11 Enterprise` },
      { key: "D", text: `Windows Autopilot` }
    ],
    optionsEn: [
      { key: "A", text: `Microsoft Endpoint Configuration Manager und ein Userdefiniertes Windows 11 Enterprise-Image` },
      { key: "B", text: `Subscription Activation` },
      { key: "C", text: `Microsoft Deployment Toolkit (MDT) und ein Standardimage von Windows 11 Enterprise` },
      { key: "D", text: `Windows Autopilot` }
    ],
...
`,
    explanationEn: `
➡️ correcte Answer: C) Microsoft Deployment Toolkit (MDT) und ein Standardimage von Windows 11 Enterprise
...
Userdaten und Applicationen behalten
...
🧩 276. correcte Image-Auswahl für In-Place Upgrade in MDT
📘 Szenario

You have folgende x64-Computer, die aktualisiert werden sollen:
...
Which Images können für ein In-Place Upgrade der Devicee verwendet werden?
`,
    options: [
...
Custom Images (mit vorinstallierten Applicationen How Office 2019) sind nicht für In-Place Upgrades geeignet, da Windows Setup eine unveränderte Komponentenstruktur erwartet.
