export type Md102Question = {
  /** ID aus deiner Sammlung (z.B. Q51, Q60, Q344, …) */
  id: string;
...

{
  ...
  correctAnswers: ["A"],
  explanation:
    "Platzhalter-Frage. Diese Frage sollte in MainLab später durch den echten Inhalt der Frage 89 ersetzt werden.",
  references: []
},
  ...
  options: [
    {
      key: "A",
      text:
        "Feature update deferral: 30 Tage; Quality update deferral: 7 Tage; Deadline for feature updates: 5 Tage; Grace period: 1 Tag"
    },
    {
      key: "B",
      text:
        "Feature update deferral: 90 Tage; Quality update deferral: 14 Tage; Deadline for feature updates: 10 Tage; Grace period: 3 Tage"
    },
    {
      key: "C",
      text:
        "Feature update deferral: 120 Tage; Quality update deferral: 0 Tage; Deadline for feature updates: 10 Tage; Grace period: 7 Tage"
    },
    {
      key: "D",
      text:
        "Feature update deferral: 90 Tage; Quality update deferral: 14 Tage; Deadline for feature updates: 0 Tage; Grace period: 0 Tage"
    }
  ],
...
},
{
  ...
  options: [
    ...
    },
    {
      key: "B",
      text:
        "Im Zero-Touch-Portal ein Konfigurationsprofil erstellen, Geräte über den Händler dem Zero-Touch-Konto zuordnen und beim ersten Start die manuelle Intune-App-Installation durch den Benutzer verlangen."
    },
    {
      key: "C",
      text:
        "Managed Google Play-Konto mit Intune verknüpfen, im Zero-Touch-Portal eine Konfiguration erstellen, Geräte beim Händler mit ZTE-Fähigkeit registrieren und die automatische Intune-Registrierung beim ersten Start nutzen."
    },
    {
      key: "D",
      text:
        "Nur Apple Business Manager und Apple Configurator einrichten, Zero-Touch wird für alle mobilen Plattformen gemeinsam dort verwaltet."
    }
  ],
...
options: [
{ key: "A", text: 'net localgroup "AzureAD\User1@contoso.com" /add "Device Owners"' },
{ key: "B", text: 'net localgroup "contoso\User1" /add "Remote Desktop Users"' },
{ key: "C", text: 'net localgroup "Device Owners" /add "contoso\User1"' },
{ key: "D", text: 'net localgroup "Remote Desktop Users" /add "AzureAD\User1@contoso.com"' },
