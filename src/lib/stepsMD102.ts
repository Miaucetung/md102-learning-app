...
export const MD102_STEPS: Md102Step[] = [
    ...
    portalLinks: [
      {
        ...
        href: "https://intune.microsoft.com/#view/Microsoft_Intune_DeviceSettings/DevicesMenu/~/autopilotDevices",
      },
    ],
    verify: [
  ...
  },
  {
    ...
    cloudTrack: ["Security Baselines (Defender, Edge, Intune) testen."],
    verify: [
    ...
    portalLinks: [
      {
        ...
        href: "https://intune.microsoft.com/#view/Microsoft_Intune_Security/SecurityMenu/~/overview",
      },
    ],
    verify: ["Policies Succeeded.", "Defender aktiv, ASR-Regeln greifen."],
    tips: ["ASR-Regeln werden oft abgefragt – z. B. Block Office Macros."],
  },
  {
    id: "m6",
    ...
    tips: ["Feature Updates → Planung, Quality Updates → Sicherheitspatches."],
  },
  {
    id: "m7",
    ...
    verify: ["Alle Apps installiert + Detection Rules korrekt."],
    tips: [
...
const KEY = "md102-app:md-102:progress";
